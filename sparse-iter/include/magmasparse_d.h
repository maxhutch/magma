/*
 ...
 @generated from sparse-iter/include/magmasparse_z.h, normal z -> d, Tue Aug 30 09:39:22 2016
 @author Hartwig Anzt
*/
...
magma_int_t
magma_dmpilut_sweep_linkedlist(
    magma_d_matrix *A,
    magma_d_matrix *L,
    magma_d_matrix *U,
    magma_queue_t queue );
...
magma_int_t
magma_dmpilut_residuals_linkedlist(
    magma_d_matrix A,
    magma_d_matrix L,
    magma_d_matrix U,
    magma_d_matrix *L_new,
...
magma_int_t
magma_dmpilut_colmajor(
    magma_d_matrix A,
    magma_d_matrix *AC,
    magma_queue_t queue );

magma_int_t
magma_dmpilut_colmajorup(
    magma_d_matrix A,
    magma_d_matrix *AC,
    magma_queue_t queue );
...
magma_int_t
magma_dmpilut_candidates_linkedlist(
    magma_d_matrix L,
    magma_d_matrix U,
    magma_d_matrix UR,
    magma_d_matrix *L_new,
...
magma_int_t
magma_dmpilut_select_candidates(
    magma_int_t *num_rm,
    magma_int_t *rm_loc,
    magma_d_matrix *L_new,
    magma_queue_t queue );
...
magma_int_t
magma_dmpilut_select_candidates_L(
    magma_int_t *num_rm,
    magma_index_t *rm_loc,
    magma_d_matrix *L_new,
    magma_queue_t queue );
...
magma_int_t
magma_dmpilut_select_candidates_U(
    magma_int_t *num_rm,
    magma_index_t *rm_loc,
    magma_d_matrix *L_new,
    magma_queue_t queue );
