/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magmasparse_z.h normal z -> c, Tue Sep  2 12:38:31 2014
       @author Hartwig Anzt
*/
...
magma_int_t 
magma_cmdiff(           magma_c_sparse_matrix A, 
                        magma_c_sparse_matrix B, 
                        real_Double_t *res );
...
magma_int_t
magma_csymbilu(         magma_c_sparse_matrix *A, 
                        magma_int_t levels,
...
magma_int_t
magma_cm_27stencil(  magma_int_t n,
                     magma_c_sparse_matrix *A );

magma_int_t
magma_cm_5stencil(  magma_int_t n,
                     magma_c_sparse_matrix *A );
