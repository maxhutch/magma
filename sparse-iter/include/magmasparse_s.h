/*
 ...
 @generated from sparse-iter/include/magmasparse_z.h, normal z -> s, Tue Aug 30 09:39:22 2016
 @author Hartwig Anzt
*/
...
magma_int_t
magma_smpilut_sweep_linkedlist(
    magma_s_matrix *A,
    magma_s_matrix *L,
    magma_s_matrix *U,
    magma_queue_t queue );
...
magma_int_t
magma_smpilut_residuals_linkedlist(
    magma_s_matrix A,
    magma_s_matrix L,
    magma_s_matrix U,
    magma_s_matrix *L_new,
...
magma_int_t
magma_smpilut_colmajor(
    magma_s_matrix A,
    magma_s_matrix *AC,
    magma_queue_t queue );

magma_int_t
magma_smpilut_colmajorup(
    magma_s_matrix A,
    magma_s_matrix *AC,
    magma_queue_t queue );
...
magma_int_t
magma_smpilut_candidates_linkedlist(
    magma_s_matrix L,
    magma_s_matrix U,
    magma_s_matrix UR,
    magma_s_matrix *L_new,
...
magma_int_t
magma_smpilut_select_candidates(
    magma_int_t *num_rm,
    magma_int_t *rm_loc,
    magma_s_matrix *L_new,
    magma_queue_t queue );
...
magma_int_t
magma_smpilut_select_candidates_L(
    magma_int_t *num_rm,
    magma_index_t *rm_loc,
    magma_s_matrix *L_new,
    magma_queue_t queue );
...
magma_int_t
magma_smpilut_select_candidates_U(
    magma_int_t *num_rm,
    magma_index_t *rm_loc,
    magma_s_matrix *L_new,
    magma_queue_t queue );
