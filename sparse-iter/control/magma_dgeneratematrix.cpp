/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magma_zgeneratematrix.cpp normal z -> d, Tue Sep  2 12:38:35 2014
       @author Hartwig Anzt
*/
#include <fstream>
#include <stdlib.h>
...
extern "C"
magma_int_t
magma_dm_27stencil(  magma_int_t n,
                     magma_d_sparse_matrix *A ){
    ...
    magma_dmgenerator( nn, offdiags, diag_offset, diag_vals, &hA );
    ...
    magma_d_mconvert( hA, A, Magma_CSR, Magma_CSR );
    magma_d_mfree( &hA );
...
extern "C"
magma_int_t
magma_dm_5stencil(  magma_int_t n,
                    magma_d_sparse_matrix *A ){
