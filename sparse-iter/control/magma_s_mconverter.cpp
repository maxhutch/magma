/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from magma_z_mconverter.cpp normal z -> s, Fri May 30 10:41:46 2014
       @author Hartwig Anzt
*/
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_s_sparse_matrix *B             copy of A in new format      
...
*/
 ...
 /*       // CSR to CSRCSCL
        ...
        size_b*size_b*sizeof( float ), cudaMemcpyHostToDevice );
                magmablas_stranspose_inplace( size_b, transpose, size_b );
                cudaMemcpy( B->val+i*size_b*size_b, transpose, 
        size_b*size_b*sizeof( float ), cudaMemcpyDeviceToHost );
            }
            /*
        ...
        if( old_format == Magma_CSR && new_format == Magma_COO ){
            ...
            cudaMemcpy( B->val, A.val, A.nnz*sizeof( float ), 
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_s_sparse_matrix L              sparse matrix L   
    magma_s_sparse_matrix U              sparse matrix U
    magma_s_sparse_matrix *B             output sparse matrix B
