/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from magma_zp2p.cpp normal z -> s, Fri May 30 10:41:45 2014
       @author Hartwig Anzt
...
/////////////////////////////////////
magma_int_t
magma_scheckerr(const char *label)
{
...
magma_int_t
magma_s_initP2P ( magma_int_t *bandwidth_benchmark, magma_int_t *num_gpus ){
  ...
  // Enable peer access
   ...
   magma_scheckerr("P2P successful");
  ...
  if(*bandwidth_benchmark==1){
   ...
   for(int i=0; i<gpu_n; i++)
    ...
    magma_scheckerr("P2P established");
