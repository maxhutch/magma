/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magma_zgeneratematrix.cpp normal z -> c, Tue Sep  2 12:38:36 2014
       @author Hartwig Anzt
*/
#include <fstream>
#include <stdlib.h>
...
magma_cmgenerator(  magma_int_t n,
    ...
    magma_cmalloc_cpu( &B.val, B.max_nnz_row*n );
    ...
    magma_c_mconvert( B, A, Magma_ELLPACK, Magma_CSR );
...
magma_cm_27stencil(  magma_int_t n,
    ...
    magma_cmgenerator( nn, offdiags, diag_offset, diag_vals, &hA );
    ...
    magma_c_mconvert( hA, A, Magma_CSR, Magma_CSR );
    magma_c_mfree( &hA );
