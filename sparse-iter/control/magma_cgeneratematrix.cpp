/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from magma_zgeneratematrix.cpp normal z -> c, Fri May 30 10:41:45 2014
       @author Hartwig Anzt
*/
#include <fstream>
#include <stdlib.h>
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_int_t *diag_offsets            array containing the offsets 
                                                (length offsets+1)
    magmaFloatComplex  *diag_vals       array containing the values
                                                (length offsets+1)
    magma_c_sparse matrix *A             matrix to generate   
