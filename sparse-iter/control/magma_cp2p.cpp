/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magma_zp2p.cpp normal z -> c, Tue Sep  2 12:38:36 2014
       @author Hartwig Anzt
...
/////////////////////////////////////
magma_int_t
magma_ccheckerr(const char *label)
{
...
magma_c_initP2P ( magma_int_t *bw_bmark, magma_int_t *num_gpus ){
  ...
  // Enable peer access
   ...
   magma_ccheckerr("P2P successful");
  ...
  if(*bw_bmark==1){
   ...
   for(int i=0; i<gpu_n; i++)
    ...
    magma_ccheckerr("P2P established");
