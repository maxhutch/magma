/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magma_zgeneratematrix.cpp normal z -> s, Tue Sep  2 12:38:35 2014
       @author Hartwig Anzt
*/
#include <fstream>
#include <stdlib.h>
...
magma_sm_27stencil(  magma_int_t n,
    ...
    magma_smgenerator( nn, offdiags, diag_offset, diag_vals, &hA );
    ...
    magma_s_mconvert( hA, A, Magma_CSR, Magma_CSR );
    magma_s_mfree( &hA );
