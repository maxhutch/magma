/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from magma_zmio.cpp normal z -> d, Sat Nov 15 19:54:23 2014
       @author Hartwig Anzt
*/
    ...
    if ( A.memory_location == Magma_CPU ) {
        ...
        if ( A.storage_type == Magma_DENSE ) {
            ...
            if( A.num_rows < 11 && A.num_cols < 11 ){ 
                ...
                magma_d_mconvert( A, &C, A.storage_type, Magma_DENSE, queue );
                magma_d_mvisu(  C, queue );
            ...
            magma_d_mconvert( A, &C, A.storage_type, Magma_CSR, queue );
            magma_d_mvisu(  C, queue );
            magma_d_mfree(&C, queue );
        }
    }
        ...
        magma_d_sparse_matrix C;
        magma_d_mtransfer( A, &C, A.memory_location, Magma_CPU, queue );
        magma_d_mvisu(  C, queue );
        magma_d_mfree(&C, queue );
    }
    ...
    magma_queue_t queue )
{
  ...
  //printf("detected symmetric case\n");
    ...
    stat_cpu += magma_dmalloc_cpu( &new_val, true_nonzeros );
  ...
  */
  ...
  if ( csr_compressor > 0) { // run the CSR compressor to remove zeros
      ...
      magma_d_sparse_matrix B;
      magma_d_mtransfer( *A, &B, Magma_CPU, Magma_CPU, queue ); 
     ...
     // printf(" remaining nonzeros:%d ", B.nnz); 
      ...
      magma_d_mtransfer( B, A, Magma_CPU, Magma_CPU, queue ); 
