/*
    -- micMAGMA (version 2.0.2) --
       Univ. of Tennessee, Knoxville
       Univ. of California, Berkeley
       Univ. of Colorado, Denver
       @date May 2016

       @generated from sparse-iter/control/magma_ziteriluutils.cpp normal z -> s, Mon May  2 23:30:51 2016
       @author Hartwig Anzt
*/
    ...
    magma_queue_t queue )
{
    ...
    magma_s_matrix L_d={Magma_CSR}, U_d={Magma_CSR}, LU_d={Magma_CSR}, A_t={Magma_CSR};

    CHECK( magma_smtransfer( L, &L_d, Magma_CPU, Magma_DEV, queue  ));
    CHECK( magma_smtransfer( U, &U_d, Magma_CPU, Magma_DEV, queue  ));
    CHECK( magma_smtransfer( A, &A_t, Magma_CPU, Magma_CPU, queue  ));
    CHECK( magma_s_spmm( one, L_d, U_d, &LU_d, queue ));

    CHECK( magma_smtransfer(LU_d, LU, Magma_DEV, Magma_CPU, queue ));
    magma_smfree( &L_d, queue  );
    magma_smfree( &U_d, queue  );
    magma_smfree( &LU_d, queue  );
    ...
    magma_queue_t queue )
{
    ...
    magma_s_matrix LL={Magma_CSR}, L_d={Magma_CSR}, U_d={Magma_CSR}, LU_d={Magma_CSR};
    ...
    CHECK( magma_smtransfer( LL, &L_d, Magma_CPU, Magma_DEV, queue  ));
    CHECK( magma_smtransfer( U, &U_d, Magma_CPU, Magma_DEV, queue  ));
    ...
    magma_queue_t queue )
{
    ...
    magma_s_matrix L_d={Magma_CSR}, U_d={Magma_CSR}, LU_d={Magma_CSR};
    
    *res = 0.0;
    *nonlinres = 0.0;

    CHECK( magma_smtransfer( C, &L_d, Magma_CPU, Magma_DEV, queue ));
    CHECK( magma_smtransfer( CT, &U_d, Magma_CPU, Magma_DEV, queue ));
    CHECK( magma_s_spmm( one, L_d, U_d, &LU_d, queue ));
    CHECK( magma_smtransfer(LU_d, LU, Magma_DEV, Magma_CPU, queue ));
