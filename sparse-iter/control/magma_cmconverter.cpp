/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from sparse-iter/control/magma_zmconverter.cpp normal z -> c, Fri Jan 22 21:42:18 2016
       @author Hartwig Anzt
*/
    ...
    if ( A.memory_location == Magma_CPU )
    {
        ...
        if ( old_format == Magma_CSR )
        {
            ...
            // CSR to BCSR
                ...
                CHECK( magma_cmconvert(A_d, &B_d, Magma_CSR, Magma_BCSR, queue ) );            
          ...
          /*      CHECK( magma_cmconvert( A, B, Magma_ELL, Magma_CSR, queue ));
            ...
            */    
            ...
            // SELLP to CSR
                ...
                // conversion
                CHECK( magma_cmalloc_cpu( &val_tmp, A.max_nnz_row*(A.num_rows+C) ));
            ...
            // BCSR to CSR
                ...
                CHECK( magma_cmtransfer(A, &A_d, Magma_CPU, Magma_DEV, queue ) );
                CHECK( magma_cmconvert(A_d, &B_d, Magma_BCSR, Magma_CSR, queue ) );
            ...
            // COO to CSR
                ...
                CHECK( magma_cmtransfer(A, &A_d, Magma_CPU, Magma_DEV, queue ) );
                CHECK( magma_cmconvert(A_d, &B_d, Magma_COO, Magma_CSR, queue ) );
                magma_cmfree( &A_d, queue );
                CHECK( magma_cmtransfer(B_d, B, Magma_DEV, Magma_CPU, queue ) );
                magma_cmfree( &B_d, queue );
            }
