/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from magma_z_mconverter.cpp normal z -> d, Fri May 30 10:41:46 2014
       @author Hartwig Anzt
*/
                                    ...
                                    magma_int_t *alignedrows)
{
    ...
    magma_dmalloc_cpu( valn, nnz_new );
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_d_sparse_matrix *B             copy of A in new format      
...
magma_d_mconvert( magma_d_sparse_matrix A, 
    ...
    if( A.memory_location == Magma_CPU ){
        ...
        if( old_format == Magma_CSR && new_format == Magma_CSRL ){
            ...
            B->nnz = numzeros;
            magma_dmalloc_cpu( &B->val, numzeros );
            magma_indexmalloc_cpu( &B->row, A.num_rows+1 );
   ...
   /*     // CSRL/CSRCSCL to CSR
        if( ( old_format == Magma_CSRL  ) 
            ...
            magma_d_mconvert( A, B, Magma_CSR, Magma_CSR);
...
/*
            ...
            magma_d_sparse_matrix ELL_sorted, ELL;
            ...
            magma_dmalloc_cpu( &ELL.val, maxrowlength*A.num_rows );
            ...
            magma_dmalloc_cpu( &ELL_sorted.val, maxrowlength*A.num_rows );
            magma_indexmalloc_cpu( &ELL_sorted.col, maxrowlength*A.num_rows );

            for( magma_int_t i=0; i<(maxrowlength*A.num_rows); i++){
                ELL.val[i] = MAGMA_D_MAKE(0., 0.);
                ELL.col[i] =  -1;
                ELL_count[i] =  0;
                ELL_sorted.val[i] = MAGMA_D_MAKE(0., 0.);
                ELL_sorted.col[i] =  -1;
            }
            ...
            magma_d_mconvert( ELL_sorted, B, Magma_ELLPACK, Magma_CSR );

            magma_d_mfree( &ELL_sorted );
            magma_d_mfree( &ELL );
            free( ELL_count );*/
...
*/
 ...
 /*       // CSR to CSRCSCL
        ...
        if( old_format == Magma_CSR && new_format == Magma_CSRCSCL ){
            ...
            magma_d_mconvert( A, &C, Magma_CSR, Magma_CSRL );
            // fill in information for B
        ...
        if( old_format == Magma_CSR && new_format == Magma_CSRCSCU ){
            ...
            magma_d_sparse_matrix C2;
            magma_d_mconvert( A, &C2, Magma_CSR, Magma_CSRL);
        ...
        if( old_format == Magma_CSR && new_format == Magma_ELLPACK ){
            ...
            //printf( "Conversion to ELLPACK with %d elements per row: ",
                                                            // maxrowlength );
            //fflush(stdout);
            magma_dmalloc_cpu( &B->val, maxrowlength*A.num_rows );
        ...
        if( old_format == Magma_ELL && new_format == Magma_CSR ){
            ...
            double *val_tmp;
            magma_dmalloc_cpu( &val_tmp, A.num_rows*A.max_nnz_row );
            magma_indexmalloc_cpu( &row_tmp, A.num_rows+1 );
        ...
        if( old_format == Magma_ELLD && new_format == Magma_CSR ){
            ...
            double *val_tmp2;
            magma_dmalloc_cpu( &val_tmp2, A.num_rows*A.max_nnz_row );
        ...
        if( old_format == Magma_CSR && new_format == Magma_ELLDD ){         
            ...
            // conversion
            magma_int_t i;
            magma_d_sparse_matrix A_tmp;
            if( B->diagorder_type == Magma_DIAGFIRST ){
                magma_d_mconvert( A, &A_tmp, Magma_CSR, Magma_ELLD );
            }
            else{
                magma_d_mconvert( A, &A_tmp, Magma_CSR, Magma_ELLPACK );
            }
            ...
            for( i=0; i<A.num_rows; i++){
                B->val[ i*maxrowlength ] = MAGMA_D_MAKE(1.0, 0.0);
            }
            for( i=0; i<off; i++){
        ...
        if( old_format == Magma_ELLDD && new_format == Magma_CSR ){         
            ...
            magma_int_t i, j;
            magma_d_sparse_matrix A_tmp;
            magma_dmalloc_cpu( &A_tmp.val, off );
            ...
            for( i=0; i<A.num_rows; i++){
                for( j=0; j<maxrowlength; j++){
                    ...
                    double val = A.val[ off + maxrowlength*i+j ];
            ...
            if( A.diagorder_type == Magma_DIAGFIRST )
                magma_d_mconvert(A_tmp, B, Magma_ELLD, Magma_CSR );
            else
                magma_d_mconvert(A_tmp, B, Magma_ELLPACK, Magma_CSR );
        ...
        if( old_format == Magma_CSR && new_format == Magma_ELLRT ){
            ...
            magma_dmalloc_cpu( &B->val, rowlength*A.num_rows );
        ...
        if( old_format == Magma_CSR && 
            ...
            //fflush(stdout);
            magma_dmalloc_cpu( &B->val, B->row[slices] );
        ...
        if( (old_format == Magma_SELLC || old_format == Magma_SELLP )
            ...
            magma_index_t *col_tmp;
            double *val_tmp;
            magma_dmalloc_cpu( &val_tmp, A.max_nnz_row*(A.num_rows+C) );
        ...
        if( old_format == Magma_CSR && new_format == Magma_DENSE ){
            ...
            // conversion
            magma_dmalloc_cpu( &B->val, A.num_rows*A.num_cols );
        ...
        if( old_format == Magma_CSR && new_format == Magma_BCSR ){
            ...
            magma_dmalloc_cpu( &B->val, numblocks * size_b * size_b );
        ...
        if( old_format == Magma_BCSR && new_format == Magma_CSR ){
            ...
            //fflush(stdout);
            double *val_tmp;      
            magma_dmalloc_cpu( &val_tmp, A.row[ r_blocks ] * size_b * size_b );
            magma_index_t *row_tmp;            
            ...
            magma_dmalloc( &transpose, size_b*size_b );
            magma_dmalloc_cpu( &val_tmp2, size_b*size_b*A.numblocks );
        ...
        if( old_format == Magma_CSR && new_format == Magma_BCSR ){
            ...
            magma_dmalloc( &B->val, nnzb*size_b*size_b );
        ...
        if( old_format == Magma_CSR && new_format == Magma_COO ){
            ...
            cudaMemcpy( B->val, A.val, A.nnz*sizeof( double ), 
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_d_sparse_matrix L              sparse matrix L   
    magma_d_sparse_matrix U              sparse matrix U
    magma_d_sparse_matrix *B             output sparse matrix B

    ========================================================================  */

magma_int_t 
magma_d_LUmergein( magma_d_sparse_matrix L, 
...
magma_d_LUmerge( magma_d_sparse_matrix L, 
    ...
    magma_d_mconvert( L, B, Magma_CSRL, Magma_CSR );
    magma_int_t i, j, k;
