/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from magma_z_mconverter.cpp normal z -> d, Fri Jul 18 17:34:30 2014
       @author Hartwig Anzt
*/
...
*/
 ...
 /*       // CSR to CSRCSCL
        ...
        if( old_format == Magma_COO && new_format == Magma_CSR ){
            ...
            magma_d_mconvert( hA, &hB, old_format, new_format );
            magma_d_mtransfer( hB, B, Magma_CPU, A.memory_location );
            magma_d_mfree( &hA );
            magma_d_mfree( &hB );   
