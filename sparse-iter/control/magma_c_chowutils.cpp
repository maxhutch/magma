/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from magma_z_chowutils.cpp normal z -> c, Fri May 30 10:41:46 2014
       @author Hartwig Anzt
*/
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_c_sparse_matrix A              sparse matrix in CSR
    magma_c_sparse_matrix B              sparse matrix in CSR    
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_c_sparse_matrix A              input sparse matrix in CSR
    magma_c_sparse_matrix L              input sparse matrix in CSR    
    magma_c_sparse_matrix U              input sparse matrix in CSR    
    magma_c_sparse_matrix U              output sparse matrix in A-LU in CSR    
...
magma_cnonlinres(   magma_c_sparse_matrix A, 
    ...
    cudaMalloc((void**)&LU_d.val, sizeof(magmaFloatComplex)*LU_d.nnz);
