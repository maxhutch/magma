/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from magma_zmsort.cpp normal z -> s, Fri Jul 18 17:34:30 2014
       @author Hartwig Anzt
*/
...
magma_smsort( magma_s_sparse_matrix *A ){
    ...
    if( (A->storage_type == Magma_CSRCOO 
        ...
        magma_s_mconvert( hA, &CSRCOOA, hA.storage_type, Magma_CSRCOO );

        magma_smsort( &CSRCOOA );

        magma_s_mfree( &hA );
        magma_s_mfree( A );
        magma_s_mconvert( CSRCOOA, &hA, Magma_CSRCOO, A_storage );
