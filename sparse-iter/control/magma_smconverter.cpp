/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/control/magma_zmconverter.cpp, normal z -> s, Tue Aug 30 09:38:47 2016
       @author Hartwig Anzt
*/
    ...
    if ( A.memory_location == Magma_CPU )
    {
        ...
        if ( old_format == Magma_CSR )
        {
            ...
            // CSR to BCSR
                ...
                CHECK( magma_smconvert(A_d, &B_d, Magma_CSR, Magma_BCSR, queue ) );            
          ...
          /*      CHECK( magma_smconvert( A, B, Magma_ELL, Magma_CSR, queue ));
            ...
            */    
            ...
            // SELLP to CSR
                ...
                // conversion
                CHECK( magma_smalloc_cpu( &val_tmp, A.max_nnz_row*(A.num_rows+C) ));
            ...
            // COO to CSR
                ...
                CHECK( magma_smtransfer(A, &A_d, Magma_CPU, Magma_DEV, queue ) );
                CHECK( magma_smconvert(A_d, &B_d, Magma_COO, Magma_CSR, queue ) );
                magma_smfree( &A_d, queue );
                CHECK( magma_smtransfer(B_d, B, Magma_DEV, Magma_CPU, queue ) );
                magma_smfree( &B_d, queue );
            }
