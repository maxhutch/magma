/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from magma_z_chowutils.cpp normal z -> s, Fri Jul 18 17:34:30 2014
       @author Hartwig Anzt
*/
...
magma_snonlinres(   magma_s_sparse_matrix A, 
    ...
    magma_s_sparse_matrix L_d, U_d, LU_d, A_t;

    magma_s_mtransfer( L, &L_d, Magma_CPU, Magma_DEV ); 
    magma_s_mtransfer( U, &U_d, Magma_CPU, Magma_DEV ); 

    magma_s_mtransfer( U, &LU_d, Magma_CPU, Magma_DEV ); 

    magma_s_mtransfer( A, &A_t, Magma_CPU, Magma_CPU ); 
    ...
    magma_s_mtransfer(LU_d, LU, Magma_DEV, Magma_CPU);
    magma_s_mfree( &L_d );
    magma_s_mfree( &U_d );
    magma_s_mfree( &LU_d );
...
magma_silures(   magma_s_sparse_matrix A, 
    ...
    magma_s_sparse_matrix L_d, U_d, LU_d;
...
magma_int_t 
magma_sinitguess( magma_s_sparse_matrix A, magma_s_sparse_matrix *L, magma_s_sparse_matrix *U ){

    magma_s_sparse_matrix hAL, hAU, hAUT, hALCOO, hAUCOO, dAL, dAU, dALU, hALU, hD, dD, dL, hL;
    magma_int_t i,j;

    // need only lower triangular
    hAL.diagorder_type == Magma_VALUE;
    magma_s_mconvert( A, &hAL, Magma_CSR, Magma_CSRL );
    //magma_s_mconvert( hAL, &hALCOO, Magma_CSR, Magma_CSRCOO );

    // need only upper triangular
    //magma_s_mconvert( A, &hAU, Magma_CSR, Magma_CSRU );
    magma_s_cucsrtranspose(  hAL, &hAU );
    //magma_s_mconvert( hAU, &hAUCOO, Magma_CSR, Magma_CSRCOO );

    magma_s_mtransfer( hAL, &dAL, Magma_CPU, Magma_DEV );
    magma_s_mtransfer( hAU, &dAU, Magma_CPU, Magma_DEV );
    magma_s_mfree( &hAL);
    magma_s_mfree( &hAU);

    magma_scuspmm( dAL, dAU, &dALU );

    magma_s_mtransfer( dALU, &hALU, Magma_DEV, Magma_CPU );
    ...
    magma_smgenerator( hALU.num_rows, offdiags, diag_offset, diag_vals, &hD );
    magma_s_mfree( &hALU);
    ...
    magma_s_mtransfer( hD, &dD, Magma_CPU, Magma_DEV );
    magma_s_mfree( &hD);

  //  magma_s_mvisu(dD);
    magma_scuspmm( dD, dAL, &dL );
    //magma_s_mvisu(dD);
    //magma_s_mvisu(dAL);
    //magma_s_mvisu(dL);
    magma_s_mfree( &dAL);
...
/*
    ...
    magma_s_sparse_matrix dLt, dLL, LL;
    magma_s_cucsrtranspose(  dL, &dLt );
    magma_scuspmm( dL, dLt, &dLL );
    magma_s_mtransfer( dLL, &LL, Magma_DEV, Magma_CPU );
...
*/
    ...
    magma_s_mconvert( hL, L, Magma_CSR, Magma_CSRCOO );
