/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zbcsrlu.cpp normal z -> c, Fri Jul 18 17:34:29 2014
*/
...
magma_cbcsrlutrf( magma_c_sparse_matrix A, magma_c_sparse_matrix *M, 
    ...
    magma_setvector( A.numblocks, sizeof(magmaFloatComplex*), 
                                                        hA, 1, dA, 1 );
    magma_setvector( A.numblocks, sizeof(magmaFloatComplex*), 
                                                        hB, 1, dB, 1 );
    magma_setvector( (M->numblocks-A.numblocks), sizeof(magmaFloatComplex*), hC, 1, dC, 1 );
    ...
    for( k=0; k<r_blocks; k++){
        ...
        magma_setvector( klblocks, sizeof(magmaFloatComplex*), hBL, 1, 
                                                                    dBL, 1 );
        ...
        magma_setvector( num_block_rows, sizeof(magmaFloatComplex*), hA, 1, 
                                                        dA, 1 );
        magma_setvector( kblocks, sizeof(magmaFloatComplex*), hB, 1, dB, 1 );
        ...
        magma_setvector( kblocks*num_block_rows, sizeof(magmaFloatComplex*), 
                                                                hC, 1, dC, 1 );
        ...
        // AIs and BIs for the batched GEMMs later
            ...
            magma_setvector( kblocks*num_block_rows, sizeof(magmaFloatComplex*), AIs, 1, dAIs, 1 );
            magma_setvector( kblocks*num_block_rows, sizeof(magmaFloatComplex*), BIs, 1, dBIs, 1 );
        }  
...
magma_cbcsrlusv( magma_c_sparse_matrix A, magma_c_vector b, magma_c_vector *x,  
    ...
    // set x = b
    magma_ccopyvector( A.num_rows, b.val, 1, x->val, 1 );
