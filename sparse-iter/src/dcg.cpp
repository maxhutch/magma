/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zcg.cpp normal z -> d, Tue Sep  2 12:38:34 2014
*/
...
magma_int_t
magma_dcg( magma_d_sparse_matrix A, magma_d_vector b, magma_d_vector *x,  
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        betanom = magma_dnrm2(dofs, r.val, 1);             // betanom = || r ||
