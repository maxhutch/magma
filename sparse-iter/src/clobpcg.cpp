/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zlobpcg.cpp normal z -> c, Fri May 30 10:41:42 2014
*/
...
#define magma_c_bspmv_tuned(m, n, alpha, A, X, beta, AX)       {        \
            magmablas_ctranspose2( blockW, n,      X, m, m, n );        \
            magma_c_vector x, ax;                                       \
            ...
            magmablas_ctranspose2(      X, m, blockW, n, n, m );            \
}
...
//                magma_ctrsm( MagmaRight, MagmaUpper, MagmaNoTrans, MagmaNonUnit, 
  //                           m, cBlockSize, c_one, dwork, cBlockSize, blockAP, m);
            ...
            magmablas_claset_identity(ldgram, ldgram, gramB, ldgram);
            ...
            magmablas_claset_identity(ldgram, ldgram, gramA, ldgram);
