/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zlobpcg.cpp normal z -> d, Fri Sep 11 18:29:45 2015
*/
...
//**************************************************************
    ...
    double c_mone = MAGMA_D_MAKE(-1.0, 0.0);
...
/*
  ...
  */
            ...
            CHECK( magma_d_applyprecond_left( A, bRv, &bWv, precond_par, queue ));
            CHECK( magma_d_applyprecond_right( A, bWv, &bRv, precond_par, queue ));
