/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zlobpcg.cpp normal z -> d, Fri May 30 10:41:42 2014
*/
...
magma_dcompact(magma_int_t m, magma_int_t n,
               double *dA, magma_int_t ldda,
               double *dnorms, double tol, 
               magma_int_t *activeMask, magma_int_t *cBlockSize);

extern "C" magma_int_t
magma_dcompactActive(magma_int_t m, magma_int_t n,
                     double *dA, magma_int_t ldda, 
                     magma_int_t *active);
//==================================================================================
...
#define magma_d_bspmv_tuned(m, n, alpha, A, X, beta, AX)       {        \
            magmablas_dtranspose2( blockW, n,      X, m, m, n );        \
            magma_d_vector x, ax;                                       \
            ...
            magmablas_dtranspose2(      X, m, blockW, n, n, m );            \
}
...
//                magma_dtrsm( MagmaRight, MagmaUpper, MagmaNoTrans, MagmaNonUnit, 
  //                           m, cBlockSize, c_one, dwork, cBlockSize, blockAP, m);
            ...
            magmablas_dlaset_identity(ldgram, ldgram, gramB, ldgram);
            ...
            magmablas_dlaset_identity(ldgram, ldgram, gramA, ldgram);
