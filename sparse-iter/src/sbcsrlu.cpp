/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zbcsrlu.cpp normal z -> s, Fri May 30 10:41:42 2014
*/
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_s_sparse_matrix A                   descriptor for matrix A
    magma_s_vector b                          RHS b vector
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_s_sparse_matrix A           input matrix A (on DEV)
    magma_s_sparse_matrix *M          output matrix containing LU decomposition
...
magma_sbcsrlutrf( magma_s_sparse_matrix A, magma_s_sparse_matrix *M, 
    ...
    cublasSetVector(  A.numblocks, sizeof(float *), 
                                                        hA, 1, dA, 1 );
    cublasSetVector(  A.numblocks, sizeof(float *), 
                                                        hB, 1, dB, 1 );
    cublasSetVector(  (M->numblocks-A.numblocks), 
                        sizeof(float *), hC, 1, dC, 1 );
    ...
    for( k=0; k<r_blocks; k++){
        ...
        cublasSetVector( klblocks, sizeof(float *), hBL, 1, 
                                                                    dBL, 1 );
        ...
        cublasSetVector( num_block_rows, sizeof(float *), hA, 1, 
                                                        dA, 1 );
        cublasSetVector( kblocks, sizeof(float *), hB, 1, dB, 1 );
        ...
        cublasSetVector( kblocks*num_block_rows, sizeof(float *), 
                                                                hC, 1, dC, 1 );
        ...
        // AIs and BIs for the batched GEMMs later
            ...
            cublasSetVector( kblocks*num_block_rows, 
                        sizeof(float *), AIs, 1, dAIs, 1 );
            cublasSetVector( kblocks*num_block_rows, 
                        sizeof(float *), BIs, 1, dBIs, 1 );
        }  
...
magma_sbcsrlusv( magma_s_sparse_matrix A, magma_s_vector b, magma_s_vector *x,  
    ...
    // set x = b
    cudaMemcpy( x->val, b.val, A.num_rows*sizeof( float ), 
