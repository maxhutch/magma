/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zlobpcg.cpp normal z -> s, Tue Sep  2 12:38:34 2014
*/
...
magma_scompact(magma_int_t m, magma_int_t n,
               float *dA, magma_int_t ldda,
               float *dnorms, float tol, 
               magma_int_t *activeMask, magma_int_t *cBlockSize);

extern "C" magma_int_t
magma_scompactActive(magma_int_t m, magma_int_t n,
                     float *dA, magma_int_t ldda, 
                     magma_int_t *active);
//==================================================================================
