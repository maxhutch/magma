/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zbailu.cpp normal z -> s, Fri May 30 10:41:41 2014
*/
// includes CUDA
...
magma_ialusetup( magma_s_sparse_matrix A, magma_s_preconditioner *precond ){
    ...
    magma_s_sparse_matrix hA, hAL, hALCOO, hAU, hAUT, hAUCOO, dAL, dAU, hL, hU, 
                                        dL, dU, DL, RL, DU, RU;
...
magma_saiccsetup( magma_s_sparse_matrix A, magma_s_preconditioner *precond ){
    ...
    magma_s_sparse_matrix hA, hAL, hALCOO, dAL, hL, dL, DL, RL;
