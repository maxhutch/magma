/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from magma_zcuspaxpy.cpp normal z -> s, Sat Nov 15 19:54:22 2014
       @author Hartwig Anzt
...
magma_scuspaxpy(
    float *alpha, magma_s_sparse_matrix A, 
    ...
    magma_queue_t queue )
{
    if (    A.memory_location == Magma_DEV 
        ...
        && ( B.storage_type == Magma_CSR ||
            ...
            stat_dev += magma_smalloc( &C.dval, C.nnz );
            if( stat_dev != 0 ){
                magma_s_mfree( &C, queue );
                return MAGMA_ERR_DEVICE_ALLOC;
            }

            cusparseScsrgeam(handle, A.num_rows, A.num_cols,
                    alpha,
                    descrA, A.nnz,
            ...
            magma_s_mtransfer( C, AB, Magma_DEV, Magma_DEV, queue );
            magma_s_mfree( &C, queue );
