/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zcuilu.cpp normal z -> c, Fri May 30 10:41:42 2014
*/
// includes CUDA
...
magma_ccuilusetup( magma_c_sparse_matrix A, magma_c_preconditioner *precond ){
        ...
        // copy matrix into preconditioner parameter
            magma_c_mtransfer(A, &(precond->M), A.memory_location, Magma_DEV);
    ...
    magma_c_sparse_matrix hA, hL, hU;
...
magma_ccuiccsetup( magma_c_sparse_matrix A, magma_c_preconditioner *precond ){
    ...
    magma_c_sparse_matrix hA, U, hD, hR, hAt;
    magma_c_mtransfer( A, &hA, A.memory_location, Magma_CPU );
    U.diagorder_type = Magma_VALUE;
    magma_c_mconvert( hA, &U, Magma_CSR, Magma_CSRL);
