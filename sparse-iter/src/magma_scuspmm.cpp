/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magma_zcuspmm.cpp normal z -> s, Tue Sep  2 12:38:35 2014
       @author Hartwig Anzt
...
magma_scuspmm( magma_s_sparse_matrix A, magma_s_sparse_matrix B, 
    ...
    if(    A.memory_location == Magma_DEV 
        ...
        && ( B.storage_type == Magma_CSR ||
            ...
            magma_s_mtransfer( C, AB, Magma_DEV, Magma_DEV );
            magma_s_mfree( &C );
