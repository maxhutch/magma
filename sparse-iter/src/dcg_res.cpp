/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zcg_res.cpp normal z -> d, Tue Sep  2 12:38:34 2014
*/
...
/**
    ...
    @ingroup magmasparse_dhesv
    ********************************************************************/

magma_int_t
magma_dcg_res( magma_d_sparse_matrix A, magma_d_vector b, magma_d_vector *x,  
    ...
    magma_dcopy( dofs, b.val, 1, p.val, 1 );                    // p = b
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        res = betanom = magma_dnrm2(dofs, r.val, 1);       // betanom = || r ||
