/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zbicgstab_merge.cpp normal z -> d, Tue Sep  2 12:38:34 2014
       @author Hartwig Anzt
...
magma_dbicgstab_merge( magma_d_sparse_matrix A, magma_d_vector b, 
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        magma_dmdotc( dofs, 1, q.val, v.val, d1, d2, skp );                     
        magma_dbicgmerge4(  1, skp );
        magma_dbicgmerge2( dofs, skp, r.val, v.val, s.val );    // s=r-alpha*v

        magma_d_spmv( c_one, A, s, c_zero, t );                 // t=As

        magma_dmdotc( dofs, 2, q.val+4*dofs, t.val, d1, d2, skp+6 );
        magma_dbicgmerge4(  2, skp );

        magma_dbicgmerge_xrbeta( dofs, d1, d2, q.val, r.val, p.val, 
