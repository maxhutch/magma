/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zjacobi.cpp normal z -> d, Tue Sep  2 12:38:34 2014
*/
...
magma_djacobisetup_vector( magma_d_vector b, magma_d_vector d, 
    ...
    if( b.memory_location == Magma_CPU ){
        ...
        // fill vector
        magma_d_vector tmp;
        magma_d_vinit( &tmp, Magma_DEV, b.num_rows, MAGMA_D_ZERO );
...
magma_int_t
magma_djacobiiter_precond( magma_d_sparse_matrix M, magma_d_vector *x, 
    ...
    for( magma_int_t i=0; i<solver_par->maxiter; i++ ){
        magma_d_spmv( c_mone, M, *x, c_zero, precond->work2 );   // t = - M * x
        magma_daxpy( dofs, c_one , 
