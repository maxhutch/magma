/*
    -- MAGMA (version 1.6.3-beta1) --
       ...
       @generated from zpbicgstab.cpp normal z -> s, Tue Aug 25 16:35:33 2015
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    do
    {
        ...
        // preconditioner
        CHECK( magma_s_applyprecond_left( A, p, &mt, precond_par, queue ));
        CHECK( magma_s_applyprecond_right( A, mt, &y, precond_par, queue ));
        ...
        // preconditioner
        CHECK( magma_s_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_s_applyprecond_right( A, ms, &z, precond_par, queue ));

        CHECK( magma_s_spmv( c_one, A, z, c_zero, t, queue ));       // t=As

        // preconditioner
        CHECK( magma_s_applyprecond_left( A, s, &ms, precond_par, queue ));
        CHECK( magma_s_applyprecond_left( A, t, &mt, precond_par, queue ));
