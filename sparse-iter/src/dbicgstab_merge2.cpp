/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zbicgstab_merge2.cpp normal z -> d, Sat Nov 15 19:54:22 2014
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        magma_dbicgmerge_spmv1(  A, d1, d2, q(2), q(0), q(3), skp, queue );          
        magma_dbicgmerge2( dofs, skp, r.dval, v.dval, s.dval, queue );   // s=r-alpha*v
        magma_dbicgmerge_spmv2( A, d1, d2, q(4), q(5), skp, queue ); 
