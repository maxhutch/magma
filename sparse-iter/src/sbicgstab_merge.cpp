/*
    -- MAGMA (version 1.6.1) --
       ...
       @generated from zbicgstab_merge.cpp normal z -> s, Fri Jan 30 19:00:30 2015
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        magma_smdotc( dofs, 1, q.dval, v.dval, d1, d2, skp, queue );                     
        magma_sbicgmerge4(  1, skp, queue );
        magma_sbicgmerge2( dofs, skp, r.dval, v.dval, s.dval, queue );    // s=r-alpha*v

        magma_s_spmv( c_one, A, s, c_zero, t, queue );                 // t=As

        magma_smdotc( dofs, 2, q.dval+4*dofs, t.dval, d1, d2, skp+6, queue );
        magma_sbicgmerge4(  2, skp, queue );

        magma_sbicgmerge_xrbeta( dofs, d1, d2, q.dval, r.dval, p.dval, 
