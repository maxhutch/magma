/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zbpcg.cpp normal z -> d, Fri Sep 11 18:29:44 2015
*/
    ...
    magma_queue_t queue )
{
    ...
    // preconditioner
    CHECK( magma_d_applyprecond_left( A, r, &rt, precond_par, queue ));
    CHECK( magma_d_applyprecond_right( A, rt, &h, precond_par, queue ));
