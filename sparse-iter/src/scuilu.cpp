/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zcuilu.cpp normal z -> s, Fri Jul 18 17:34:29 2014
*/
// includes CUDA
...
magma_scuilusetup( magma_s_sparse_matrix A, magma_s_preconditioner *precond ){
        ...
        magma_s_mconvert( hA, &hACSR, hA.storage_type, Magma_CSR);
        magma_s_mtransfer(hACSR, &(precond->M), Magma_CPU, Magma_DEV);
        magma_s_mfree( &hA );
        magma_s_mfree( &hACSR );
...
magma_scuiccsetup( magma_s_sparse_matrix A, magma_s_preconditioner *precond ){
    ...
    magma_s_mconvert( hA, &hACSR, hA.storage_type, Magma_CSR);
    magma_s_mconvert( hACSR, &U, Magma_CSR, Magma_CSRL);
    magma_s_mfree( &hACSR );
