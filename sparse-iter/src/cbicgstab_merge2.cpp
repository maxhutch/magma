/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zbicgstab_merge2.cpp normal z -> c, Fri May 30 10:41:41 2014
       @author Hartwig Anzt
...
magma_cbicgstab_merge2( magma_c_sparse_matrix A, magma_c_vector b, 
    ...
    cudaMemcpy( skp, skp_h, 8*sizeof( magmaFloatComplex ), 
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        magma_cbicgmerge_spmv1(  A, d1, d2, q(2), q(0), q(3), skp );          
        magma_cbicgmerge2( dofs, skp, r.val, v.val, s.val );   // s=r-alpha*v
        magma_cbicgmerge_spmv2( A, d1, d2, q(4), q(5), skp); 
        magma_cbicgmerge_xrbeta( dofs, d1, d2, q(0), q(1), q(2), 
                                                    q(4), q(5), x->val, skp);  

        // check stopping criterion (asynchronous copy)
        cublasGetVectorAsync(1 , sizeof( magmaFloatComplex ), skp+5, 1, 
                                                        skp_h+5, 1, stream[1] );
