/*
    -- MAGMA (version 1.6.1) --
       ...
       @generated from magma_zcuspaxpy.cpp normal z -> d, Fri Jan 30 19:00:30 2015
       @author Hartwig Anzt
...
magma_dcuspaxpy(
    double *alpha, magma_d_sparse_matrix A, 
    double *beta, magma_d_sparse_matrix B, 
    ...
    magma_queue_t queue )
{
    if (    A.memory_location == Magma_DEV 
        ...
        && ( B.storage_type == Magma_CSR ||
            ...
            stat_dev += magma_dmalloc( &C.dval, C.nnz );
            if( stat_dev != 0 ){
            ...
            magma_d_mtransfer( C, AB, Magma_DEV, Magma_DEV, queue );
            magma_d_mfree( &C, queue );
