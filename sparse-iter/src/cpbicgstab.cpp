/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zpbicgstab.cpp normal z -> c, Sat Nov 15 19:54:22 2014
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    magma_c_vinit( &ms, Magma_DEV, dofs, c_zero, queue );
    magma_c_vinit( &mt, Magma_DEV, dofs, c_zero, queue );
    magma_c_vinit( &y, Magma_DEV, dofs, c_zero, queue );
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        // preconditioner
        magma_c_applyprecond_left( A, p, &mt, precond_par, queue );      
        magma_c_applyprecond_right( A, mt, &y, precond_par, queue );        

        magma_c_spmv( c_one, A, y, c_zero, v, queue );              // v = Ap
        ...
        // preconditioner
        magma_c_applyprecond_left( A, s, &ms, precond_par, queue ); 
        magma_c_applyprecond_right( A, ms, &z, precond_par, queue );      

        magma_c_spmv( c_one, A, z, c_zero, t, queue );               // t=As

        // preconditioner
        magma_c_applyprecond_left( A, s, &ms, precond_par, queue );      
        magma_c_applyprecond_left( A, t, &mt, precond_par, queue );        
    ...
    magma_c_vfree(&ms, queue );
    magma_c_vfree(&mt, queue );
