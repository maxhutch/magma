/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zcg.cpp normal z -> s, Fri May 30 10:41:41 2014
*/
...
magma_int_t
magma_scg( magma_s_sparse_matrix A, magma_s_vector b, magma_s_vector *x,  
    ...
    for( solver_par->numiter= 1; solver_par->numiter<solver_par->maxiter; 
        ...
        betanom = magma_snrm2(dofs, r.val, 1);             // betanom = || r ||
