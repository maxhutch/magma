/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from sparse-iter/testing/testing_zpreconditioner.cpp normal z -> s, Fri Jan 22 21:42:52 2016
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        //preconditioner
        CHECK( magma_s_precondsetup( B_d, b, &zopts.solver_par, &zopts.precond_par, queue ) );
