/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/testing/testing_zpreconditioner.cpp, normal z -> d, Tue Aug 30 09:39:21 2016
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        //preconditioner
        TESTING_CHECK( magma_d_precondsetup( B_d, b, &zopts.solver_par, &zopts.precond_par, queue ) );
        
        double residual;
        TESTING_CHECK( magma_dresidual( B_d, b, x, &residual, queue ));
        ...
        TESTING_CHECK( magma_dresidual( B_d, b, x1, &residual, queue ));
        ...
        TESTING_CHECK( magma_dresidual( B_d, b, x2, &residual, queue ));
        printf("%.8e  %.8e\n", tempo2-tempo1, residual );
