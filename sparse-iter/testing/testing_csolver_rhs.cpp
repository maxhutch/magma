/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/testing/testing_zsolver_rhs.cpp, normal z -> c, Tue Aug 30 09:39:21 2016
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        //TESTING_CHECK( magma_cvinit( &b_h, Magma_CPU, A.num_cols, 1, MAGMA_C_ONE, queue ));
