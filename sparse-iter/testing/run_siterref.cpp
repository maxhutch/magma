/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from run_ziterref.cpp normal z -> s, Fri May 30 10:41:49 2014
       @author Hartwig Anzt
*/
...
int main( int argc, char** argv)
{
    ...
    for( i = 1; i < argc; ++i ) {
     if ( strcmp("--format", argv[i]) == 0 ) {
            ...
            sscanf( argv[++i], "%f", &precond_par.epsilon );
    ...
    while(  i < argc ){
        ...
        magma_siterref( B_d, b, &x, &solver_par, &precond_par );
