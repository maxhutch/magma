/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/testing/testing_zsolver.cpp, normal z -> s, Tue Aug 30 09:39:21 2016
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while( i < argc ) {
        ...
        TESTING_CHECK( magma_svinit( &b, Magma_DEV, A.num_rows, 1, one, queue ));
