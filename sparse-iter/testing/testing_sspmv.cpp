/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from testing_zspmv.cpp normal z -> s, Sat Nov 15 19:54:24 2014
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    while(  i < argc ) {
        ...
        // init CPU vectors
        magma_s_vinit( &hx, Magma_CPU, hA.num_rows, c_zero, queue );
        magma_s_vinit( &hy, Magma_CPU, hA.num_rows, c_zero, queue );

        // init DEV vectors
        magma_s_vinit( &dx, Magma_DEV, hA.num_rows, c_one, queue );
        magma_s_vinit( &dy, Magma_DEV, hA.num_rows, c_zero, queue );
