/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/testing/testing_zsort.cpp, normal z -> s, Tue Aug 30 09:39:20 2016
       @author Hartwig Anzt
*/
...
int main(  int argc, char** argv )
{
    ...
    printf("sorting...");
    TESTING_CHECK( magma_sindexsort(x, 0, n-1, queue ));
    printf("done.\n\n");
    ...
    TESTING_CHECK( magma_smalloc_cpu( &y, n ));
    printf("unsorted:\n");
    srand(time(NULL));
    for(i = 0; i < n; i++ ){
    ...
    printf("sorting...");
    TESTING_CHECK( magma_ssort(y, 0, n-1, queue ));
    printf("done.\n\n");
    ...
    while( i < argc ) {
        ...
        TESTING_CHECK( magma_sdomainoverlap( A.num_rows, &num_ind, A.row, A.col, x, queue ));
