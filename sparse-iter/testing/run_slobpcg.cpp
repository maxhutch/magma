/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from run_zlobpcg.cpp normal z -> s, Fri Jul 18 17:34:31 2014
       @author Hartwig Anzt
*/
...
int main( int argc, char** argv)
{
    ...
    while(  i < argc ){
        ...
        magma_s_sparse_matrix A2;
        A2.storage_type = Magma_SELLC;
        A2.blocksize = 8;
        A2.alignment = 4;
        magma_s_mconvert( A, &A2, Magma_CSR, A2.storage_type );

        // copy matrix to GPU                                                     
        magma_s_mtransfer( A2, &dA, Magma_CPU, Magma_DEV);

        magma_ssolverinfo_init( &solver_par, &precond_par ); // inside the loop!
