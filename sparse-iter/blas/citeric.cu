/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from sparse-iter/blas/ziteric.cu normal z -> c, Fri Jan 22 21:42:16 2016
    ...
    magma_queue_t queue )
{
    ...
    magma_citeric_csr_kernel<<< grid, block, 0, queue->cuda_stream() >>>
            ( A.num_rows, A.nnz, 
