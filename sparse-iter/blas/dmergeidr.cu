/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zmergeidr.cu normal z -> d, Fri Sep 11 18:29:42 2015
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    magma_didr_smoothing_1_kernel<<<Gs, Bs, 0, queue>>>( num_rows, num_cols, drs, dr, dt );
    ...
    magma_queue_t queue )
{
    dim3 Bs( BLOCK_SIZE );
    dim3 Gs( magma_ceildiv( num_rows, BLOCK_SIZE ) );
    magma_didr_smoothing_2_kernel<<<Gs, Bs, 0, queue>>>( num_rows, num_cols, omega, dx, dxs);
