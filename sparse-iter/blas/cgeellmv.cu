/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zgeellmv.cu normal z -> c, Fri May 30 10:41:36 2014
...
//Michael Garland
__global__ void 
cgeellmv_kernel_shift( int num_rows, 
                       int num_cols,
                       int num_cols_per_row,
                       magmaFloatComplex alpha, 
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magmaFloatComplex *d_val       array containing values of A in ELLPACK
...
magma_cgeellmv(magma_trans_t transA,
   ...
   cgeellmv_kernel<<< grid, BLOCK_SIZE, 0, magma_stream >>>
...
magma_cgeellmv_shift( magma_trans_t transA,
   ...
   cgeellmv_kernel_shift<<< grid, BLOCK_SIZE, 0, magma_stream >>>
