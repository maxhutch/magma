/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zaicc_chow_csr_s.cu normal z -> s, Fri May 30 10:41:37 2014
...
__global__ void 
magma_saic_csr_s_kernel( magma_int_t num_rows, 
                         magma_int_t nnz,
...
*/
        ...
        // modify entry
        if (i == j)
            val[k] = MAGMA_S_MAKE(sqrt(abs(MAGMA_S_REAL(s))), 0.0);
        else
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magma_s_sparse_matrix A_L               input matrix L
    magma_s_sparse_matrix A_U               input matrix U
    magma_s_sparse_matrix L                 input/output matrix L
    magma_s_sparse_matrix U                 input/output matrix U
...
magma_saic_csr_s( magma_s_sparse_matrix A,
    ...
    magma_saic_csr_s_kernel<<< grid, block, 0, magma_stream >>>
