/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zaicc_chow_csr_s.cu normal z -> s, Fri Jul 18 17:34:28 2014
...
*/
        ...
        // modify entry
        if (i == j)
            A2[k] = MAGMA_S_MAKE(sqrt(abs(MAGMA_S_REAL(s))), 0.0);
        else
...
magma_saic_csr_s( magma_s_sparse_matrix A,
    ...
    magma_s_vector A2;
            ...
            // init DEV vectors
    magma_s_vinit( &A2, Magma_DEV, A.nnz, MAGMA_S_ONE );    
    ...
    magma_scopy( A.nnz, A2.val, 1, A_CSR.val, 1 );                            // rr = b
