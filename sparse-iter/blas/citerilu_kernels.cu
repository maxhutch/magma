/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from sparse-iter/blas/ziterilu_kernels.cu, normal z -> c, Tue Aug 30 09:38:45 2016
    ...
    magma_queue_t queue )
{
    ...
    magma_citerilu_csr_kernel<<< grid, block, 0, queue->cuda_stream() >>>
        ( A.num_rows, A.nnz, 
