/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zmergebicgstab.cu normal z -> d, Fri Sep 11 18:29:42 2015
       @author Hartwig Anzt
    ...
    magma_queue_t queue )
{
    ...
    magma_dbicgmerge1_kernel<<<Gs, Bs, 0, queue>>>( n, skp, v, r, p );
    ...
    magma_queue_t queue )
{
    ...
    magma_dbicgmerge2_kernel<<<Gs, Bs, 0, queue>>>( n, skp, r, v, s );
    ...
    magma_queue_t queue )
{
    dim3 Bs( BLOCK_SIZE );
    dim3 Gs( magma_ceildiv( n, BLOCK_SIZE ) );
    magma_dbicgmerge3_kernel<<<Gs, Bs, 0, queue>>>( n, skp, p, s, t, x, r );
