...
__global__ void 
magma_zlobpcg_shift_kernel( magma_int_t num_rows, magma_int_t num_vecs, 
        magma_int_t shift, magmaDoubleComplex *x ){
...
magma_zlobpcg_shift(    magma_int_t num_rows,
    ...
    magma_zlobpcg_shift_kernel<<< grid, block, Ms, magma_stream >>>
