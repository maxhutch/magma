/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zaicc_chow_csr_a.cu normal z -> d, Fri Jul 18 17:34:28 2014
...
__global__ void 
magma_daic_csr_a_kernel(    magma_int_t n, 
                            magma_int_t nnz, 
...
*/
        ...
        // modify entry
        if (i == j)
            val[il-1] = MAGMA_D_MAKE(sqrt(abs(MAGMA_D_REAL(s))), 0.0);
        else
            val[il-1] =  s / val[iu-1];
    }
...
magma_daic_csr_a( magma_d_sparse_matrix A,
    ...
    magma_daic_csr_a_kernel<<< grid, block, 0, magma_stream >>>
            ( A.num_rows, A.nnz, 
