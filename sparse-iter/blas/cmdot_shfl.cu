/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from sparse-iter/blas/zmdot_shfl.cu normal z -> c, Wed Jan  6 17:59:41 2016
    ...
    magma_queue_t queue )
{
    if (k==1) { // call CUBLAS dotc, we will never be faster
        magmaFloatComplex res =  magma_cdotc(n,v,1,r,1);
        magma_csetvector(1,&res,1,skp,1);
    } else {
#if MIN_CUDA_ARCH < 300
