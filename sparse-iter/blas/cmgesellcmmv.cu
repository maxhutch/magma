/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zmgesellcmmv.cu normal z -> c, Fri May 30 10:41:37 2014
...
zmgesellptmv_kernel_8_3D( int num_rows, 
                     ...
                     magma_index_t *d_colind,
                     magma_index_t *d_rowptr,
                     const magmaFloatComplex* __restrict__ d_x,
                     magmaFloatComplex beta, 
                     magmaFloatComplex *d_y)
{
   // T threads assigned to each row
...
/*  -- MAGMA (version 1.5.0-beta2) --
    ...
    magmaFloatComplex *d_val       array containing values of A in SELLP
