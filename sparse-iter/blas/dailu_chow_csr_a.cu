/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zailu_chow_csr_a.cu normal z -> d, Fri Jul 18 17:34:28 2014
...
__global__ void 
magma_dailu_csr_a_kernel(   magma_int_t num_rows, 
                            magma_int_t nnz,  
...
// every row is handled by one threadblock
__global__ void 
magma_dailu_csr_a_kernel(   magma_int_t Lnum_rows, 
                            magma_int_t Lnnz,  
...
magma_dailu_csr_a( magma_d_sparse_matrix A,
    ...
    magma_dailu_csr_a_kernel<<< grid, block, 0, magma_stream >>>
        ( A.num_rows, A.nnz, 
