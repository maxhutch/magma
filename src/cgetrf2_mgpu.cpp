/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zgetrf2_mgpu.cpp normal z -> c, Fri Apr 25 15:05:37 2014
...
#define W(j) (w+((j)%num_gpus)*nb*ldw)
    ...
    *info = 0;
    ...
    magmablas_ctranspose2( d_lAP[0], maxm, dAT(0,0,0), lddat, nb0, m );
        ...
        for( dd=0; dd < num_gpus; dd++ ) {
            ...
            if ( d == (i+1)%num_gpus ) {
                ...
                if ( nb0 > 0 ) {
                    ...
                    magmablas_ctranspose2( &d_lAP[d][((i+1)%h)*nb*maxm], ldda, dAT(d,loff,i_local), lddat, nb0, m-(i+1)*nb );
