/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zlatrd2.cpp normal z -> c, Fri Sep 11 18:29:30 2015
        ...
        for (i = n-1; i >= n - nb; --i) {
            ...
            if (i > 0) {
                ...
                *A(i-1,i) = MAGMA_C_ONE;
                ...
                magma_csetvector_async( i, A(0, i), 1, dA(0, i), 1, stream );
        ...
        for (i = 0; i < nb; ++i) {
            ...
            if (i < n-1) {
                ...
                *A(i+1,i) = MAGMA_C_ONE;
                ...
                magma_csetvector_async( i_n, A(i+1, i), 1, dA(i+1, i), 1, stream );
