/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zgetrf2_mgpu.cpp normal z -> s, Tue Sep  2 12:38:19 2014
...
/**
    ...
    @param[in,out]
    d_lAT   REAL array of pointers on the GPU, dimension (num_gpus).
    ...
    d_lAP   REAL array of pointers on the GPU, dimension (num_gpus).
    ...
    @param (workspace)
    w       REAL array, dimension (num_gpus*nb*maxm).
