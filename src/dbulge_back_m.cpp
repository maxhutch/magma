/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zbulge_back_m.cpp normal z -> d, Fri Apr 25 15:05:50 2014
...
public:
    ...
    magma_dapplyQ_m_data(magma_int_t nrgpu_, magma_int_t threads_num_, magma_int_t n_, magma_int_t ne_, magma_int_t n_gpu_,
...
magma_dbulge_back_m(magma_int_t nrgpu, magma_uplo_t uplo,
...
//n_gpu = ne;
    if (n_gpu < ne) {
        ...
        magma_dbulge_applyQ_v2_m(nrgpu, MagmaLeft, ne, n, nb, Vblksiz, Z, ldz, V, ldv, T, ldt, info);
        magma_device_sync();
    }
...
static void *magma_dapplyQ_m_parallel_section(void *arg)
{
    ...
    if (my_core_id == 0) {
        ...
        magma_dbulge_applyQ_v2_m(nrgpu, MagmaLeft, n_gpu, n, nb, Vblksiz, E, lde, V, ldv, T, ldt, &info);
        magma_device_sync();
