/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zpotrf3_mgpu.cpp normal z -> s, Fri May 30 10:40:56 2014
...
magma_spotrf3_mgpu(magma_int_t num_gpus, magma_uplo_t uplo, magma_int_t m, magma_int_t n,
...
#if (defined(PRECISION_d) || defined(PRECISION_s)) && defined(STRSM_WORK)
                        magmablas_slaset( MagmaUpperLower, trsm_nb, trsm_n, dinvA(d,0),trsm_nb );
                        magmablas_slaset( MagmaUpperLower, nb0,jb, dx(d,0),nb0 );
...
#if (defined(PRECISION_d) || defined(PRECISION_s)) && defined(STRSM_WORK)
                        magmablas_slaset( MagmaUpperLower, trsm_nb,trsm_n, dinvA(d,0),trsm_nb );
                        magmablas_slaset( MagmaUpperLower, nb2,jb, dx(d,0),nb2 );
                        magmablas_strsm_work( MagmaLeft, MagmaUpper,
                                              MagmaTrans, MagmaNonUnit,
                                              jb, nb2, c_one,
                                              dlpanel, ldpanel,
                ...
                if ( j+jb < m ) {
                    ...
                    if ( nb2 > 0 ) {
                        ...
                        if (flag == 0) {
                            ...
                            magmablas_slaset( MagmaUpperLower, trsm_nb,trsm_n, dinvA(d,flag),trsm_nb );
                            magma_queue_wait_event( stream[d][stream2], event[d][1] ); // panel received
                        }
                        magmablas_slaset( MagmaUpperLower, nb2,jb, dx(d,1),nb2 );
...
extern "C" magma_int_t
magma_shtodpo(magma_int_t num_gpus, magma_uplo_t uplo, magma_int_t m, magma_int_t n,
              magma_int_t off_i, magma_int_t off_j, magma_int_t nb,
...
extern "C" magma_int_t
magma_sdtohpo(magma_int_t num_gpus, magma_uplo_t uplo, magma_int_t m, magma_int_t n,
