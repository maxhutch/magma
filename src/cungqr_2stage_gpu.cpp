/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zungqr_2stage_gpu.cpp normal z -> c, Fri Jul 18 17:34:19 2014
    ...
    *info = 0;
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= nb; i -= nb) {
            ...
            //                  dA(i,i), ldda * sizeof(magmaFloatComplex),
            ...
            //                 work, &lwork, &iinfo);
            //cudaMemcpy2DAsync(dA(i,i), ldda * sizeof(magmaFloatComplex),
