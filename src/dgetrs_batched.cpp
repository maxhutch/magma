/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zgetrs_batched.cpp normal z -> d, Sat Nov 15 19:54:10 2014
*/
                  ...
                  magma_int_t batchCount)
{
    ...
    dset_pointer(dinvA_array, dinvA, ((n+TRI_NB-1)/TRI_NB)*TRI_NB, 0, 0, invA_msize, batchCount);
    ...
    if (notran) {
        magma_dlaswp_rowserial_batched(nrhs, dB_array, lddb, 1, n, dipiv_array, batchCount);
