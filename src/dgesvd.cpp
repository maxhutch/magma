    ...
    *info = 0;
    ...
    if (*info == 0) {
        if (m >= n && minmn > 0) {
            ...
            #if VERSION == 1
            lapackf77_dorgbr( "P", &n, &n, &n, NULL, &n, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaP,   n,  n,  n, NULL,  n, NULL, dummy,  ineg_one, &ierr );
            #endif
            ...
            #if VERSION == 1
            lapackf77_dorgbr( "Q", &m, &m, &n, NULL, &m, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaQ,   m,  m,  n, NULL,  m, NULL, dummy,  ineg_one, &ierr );
            #endif
            magma_int_t lwork_dorgbr_q_mm = magma_int_t( real( dummy[0] ));
            
            #if VERSION == 1
            lapackf77_dorgbr( "Q", &n, &n, &n, NULL, &n, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaQ,   n,  n,  n, NULL,  n, NULL, dummy,  ineg_one, &ierr );
            #endif
            ...
            #if VERSION == 1
            lapackf77_dormbr( "Q", "R", "N",                &m, &n, &n, NULL, &m, NULL, NULL, &m, dummy, &ineg_one, &ierr );
            #else
            magma_dormbr( MagmaQ, MagmaRight, MagmaNoTrans,  m,  n,  n, NULL,  m, NULL, NULL,  m, dummy,  ineg_one, &ierr );
            #endif
            ...
            #if VERSION == 1
            lapackf77_dorgbr( "P", &m, &m, &m, NULL, &m, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaP,   m,  m,  m, NULL,  m, NULL, dummy,  ineg_one, &ierr );
            #endif
            ...
            #if VERSION == 1
            lapackf77_dorgbr( "P", &n, &n, &m, NULL, &n, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaP,   n,  n,  m, NULL,  n, NULL, dummy,  ineg_one, &ierr );
            #endif
            magma_int_t lwork_dorgbr_p_nn = magma_int_t( real( dummy[0] ));
            
            #if VERSION == 1
            lapackf77_dorgbr( "Q", &m, &m, &m, NULL, &m, NULL, dummy, &ineg_one, &ierr );
            #else
            magma_dorgbr( MagmaQ,   m,  m,  m, NULL,  m, NULL, dummy,  ineg_one, &ierr );
            #endif
            magma_int_t lwork_dorgbr_q_mm = magma_int_t( real( dummy[0] ));
            ...
            // missing from LAPACK, since it occurs only in slow paths
            #if VERSION == 1
            lapackf77_dormbr( "P", "L", "T",             &m, &n, &m, NULL, &m, NULL, NULL, &m, dummy, &ineg_one, &ierr );
            #else
            magma_dormbr( MagmaP, MagmaLeft, MagmaTrans,  m,  n,  m, NULL,  m, NULL, NULL,  m, dummy,  ineg_one, &ierr );
            #endif
