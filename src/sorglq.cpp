/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from src/zunglq.cpp normal z -> s, Mon May  2 23:30:09 2016
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    //if (lwork < lwkopt) {
    //    magma_smalloc_cpu( &work2, lwkopt );
    //}
    //else {
    //    work2 = work;
    //}
    ...
    magmaFloat_ptr dV; dV = dA + ldda*n;
    magmaFloat_ptr dW; dW = dA + ldda*n + n*nb;
    magmaFloat_ptr dT; dT = dA + ldda*n + n*nb + lddwork*nb;
