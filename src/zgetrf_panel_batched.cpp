    ...
    magma_int_t batchCount, magma_queue_t stream, cublasHandle_t myhandle)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_zdisplace_pointers(dW5_displ, dA_array, ldda, p1, p2, batchCount); 
        ...
        magma_zdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount); 
        ...
        magma_zdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount); // no need since it is above
