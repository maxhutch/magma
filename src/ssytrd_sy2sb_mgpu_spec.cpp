/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zhetrd_he2hb_mgpu_spec.cpp normal z -> s, Fri Apr 25 15:05:51 2014
...
magma_ssytrd_sy2sb_mgpu_spec( magma_uplo_t uplo, magma_int_t n, magma_int_t nb,
                    ...
                    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    for( magma_int_t dev = 0; dev < ngpu; ++dev ) {
        ...
        magma_smalloc_pinned ( &workngpu[dev], worksiz);
    ...
    magma_smalloc_pinned ( &workngpu[ngpu], worksiz);
    float *worktest = NULL;
    //magma_smalloc_cpu( &worktest, n*nb ); // not used
    // ======================
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                ...
                spanel_to_q(MagmaUpper, pn-1, A(i, i+1), lda, work);
                ...
                /*
                magma_device_sync();
                cudaMemcpy2DAsync(A(i,i), lda*sizeof(float),
                                 dA(idev,i,di+1), ldda*sizeof(float),
                                 (pm+pn)*sizeof(float), pn,
                ...
                */
                ...
                //magma_setdevice( 0 );
                sq_to_panel(MagmaUpper, pn-1, A(i, i+1), lda, work);
            }
            ...
            spanel_to_q(MagmaUpper, pk, A(indi, indj), lda, work);
            ...
            sq_to_panel(MagmaUpper, pk, A(indi, indj), lda, work);
            // ===============================================
            ...
            if (i + nb <= n-nb) {
                ...
                spanel_to_q(MagmaUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
                magma_sgetmatrix( pk, pk,
                                  dA(idev, indi, di+1), ldda,
                                  A(n-pk+1, n-pk+1),  lda );
                sq_to_panel(MagmaUpper, pk-1, A(n-pk+1, n-pk+2), lda, work);
            }
