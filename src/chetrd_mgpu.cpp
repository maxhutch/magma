/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Tue Aug 13 16:44:36 2013
...
magma_chetrd_mgpu(magma_int_t num_gpus, magma_int_t k, char uplo, magma_int_t n,
...
//#define PROFILE_SY2RK
    ...
    magma_setdevice(0);
    if( MAGMA_SUCCESS != magma_cmalloc_pinned( &hwork, k*num_gpus*n ) ) {
    ...
    if (upper) {
        ...
        for (i = nb*((n-1)/nb); i >= nx; i -= nb) {
            ...
            magma_cher2k_mgpu(num_gpus, 'U', 'N', nb, i, ib,
...
#endif
            magma_cher2k_mgpu(num_gpus, 'L', 'N', nb, n-i-ib, ib,
...
extern "C" magma_int_t
magma_chtodhe(magma_int_t num_gpus, char *uplo, magma_int_t n, magma_int_t nb,
              magmaFloatComplex *a, magma_int_t lda,
...
magma_cher2k_mgpu(
    ...
    magmaFloatComplex **db, magma_int_t lddb, magma_int_t offset_b,
    float beta,
...
magma_chetrd_mgpu(magma_int_t num_gpus, magma_int_t k, char uplo, magma_int_t n,
                  ...
                  magma_int_t *info)
{
    printf("magma_chetrd_mgpu is not supported on this GPU. Exit.\n");
    exit(1);
}
