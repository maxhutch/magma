/*
   ...
   @generated from src/zgetrf_batched.cpp, normal z -> c, Sun Nov 20 20:20:26 2016
*/
...
#define RUN_ALL
        ...
        magma_cdisplace_pointers(dW0_displ, dA_array, ldda, i, 0, batchCount, queue);
        ...
        if ( (i + ib) < n)
        {
            ...
            magma_cdisplace_pointers(dA_displ, dA_array, ldda, i, i+ib, batchCount, queue);
