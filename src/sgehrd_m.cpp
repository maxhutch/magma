/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from src/zgehrd_m.cpp normal z -> s, Fri Jan 22 21:41:52 2016
       @author Mark Gates
*/
    ...
    if (nb == 1 || nb >= nh) {
        ...
        for( d = 0; d < ngpu; ++d ) {
            ...
            ldwork = nlocal*ldda   // A
                   ...
                   + nb*ldda       // W
                   + nb*nb;        // Ti
            if ( MAGMA_SUCCESS != magma_smalloc( &data.A[d], ldwork )) {
        ...
        magma_ssetmatrix_1D_col_bcyclic( n, n, A, lda, data.A, ldda, ngpu, nb, data.queues );
