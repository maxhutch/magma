/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @author Stan Tomov
       @generated from zlabrd_gpu.cpp normal z -> s, Fri May 30 10:41:09 2014
                  ...
                  float *dY, magma_int_t lddy)
{
    ...
    if (m >= n) {
        ...
        for (i__ = 1; i__ <= nb; ++i__) {
            ...
            lapackf77_slacgv( &i__3, &Y[i__+y_dim1], &ldy );
            #endif
            blasf77_sgemv("No transpose", &i__2, &i__3, &c_neg_one, &A[i__ + a_dim1], &lda,
                   &Y[i__+y_dim1], &ldy, &c_one, &A[i__ + i__ * a_dim1], &c__1);
            #if defined(PRECISION_z) || defined(PRECISION_c)
            lapackf77_slacgv( &i__3, &Y[i__+y_dim1], &ldy );
            #endif
            blasf77_sgemv("No transpose", &i__2, &i__3, &c_neg_one, &X[i__ + x_dim1], &ldx,
            ...
            if (i__ < n) {
                ...
                i__2 = n - i__;
                i__3 = i__ - 1;
                blasf77_sgemv("N", &i__2, &i__3, &c_neg_one, &Y[i__ + 1 +y_dim1], &ldy,
                              &Y[i__ * y_dim1 + 1], &c__1,
                              &c_zero, f, &c__1);
                i__2 = m - i__ + 1;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_one, &X[i__ + x_dim1],
                ...
                i__2 = i__ - 1;
                i__3 = n - i__;
                blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_neg_one, &A[(i__ + 1) *
                              a_dim1 + 1], &lda, &Y[i__ * y_dim1 + 1], &c__1, &c_one,
                              &Y[i__ + 1 + i__ * y_dim1], &c__1);
                i__2 = n - i__;
                blasf77_sscal(&i__2, &tauq[i__], &Y[i__ + 1 + i__ * y_dim1], &c__1);

                /* Update A(i,i+1:n) */
                i__2 = n - i__;
                #if defined(PRECISION_z) || defined(PRECISION_c)
                lapackf77_slacgv( &i__2, &A[i__+(i__+1)*a_dim1], &lda );
                lapackf77_slacgv( &i__,  &A[i__+a_dim1], &lda );
                #endif
                blasf77_sgemv("No transpose", &i__2, &i__, &c_neg_one, &Y[i__ + 1 +
                ...
                #if defined(PRECISION_z) || defined(PRECISION_c)
                lapackf77_slacgv( &i__,  &A[i__+a_dim1], &lda );
                lapackf77_slacgv( &i__2, &X[i__+x_dim1], &ldx );
                #endif
                blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_neg_one, &A[(i__ + 1) *
                ...
                i__2 = m - i__;
                blasf77_sgemv("N", &i__2, &i__, &c_neg_one, &A[i__ + 1 + a_dim1], &lda,
                       &X[i__ * x_dim1 + 1], &c__1, &c_zero, f, &c__1);
                i__2 = i__ - 1;
                i__3 = n - i__;
                blasf77_sgemv("N", &i__2, &i__3, &c_one, &A[(i__ + 1) * a_dim1 + 1],
                ...
                i__2 = m - i__;
                i__3 = i__ - 1;
                blasf77_sgemv("No transpose", &i__2, &i__3, &c_neg_one, &X[i__ + 1 +
                        x_dim1], &ldx, &X[i__ * x_dim1 + 1], &c__1, &c_one, &X[
                        i__ + 1 + i__ * x_dim1], &c__1);
                i__2 = m - i__;
                blasf77_sscal(&i__2, &taup[i__], &X[i__ + 1 + i__ * x_dim1], &c__1);
        ...
        for (i__ = 1; i__ <= nb; ++i__) {
            ...
            lapackf77_slacgv(&i__3, &A[i__ + a_dim1], &lda);
            #endif
            blasf77_sgemv("No transpose", &i__2, &i__3, &c_neg_one, &Y[i__ + y_dim1], &ldy,
                   &A[i__ + a_dim1], &lda, &c_one, &A[i__ + i__ * a_dim1], &lda);
            i__2 = i__ - 1;
            #if defined(PRECISION_z) || defined(PRECISION_c)
            lapackf77_slacgv(&i__3, &A[i__ + a_dim1], &lda);
            lapackf77_slacgv(&i__3, &X[i__ + x_dim1], &ldx);
            #endif
            i__3 = n - i__ + 1;
            blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_neg_one, &A[i__ * a_dim1 + 1],
            ...
            if (i__ < m) {
                ...
                i__2 = n - i__ + 1;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_one, &Y[i__ + y_dim1],
                ...
                lapackf77_slacgv(&i__3, &Y[i__ + y_dim1], &ldy);
                #endif
                blasf77_sgemv("No transpose", &i__2, &i__, &c_neg_one,
                ...
                i__2 = m - i__;
                i__3 = i__ - 1;
                blasf77_sgemv(MagmaTransStr, &i__2, &i__3, &c_one, &A[i__ + 1 + a_dim1],
                ...
                i__2 = m - i__;
                blasf77_sgemv(MagmaTransStr, &i__2, &i__, &c_one, &X[i__ + 1 + x_dim1],
                ...
                i__2 = n - i__;
                blasf77_sgemv(MagmaTransStr, &i__, &i__2, &c_neg_one,
