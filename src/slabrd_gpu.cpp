/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @author Stan Tomov
       @generated from zlabrd_gpu.cpp normal z -> s, Fri Jul 18 17:34:20 2014
        ...
        for (i = 1; i <= nb; ++i) {
            ...
            if (i < n) {
                *A(i,i) = c_one;
                ...
                i__2 = i - 1;
                i__3 = n - i;
                blasf77_sgemv( MagmaTransStr, &i__2, &i__3, &c_neg_one,
                               A(1,i+1), &lda,
                               Y(1,i),   &ione, &c_one,
                               Y(i+1,i), &ione );
                i__2 = n - i;
                ...
                *A(i,i+1) = c_one;
                ...
                i__2 = n - i;
                blasf77_sgemv( MagmaTransStr, &i__2, &i, &c_one,
                               Y(i+1,1), &ldy,
                               A(i,i+1), &lda, &c_zero,
                               X(1,i),   &ione );
        ...
        for (i = 1; i <= nb; ++i) {
            ...
            if (i < m) {
                ...
                *A(i+1,i) = c_one;
                ...
                i__2 = n - i;
                blasf77_sgemv( MagmaTransStr, &i, &i__2, &c_neg_one,
                               A(1,i+1), &lda,
                               Y(1,i),   &ione, &c_one,
                               Y(i+1,i), &ione );
                i__2 = n - i;
