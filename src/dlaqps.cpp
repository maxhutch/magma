/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated d Tue Aug 13 16:44:29 2013
...
magma_dlaqps(magma_int_t m, magma_int_t n, magma_int_t offset,
...
/*  -- MAGMA (version 1.4.0) --
    ...
    TAU     (output) DOUBLE_PRECISION array, dimension (KB)
    ...
    AUXV    (input/output) DOUBLE_PRECISION array, dimension (NB)
            Auxiliar vector.

    F       (input/output) DOUBLE_PRECISION array, dimension (LDF,NB)
            Matrix F' = L*Y'*A.
    ...
    *kb = k + 1;
    ...
    while( lsticc > 0 ) {
        ...
        if (lsticc <= nb)
            ...
            //vn1[lsticc] = magma_dnrm2(i__1, dA(rk + 1, lsticc), ione);
