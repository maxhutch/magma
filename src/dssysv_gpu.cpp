/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from src/zchesv_gpu.cpp, mixed zc -> ds, Tue Aug 30 09:38:12 2016
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    #ifdef TIMER_DSHESV
    ssytrf_t = magma_sync_wtime(NULL)-start_t;
    #endif
    if (*info != 0) {
        *iter = -3;
        goto fallback;
    ...
    #ifdef TIMER_DSHESV
    ssytrs_t = magma_sync_wtime(NULL)-start_t;
    #endif
    ...
    #ifdef TIMER_DSHESV
    dsymm_t = magma_sync_wtime(NULL)-start_t;
    #endif
