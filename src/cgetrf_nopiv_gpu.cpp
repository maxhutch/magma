/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zgetrf_nopiv_gpu.cpp normal z -> c, Fri Apr 25 15:05:37 2014
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= min(m,n)) {
        ...
        for( i=0; i < s; i++ ) {
            // download i-th panel
            cols = maxm - i*nb;
            magma_cgetmatrix( m-i*nb, nb, dA(i,i), ldda, work, lddwork );
            ...
            // upload i-th panel
            magma_csetmatrix( m-i*nb, nb, work, lddwork, dA(i, i), ldda );
