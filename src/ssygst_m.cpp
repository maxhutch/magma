/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zhegst_m.cpp normal z -> s, Fri Apr 25 15:05:52 2014
*/
...
static void magma_ssygst_m_1_U_row_update(magma_int_t nk, magma_int_t nb, float* dA_row, magma_int_t ldda,
                                          float* dC1, magma_int_t lddc1, float* dC2, magma_int_t lddc2);
...
magma_ssygst_m(magma_int_t nrgpu, magma_int_t itype, magma_uplo_t uplo, magma_int_t n,
            ...
            for (magma_int_t k = 0; k < nbl; ++k) {
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+1; j < nbl; ++j) {
                        ...
                        if (igpu != igpu_p) {
                            ...
                            magma_ssygst_m_1_U_row_update(n-j*nb, nb, dA(igpu, j/nrgpu, j), ldda,
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+nrgpu; j < nbl; j += nrgpu) {
                        ...
                        magma_ssygst_m_1_U_row_update(n-j*nb, nb, dA(igpu_p, j/nrgpu, j), ldda,
            ...
            for (magma_int_t k = 0; k < nbl; ++k) {
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+1; j < nbl; ++j) {
                        ...
                        if (igpu != igpu_p) {
                            ...
                            magma_ssygst_m_1_L_col_update(n-j*nb, nb, dA(igpu, j, j/nrgpu), ldda,
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+nrgpu; j < nbl; j += nrgpu) {
                        ...
                        magma_ssygst_m_1_L_col_update(n-j*nb, nb, dA(igpu_p, j, j/nrgpu), ldda,
            ...
            if (n > nb) {
                ...
                for (magma_int_t k = 0; k < nbl; ++k) {
                    ...
                    for (magma_int_t igpu = 0; igpu < nrgpu; ++igpu) {
                        ...
                        magma_sgemm(MagmaNoTrans, MagmaNoTrans, k*nb, nloc[igpu], kb, c_one, dB_c(igpu, 0, k%2), lddbc,
            ...
            for (magma_int_t k = 0; k < nbl; ++k) {
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j = 0; j < k; ++j) {
                        ...
                        magma_ssyr2k(uplo, MagmaNoTrans,
                                     nb, kb,
                ...
                for (magma_int_t igpu = 0; igpu < nrgpu; ++igpu) {
                    ...
                    magma_queue_sync(stream[igpu][0]); // sync B copy (conflicts with ssygst)
                }
            ...
            if (n > nb) {
                ...
                for (magma_int_t k = 0; k < nbl; ++k) {
                    ...
                    for (magma_int_t igpu = 0; igpu < nrgpu; ++igpu) {
                        ...
                        magma_sgemm(MagmaNoTrans, MagmaNoTrans, nloc[igpu], k*nb, kb, c_one, dA(igpu, iloc[igpu], k), ldda,
