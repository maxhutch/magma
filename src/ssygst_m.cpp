/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zhegst_m.cpp normal z -> s, Fri Sep 11 18:29:32 2015
*/
            ...
            for (magma_int_t k = 0; k < nbl; ++k) {
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+1; j < nbl; ++j) {
                        ...
                        if (igpu != igpu_p) {
                            ...
                            magma_ssygst_m_1_U_row_update(n-j*nb, nb, dA(igpu, j/ngpu, j), ldda,
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+ngpu; j < nbl; j += ngpu) {
                        ...
                        magma_ssygst_m_1_U_row_update(n-j*nb, nb, dA(igpu_p, j/ngpu, j), ldda,
            ...
            for (magma_int_t k = 0; k < nbl; ++k) {
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+1; j < nbl; ++j) {
                        ...
                        if (igpu != igpu_p) {
                            ...
                            magma_ssygst_m_1_L_col_update(n-j*nb, nb, dA(igpu, j, j/ngpu), ldda,
                ...
                if (k > 0) {
                    ...
                    for (magma_int_t j=k+ngpu; j < nbl; j += ngpu) {
                        ...
                        magma_ssygst_m_1_L_col_update(n-j*nb, nb, dA(igpu_p, j, j/ngpu), ldda,
