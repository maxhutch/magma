/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zpotrf_m.cpp normal z -> s, Fri Sep 11 18:29:27 2015
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for( J=0; J < n; J += NB ) {
            ...
            magma_shtodpo( ngpu, uplo, JB, n, J, J, nb, A, lda, dwork, NB, stream, &iinfo);
            ...
            magma_sdtohpo(ngpu, uplo, JB, n, J, J, nb, NB, A, lda, dwork, NB, stream, &iinfo);
            //magma_sdtohpo(ngpu, uplo, JB, n, J, J, nb, 0, A, lda, dwork, NB, stream, &iinfo);
        }
    } else {
        /* ========================================================= *
        ...
        for( J=0; J < n; J += NB ) {
            ...
            magma_shtodpo( ngpu, uplo, n, JB, J, J, nb, A, lda, dwork, lddla, stream, &iinfo);
            ...
            magma_sdtohpo( ngpu, uplo, n, JB, J, J, nb, JB, A, lda, dwork, lddla, stream, &iinfo);
        } /* end of for J */
    } /* if upper */
    } /* if nb */
