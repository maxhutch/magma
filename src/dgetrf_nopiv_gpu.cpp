/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zgetrf_nopiv_gpu.cpp normal z -> d, Fri Apr 25 15:05:36 2014
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= min(m,n)) {
        ...
        for( i=0; i < s; i++ ) {
            // download i-th panel
            cols = maxm - i*nb;
            magma_dgetmatrix( m-i*nb, nb, dA(i,i), ldda, work, lddwork );
            ...
            // upload i-th panel
            magma_dsetmatrix( m-i*nb, nb, work, lddwork, dA(i, i), ldda );
