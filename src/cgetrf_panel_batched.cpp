/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zgetrf_panel_batched.cpp normal z -> c, Sat Nov 15 19:54:10 2014
*/
    ...
    magma_int_t batchCount, magma_queue_t stream, cublasHandle_t myhandle)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_cdisplace_pointers(dW1_displ, dA_array, ldda, p2, 0, batchCount); // no need since it is above
