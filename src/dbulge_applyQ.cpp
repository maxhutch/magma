 ...
 *     @author Stan Tomov
 *
 *     @generated d Tue Aug 13 16:44:39 2013
 *
 */
...
#define TAU(m)   &(TAU[(m)])
#define T(m)     &(T[(m)])
extern "C" void magma_dbulge_applyQ(magma_int_t WANTZ, char SIDE, magma_int_t NE, magma_int_t N, magma_int_t NB, magma_int_t Vblksiz, double *E, magma_int_t LDE, double *V, double *TAU, double *T, magma_int_t *INFO, double *dV, double *dT, double *dE, magma_int_t copytype )
{
