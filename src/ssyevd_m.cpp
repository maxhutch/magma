/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from src/dsyevd_m.cpp, normal d -> s, Sun Nov 20 20:20:23 2016
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_ssytrd_mgpu(ngpu, 1, uplo, n, A, lda, w, &work[inde],
    ...
    if (! wantz) {
        ...
        magma_free( dwork );
#else
        magma_sstedx_m(ngpu, MagmaRangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
        ...
        magma_sormtr_m(ngpu, MagmaLeft, uplo, MagmaNoTrans, n, n, A, lda, &work[indtau],
