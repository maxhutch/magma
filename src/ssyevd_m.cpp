/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from dsyevd_m.cpp normal d -> s, Fri May 30 10:41:06 2014
...
magma_ssyevd_m(magma_int_t nrgpu, magma_vec_t jobz, magma_uplo_t uplo,
               magma_int_t n,
               ...
               magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (! wantz) {
        ...
        magma_free( dwork );
#else
        magma_sstedx_m(nrgpu, MagmaRangeAll, n, 0., 0., 0, 0, w, &work[inde],
                       &work[indwrk], n, &work[indwk2],
