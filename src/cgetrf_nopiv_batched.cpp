/*
   ...
   @generated from zgetrf_nopiv_batched.cpp normal z -> c, Sat Nov 15 19:54:09 2014
 */
...
#define A(i_, j_)  (A + (i_) + (j_)*lda)   
    ...
    cset_pointer(dwork_array, dwork, 0, 0, 0, dwork_msize, batchCount);
    ...
    for(i = 0; i < min_mn; i+=nb) 
    {
        ...
        magma_cdisplace_pointers(dA_displ, dA_array, lda, i, i, batchCount);
        cset_pointer(dwork_array, dwork, nb, 0, 0, dwork_msize, batchCount);
#if 1
...
#define RUN_ALL
        ...
        if( (i + ib) < n)
        {
            ...
            //magma_cdisplace_pointers(dA_displ, dA_array, lda, i, i+ib, batchCount);
            cset_pointer(dwork_array, dwork, nb, 0, 0, dwork_msize, batchCount); // I don't think it is needed Azzam

            magma_cdisplace_pointers(dA_displ, dA_array, lda, i, i, batchCount);
            magma_cdisplace_pointers(dW0_displ, dA_array, lda, i, i+ib, batchCount);
            ...
            {    
                ...
                {
                    magma_cdisplace_pointers(dA_displ, dA_array,  lda, i+ib,    i, batchCount);
                    magma_cdisplace_pointers(dW1_displ, dA_array, lda,    i, i+ib, batchCount);
                    magma_cdisplace_pointers(dW2_displ, dA_array, lda, i+ib, i+ib, batchCount);
