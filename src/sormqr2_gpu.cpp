/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zunmqr2_gpu.cpp normal z -> s, Fri Apr 25 15:05:42 2014
...
magma_sormqr2_gpu(magma_side_t side, magma_trans_t trans,
                  ...
                  magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magmablas_ssetdiag1subdiag0(MagmaLower, k, nb, dA, ldda);
    ...
    for (i = i1; (step < 0 ? i >= i2 : i <= i2); i += step) {
        ...
        i__4 = nq - i + 1;
        lapackf77_slarft("F", "C", &i__4, &ib, &wA[i + i*ldwa], &ldwa,
                         &tau[i], t, &ib);
