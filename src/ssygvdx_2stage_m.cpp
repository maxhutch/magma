...
magma_ssygvdx_2stage_m(magma_int_t nrgpu, magma_int_t itype, char jobz, char range, char uplo, magma_int_t n,
...
/*  -- MAGMA (version 1.4.1) --
    ...
    *info = 0;
    ...
    printf("time ssyevdx_2stage_m = %6.2f\n", GetTimerValue(start,end)/1000.);
#endif
