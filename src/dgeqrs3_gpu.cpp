/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zgeqrs3_gpu.cpp normal z -> d, Fri May 30 10:40:59 2014
                  ...
                  magma_int_t *info)
{
    ...
    */
    magmablas_dswapdblk(k, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
    ...
    magmablas_dswapdblk(k, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
