/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zhetrd_he2hb_mgpu_spec.cpp normal z -> c, Fri May 30 10:41:08 2014
...
magma_chetrd_he2hb_mgpu_spec( magma_uplo_t uplo, magma_int_t n, magma_int_t nb,
                    ...
                    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magmaFloatComplex *worktest = NULL;
    //magma_cmalloc_cpu( &worktest, n*nb ); // not used
    // ======================
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                ...
                /*
                magma_device_sync();
                cudaMemcpy2DAsync(A(i,i), lda*sizeof(magmaFloatComplex),
                                 dA(idev,i,di+1), ldda*sizeof(magmaFloatComplex),
