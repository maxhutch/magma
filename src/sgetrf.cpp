/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @author Stan Tomov
       @generated from zgetrf.cpp normal z -> s, Fri Apr 25 15:05:38 2014
*/
    ...
    *info = 0;
    ...
    if ( (nb <= 1) || (nb >= min(m,n)) ) {
        ...
        if ( num_gpus > 1 ) {
            ...
            magma_sgetrf_m(num_gpus, m, n, A, lda, ipiv, info);
            return *info;
        }
        ...
        for( i = 0; i < s; i++ ) {
            ...
            if (i > 0) {
                ...
                magma_sgetmatrix_async( m-i*nb, nb, dA, cols, work, lda,
                                        stream[0]);
            ...
            // upload i-th panel
            magma_ssetmatrix_async( m-i*nb, nb, work, lda, dA, cols,
                                    stream[0]);
