/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Wed Aug 14 12:16:22 2013
       @author Mark Gates
*/
...
/*  -- MAGMA (version 1.4.0) --
    ...
    for( d = 0; d < ngpu; ++d ) {
        ...
        magmablas_claset( MagmaUpperLower, nb, nb, dV(d,k,0), ldv );
    }
    ...
    for (i = 0; i < nb; ++i) {
        ...
        *A(k+i+1,i) = c_one;
        ...
        for( d = 0; d < ngpu; ++d ) {
            ...
            magmablas_clacpy( 'F', nb, nblocks-lblock,
