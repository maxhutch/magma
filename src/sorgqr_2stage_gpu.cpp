/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zungqr_2stage_gpu.cpp normal z -> s, Fri May 30 10:41:06 2014
                 ...
                 magma_int_t nb, magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        /* A(kk+1:m, kk+1:n) = I */
        magmablas_slaset_identity(m-kk, n-kk, dA(kk,kk), ldda);
    }
    else {
        ki = 0;
        kk = 0;
    ...
    if (kk < n) {
        ...
        //magmablas_slaset(MagmaUpperLower, kk-nb, nb, dA(0,kk-nb), ldda);
        //magmablas_slaset_identity(m-(kk-nb), nb, dA(kk-nb,kk-nb), ldda);
    }
    ...
    if (kk > 0) {
        ...
        for (i = ki; i >= nb; i -= nb) {
            ...
            if (i + ib < n) {
                ...
                magmablas_slaset_identity(m-i, ib, dA(i,i), ldda);
            ...
            //                 work, &lwork, &iinfo);
            //cudaMemcpy2DAsync(dA(i,i), ldda * sizeof(float),
            ...
            i__2 = i + ib;
            //magmablas_slaset(MagmaUpperLower, i-ib, ib, dA(0,i-ib), ldda);
            //magmablas_slaset_identity(m-(i-ib), ib, dA(i-ib,i-ib), ldda);
        }
    }

    magmablas_slaset_identity(m, nb, dA(0,0), ldda);
