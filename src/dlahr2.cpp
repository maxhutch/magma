/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zlahr2.cpp normal z -> d, Fri May 30 10:41:08 2014
       @author Stan Tomov
       @author Mark Gates
*/
...
/**
    ...
    @param[in,out]
    dA      DOUBLE_PRECISION array on the GPU, dimension (LDA,N-K+1)
            On entry, the n-by-(n-k+1) general matrix A.
            On exit, the elements in rows K:N of the first NB columns are
            overwritten with the matrix Y.

    @param[out]
    dV      DOUBLE_PRECISION array on the GPU, dimension (N, NB)
