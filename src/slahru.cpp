/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zlahru.cpp normal z -> s, Fri Apr 25 15:05:51 2014
       @author Stan Tomov
       @author Mark Gates
*/
...
/**
    ...
    @param[in,out]
    dA      REAL array on the GPU, dimension
    ...
    float *dwork )
{
    ...
    magma_sgemm( MagmaNoTrans, MagmaTrans, k, ihi-k, nb,
                 c_neg_one, dYm,   ldda,
                            dwork, ldda,
                 c_one,     dA,    ldda );
    ...
    magma_sgemm( MagmaNoTrans, MagmaTrans, ihi-k, ihi-k-nb, nb,
                 c_neg_one, dY,         ldda,
                            dwork + nb, ldda,
                 c_one,     dA(k,nb),   ldda );
