/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Tue Aug 13 16:44:44 2013
...
static void magma_stile_bulge_applyQ(magma_int_t core_id, char side, magma_int_t n_loc, magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
                                     float *E, magma_int_t lde, float *V, magma_int_t ldv,
...
public:
    ...
    magma_sapplyQ_m_data(magma_int_t nrgpu_, magma_int_t threads_num_, magma_int_t n_, magma_int_t ne_, magma_int_t n_gpu_,
                         magma_int_t nb_, magma_int_t Vblksiz_, float *E_, magma_int_t lde_,
                         float *V_, magma_int_t ldv_, float *TAU_,
...
magma_sbulge_back_m(magma_int_t nrgpu, magma_int_t threads, char uplo, 
...
//n_gpu = ne;
    if(n_gpu < ne)
    {
        ...
        magma_sbulge_applyQ_v2_m(nrgpu, 'L', ne, n, nb, Vblksiz, Z, ldz, V, ldv, T, ldt, info);
        magma_device_sync();
    }
...
static void *magma_sapplyQ_m_parallel_section(void *arg)
{
    ...
    if(my_core_id==0)
    {
        ...
        magma_sbulge_applyQ_v2_m(nrgpu, 'L', n_gpu, n, nb, Vblksiz, E, lde, V, ldv, T, ldt, &info);
        magma_device_sync();
        ...
        magma_stile_bulge_applyQ(my_core_id, 'L', n_loc, n, nb, Vblksiz, E_loc, lde, V, ldv, TAU, T, ldt);
...
static void magma_stile_bulge_applyQ(magma_int_t core_id, char side, magma_int_t n_loc, magma_int_t n, magma_int_t nb, magma_int_t Vblksiz,
                                     float *E, magma_int_t lde, float *V, magma_int_t ldv,
                                     float *TAU, float *T, magma_int_t ldt)//, magma_int_t* info)
{
    //%===========================
    //%   local variables
    //%===========================
