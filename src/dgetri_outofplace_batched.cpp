/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from src/zgetri_outofplace_batched.cpp, normal z -> d, Sun Nov 20 20:20:26 2016
*/
                  ...
                  magma_int_t batchCount, magma_queue_t queue)
{
    ...
    magmablas_dlaset( MagmaFull, invdiagA_msize, batchCount, MAGMA_D_ZERO, MAGMA_D_ZERO, dinvdiagA, invdiagA_msize, queue );
    ...
    magma_dset_pointer( dinvdiagA_array, dinvdiagA, DTRTRI_BATCHED_NB, 0, 0, invdiagA_msize, batchCount, queue );
