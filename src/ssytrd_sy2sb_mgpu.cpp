/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Tue Aug 13 16:44:45 2013
...
magma_ssytrd_sy2sb_mgpu( char uplo, magma_int_t n, magma_int_t nb,
...
/*  -- MAGMA (version 1.4.0) --
    ...
    *info = 0;
    ...
    float *worktest = NULL; //(float *) malloc(n*nb*sizeof(float)); // not used
    // ======================
             ...
             if (i > 1 ){
                ...
                // below a -1 was added and then a -1 was done on di because of the fortran indexing
                 ...
                 cudaMemcpy2DAsync(a_ref(i,i), lda*sizeof(float),
                                  datest(idev,i,di+1), ldda*sizeof(float),
