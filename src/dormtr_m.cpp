/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zunmtr_m.cpp normal z -> d, Fri Jul 18 17:34:18 2014
...
magma_dormtr_m(magma_int_t nrgpu, magma_side_t side, magma_uplo_t uplo, magma_trans_t trans,
               ...
               magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        //magma_dormql_m(nrgpu, side, trans, mi, ni, i__2, A(0,1), lda, tau,
        ...
        i__2 = nq - 1;
        magma_dormqr_m(nrgpu, side, trans, mi, ni, i__2, A(1,0), lda, tau,
