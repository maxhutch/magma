/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zhesv_nopiv_gpu.cpp normal z -> d, Fri Sep 11 18:29:29 2015
                 ...
                 magma_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_dsytrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_dsytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
