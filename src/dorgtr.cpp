/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated d Tue Aug 13 16:44:35 2013
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (j = 0; j < n-1; ++j) {
            ...
            *a_ref(n-1, j) = MAGMA_D_ZERO;
        }
        for (i = 0; i < n-1; ++i) {
            *a_ref(i, n-1) = MAGMA_D_ZERO;
        }
        *a_ref(n-1, n-1) = MAGMA_D_ONE;
        ...
        *a_ref(0, 0) = MAGMA_D_ONE;
        ...
        if (n > 1) {
            /* Generate Q(2:n,2:n) */
            magma_dorgqr(n-1, n-1, n-1, a_ref(1, 1), lda, tau, dT, nb, &iinfo);
        }
    }
