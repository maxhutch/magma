/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zhetrd2_gpu.cpp normal z -> d, Fri Sep 11 18:29:30 2015
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        magma_dsetmatrix( kk, kk, A(0, 0), lda, dA(0, 0), ldda );
    }
    else {
        ...
        magma_dsetmatrix( n-i, n-i, A(i, i), lda, dA(i, i), ldda );
    }
