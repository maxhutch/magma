/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from src/zhegvdx_2stage.cpp normal z -> s, Wed Jan  6 17:59:34 2016
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (wantz && *info == 0) {
        ...
        magma_ssetmatrix( n, *mout, A, lda, dA, ldda );
        magma_ssetmatrix( n,  n,    B, ldb, dB, lddb );
        ...
        if (itype == 1 || itype == 2) {
            ...
            magma_strsm(MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda);
        }
        else if (itype == 3) {
            /* For B*A*x=(lambda)*x;
            ...
            magma_strmm(MagmaLeft, uplo, trans, MagmaNonUnit, n, *mout, c_one, dB, lddb, dA, ldda);
        }
