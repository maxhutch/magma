/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zgetrf_incpiv_gpu.cpp normal z -> s, Fri Sep 11 18:29:28 2015
    ...
    *info = 0;
    ...
    if ( ib >= mindim ) {
        ...
        for( i=0; i < s; i++ ) {
            ...
            if ( i > 0 ) {
                // download i-th panel
                magmablas_stranspose( sb, m, AT(0,i), ldda, dwork, maxm );
            ...
            magmablas_stranspose( rows, sb, dwork, cols, AT(i,i), ldda );
