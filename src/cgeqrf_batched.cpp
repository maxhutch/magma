/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zgeqrf_batched.cpp normal z -> c, Fri Sep 11 18:29:32 2015
*/
...
#define dA(i, j)  (dA + (i) + (j)*ldda)   // A(i, j) means at i row, j column
    ...
    cset_pointer(dR_array, dR, lddr, 0, 0, lddr*min(nb, min_mn), batchCount, queue);
    cset_pointer(dT_array, dT, lddt, 0, 0, lddt*min(nb, min_mn), batchCount, queue);
