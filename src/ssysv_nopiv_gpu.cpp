/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zhesv_nopiv_gpu.cpp normal z -> s, Fri Sep 11 18:29:29 2015
...
magma_ssysv_nopiv_gpu(magma_uplo_t uplo,  magma_int_t n, magma_int_t nrhs,
                 ...
                 magma_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_ssytrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_ssytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
