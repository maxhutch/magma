/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zheevr.cpp normal z -> c, Fri May 30 10:41:05 2014
...
magma_cheevr(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n,
             magmaFloatComplex *A, magma_int_t lda, float vl, float vu,
             magma_int_t il, magma_int_t iu, float abstol, magma_int_t *m,
             float *w, magmaFloatComplex *Z, magma_int_t ldz, magma_int_t *isuppz,
