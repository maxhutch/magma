...
/*  -- MAGMA (version 1.4.1) --
    ...
    work    (CPU workspace/output) REAL array, dimension 3n^2.
    ...
    *info = 0;
    ...
    magma_smalloc_cpu( &hwork, 2*n*n + 2*n);
    if ( hwork == NULL ) {
    ...
    do {
      ...
      // magmablas_sgemm_reduce(n, n, m, one, dA, ldda, dA, ldda, zero, dwork, n );
      ...
      magma_ssetmatrix(n, n, VT, n, G, n);
      magma_strsm('r', 'u', 'n', 'n', m, n, one, G, n, dA, ldda);
      if (mins > 0.00001f)
        cn = maxs/mins;
