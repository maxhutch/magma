/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zunmqr_m.cpp normal z -> c, Tue Sep  2 12:38:22 2014
    ...
    if (left) {
        ...
        for (magma_int_t i = i1; (i3 < 0 ? i >= i2 : i < i2); i += i3) {
            ...
            for (igpu = 0; igpu < nrgpu; ++igpu) {
                ...
                magmablas_claset_band_q( MagmaUpper, kb, kb, kb, c_zero, c_one, dA_c(igpu, ind_c, i, 0), lddac, stream[igpu][0] );
            }
