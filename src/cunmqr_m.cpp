/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Wed Aug 14 12:16:12 2013
...
magma_cunmqr_m(magma_int_t nrgpu, char side, char trans,
    ...
    if (left) {
        ...
        for (magma_int_t i = i1; (i3 < 0 ? i >= i2 : i < i2); i += i3)
        {
            ...
            for (igpu = 0; igpu < nrgpu; ++igpu){
                ...
                magmablas_csetdiag1subdiag0_stream('L', kb, kb, dA_c(igpu, ind_c, i, 0), lddac, stream[igpu][0]);
            }
