/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from src/zgeqrs3_gpu.cpp normal z -> c, Fri Jan 22 21:41:35 2016
    ...
    magma_int_t *info)
{
    ...
    */
    magmablas_cswapdblk( k-1, nb, dA(0,0), ldda, 1, dT(0), nb, 0, queue );
    if ( nrhs == 1 ) {
    ...
    magmablas_cswapdblk( k-1, nb, dT(0), nb, 0, dA(0,0), ldda, 1, queue );
