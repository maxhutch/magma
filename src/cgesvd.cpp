...
/*  -- MAGMA (version 1.4.1) --
    ...
    *info = 0;
    ...
    if (*info == 0) {
        ...
        work[0] = MAGMA_C_MAKE( minwrk * (1. + lapackf77_slamch("Epsilon")), 0 );
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                // (RWorkspace: 0)
                i__2 = lwork - iwork + 1;
                lapackf77_cgeqrf(&m, &n, A, &lda, &work[itau], &work[iwork], &i__2, &ierr);
                
                // Zero out below R
                i__2 = n - 1;
                i__3 = n - 1;
                lapackf77_claset("L", &i__2, &i__3, &c_zero, &c_zero, &A[1], &lda);
                ie = 1;
                itauq = 1;
                itaup = itauq + n;
                iwork = itaup + n;
                ...
                i__2 = lwork - iwork + 1;
                //printf( "path 1\n" );
                magma_cgebrd(n, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                ...
                if (want_vo || want_vas) {
                    ...
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &n, &n, &n, A, &lda, &work[itaup], &work[iwork], &i__2, &ierr);
                    ncvt = n;
                }
                irwork = ie + n;
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    i__2 = n - 1;
                    i__3 = n - 1;
                    lapackf77_claset("L", &i__2, &i__3, &c_zero, &c_zero, &work[ir + 1], &ldwrkr);
                    ...
                    // lapackf77_cungqr(&m, &n, &n, A, &lda, &work[itau], &work[iwork], &i__2, &ierr);
                    ...
                    i__2 = lwork - iwork + 1;
                    //printf( "path 2-a\n" );
                    magma_cgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                    
                    // Generate left vectors bidiagonalizing R
                    // (CWorkspace: need N*N + 3*N, prefer N*N + 2*N + N*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &n, &n, &n, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2, &ierr);
                    irwork = ie + n;
                    ...
                    i__3 = lwork - iwork + 1;
                    //printf( "path 2-b\n" );
                    magma_cgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__3, &ierr);
                    
                    // Generate left vectors bidiagonalizing A
                    // (CWorkspace: need 3*N, prefer 2*N + N*NB)
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &m, &n, &n, A, &lda, &work[itauq], &work[iwork], &i__3, &ierr);
                    irwork = ie + n;
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cgeqrf(&m, &n, A, &lda, &work[itau], &work[iwork], &i__3, &ierr);
                    ...
                    if (n > 1) {
                        i__3 = n - 1;
                        i__2 = n - 1;
                        lapackf77_claset("L", &i__3, &i__2, &c_zero, &c_zero, &VT[1], &ldvt);
                    }
                    ...
                    // lapackf77_cungqr(&m, &n, &n, A, &lda, &work[itau], &work[iwork], &i__3, &ierr);
                    magma_cungqr2(m, n, n, A, lda, &work[itau], &ierr);
                    ...
                    i__3 = lwork - iwork + 1;
                    //printf( "path 3-a\n" );
                    magma_cgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__3, &ierr);
                    ...
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &n, &n, &n, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__3, &ierr);
                    
                    // Generate right vectors bidiagonalizing R in VT
                    // (CWorkspace: need N*N + 3*N-1, prefer N*N + 2*N + (N-1)*NB)
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &n, &n, &n, VT, &ldvt, &work[itaup], &work[iwork], &i__3, &ierr);
                    irwork = ie + n;
                    ...
                    if (n > 1) {
                        i__2 = n - 1;
                        i__3 = n - 1;
                        lapackf77_claset("L", &i__2, &i__3, &c_zero, &c_zero, &VT[1], &ldvt);
                    }
                    ...
                    i__2 = lwork - iwork + 1;
                    //printf( "path 3-b\n" );
                    magma_cgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                    
                    // Multiply Q in A by left vectors bidiagonalizing R
                    // (CWorkspace: need 2*N + M, prefer 2*N + M*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cunmbr("Q", "R", "N", &m, &n, &n, VT, &ldvt, &work[itauq], A, &lda, &work[iwork], &i__2, &ierr);
                    
                    // Generate right vectors bidiagonalizing R in VT
                    // (CWorkspace: need 3*N-1, prefer 2*N + (N-1)*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &n, &n, &n, VT, &ldvt, &work[itaup], &work[iwork], &i__2, &ierr);
                    irwork = ie + n;
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        // lapackf77_cungqr(&m, &n, &n, U, &ldu, &work[itau], &work[iwork], &i__2, &ierr);
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunmbr("Q", "R", "N", &m, &n, &n, A, &lda, &work[itauq], U, &ldu, &work[iwork], &i__2, &ierr);
                        irwork = ie + n;
                    ...
                    if (lwork >= 2*n*n + wrkbrd) {
                        ...
                        i__2 = n - 1;
                        i__3 = n - 1;
                        lapackf77_claset("L", &i__2, &i__3, &c_zero, &c_zero, &work[iu + 1], &ldwrku);
                        ...
                        i__2 = lwork - iwork + 1;
                        //printf( "path 5-a\n" );
                        magma_cgebrd(n, n, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cungbr("Q", &n, &n, &n, &work[iu], &ldwrku, &work[itauq], &work[iwork], &i__2, &ierr);
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cungbr("P", &n, &n, &n, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2, &ierr);
                        irwork = ie + n;
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunmbr("Q", "R", "N", &m, &n, &n, VT, &ldvt, &work[itauq], U, &ldu, &work[iwork], &i__2, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(n + m, wrkbrd)) {
                        ...
                        // lapackf77_cungqr(&m, &m, &n, U, &ldu, &work[itau], &work[iwork], &i__2, &ierr);
            ...
            i__2 = lwork - iwork + 1;
            //printf( "path 10\n" );
            magma_cgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
            ...
            if (want_uas) {
                ...
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("Q", &m, &ncu, &n, U, &ldu, &work[itauq], &work[iwork], &i__2, &ierr);
            }
            if (want_vas) {
            ...
            if (want_uo) {
                ...
                // (RWorkspace: 0)
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("Q", &m, &n, &n, A, &lda, &work[itauq], &work[iwork], &i__2, &ierr);
            }
            if (want_vo) {
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                // (RWorkspace: 0)
                i__2 = lwork - iwork + 1;
                lapackf77_cgelqf(&m, &n, A, &lda, &work[itau], &work[iwork], &i__2, &ierr);
                
                // Zero out above L
                i__2 = m - 1;
                i__3 = m - 1;
                lapackf77_claset("U", &i__2, &i__3, &c_zero, &c_zero, &A[lda], &lda);
                ie = 1;
                itauq = 1;
                itaup = itauq + m;
                iwork = itaup + m;
                ...
                i__2 = lwork - iwork + 1;
                //printf( "path 1t\n" );
                magma_cgebrd(m, m, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                ...
                if (want_uo || want_uas) {
                    ...
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &m, &m, &m, A, &lda, &work[itauq], &work[iwork], &i__2, &ierr);
                }
                irwork = ie + m;
                nru = 0;
                if (want_uo || want_uas) {
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    i__2 = m - 1;
                    i__3 = m - 1;
                    lapackf77_claset("U", &i__2, &i__3, &c_zero, &c_zero, &work[ir + ldwrkr], &ldwrkr);
                    
                    // Generate Q in A
                    // (CWorkspace: need M*M + 2*M, prefer M*M + M + M*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cunglq(&m, &n, &m, A, &lda, &work[itau], &work[iwork], &i__2, &ierr);
                    ie = 1;
                    itauq = itau;
                    itaup = itauq + m;
                    iwork = itaup + m;
                    ...
                    i__2 = lwork - iwork + 1;
                    //printf( "path 2t-a\n" );
                    magma_cgebrd(m, m, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                    
                    // Generate right vectors bidiagonalizing L
                    // (CWorkspace: need M*M + 3*M-1, prefer M*M + 2*M + (M-1)*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &m, &m, &m, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__2, &ierr);
                    irwork = ie + m;
                    ...
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &m, &n, &m, A, &lda, &work[itaup], &work[iwork], &i__3, &ierr);
                    irwork = ie + m;
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cgelqf(&m, &n, A, &lda, &work[itau], &work[iwork], &i__3, &ierr);
                    
                    // Copy L to U, zeroing about above it
                    lapackf77_clacpy("L", &m, &m, A, &lda, U, &ldu);
                    i__3 = m - 1;
                    i__2 = m - 1;
                    lapackf77_claset("U", &i__3, &i__2, &c_zero, &c_zero, &U[ldu], &ldu);
                    
                    // Generate Q in A
                    // (CWorkspace: need M*M + 2*M, prefer M*M + M + M*NB)
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cunglq(&m, &n, &m, A, &lda, &work[itau], &work[iwork], &i__3, &ierr);
                    ie = 1;
                    itauq = itau;
                    itaup = itauq + m;
                    iwork = itaup + m;
                    ...
                    i__3 = lwork - iwork + 1;
                    //printf( "path 3t-a\n" );
                    magma_cgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__3, &ierr);
                    ...
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("P", &m, &m, &m, &work[ir], &ldwrkr, &work[itaup], &work[iwork], &i__3, &ierr);
                    
                    // Generate left vectors bidiagonalizing L in U
                    // (CWorkspace: need M*M + 3*M, prefer M*M + 2*M + M*NB)
                    // (RWorkspace: 0)
                    i__3 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &m, &m, &m, U, &ldu, &work[itauq], &work[iwork], &i__3, &ierr);
                    irwork = ie + m;
                    ...
                    i__2 = m - 1;
                    i__3 = m - 1;
                    lapackf77_claset("U", &i__2, &i__3, &c_zero, &c_zero, &U[ldu], &ldu);
                    ...
                    i__2 = lwork - iwork + 1;
                    //printf( "path 3t-b\n" );
                    magma_cgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                    
                    // Multiply right vectors bidiagonalizing L by Q in A
                    // (CWorkspace: need 2*M + N, prefer 2*M + N*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cunmbr("P", "L", "C", &m, &n, &m, U, &ldu, &work[itaup], A, &lda, &work[iwork], &i__2, &ierr);
                    
                    // Generate left vectors bidiagonalizing L in U
                    // (CWorkspace: need 3*M, prefer 2*M + M*NB)
                    // (RWorkspace: 0)
                    i__2 = lwork - iwork + 1;
                    lapackf77_cungbr("Q", &m, &m, &m, U, &ldu, &work[itauq], &work[iwork], &i__2, &ierr);
                    irwork = ie + m;
                ...
                if (want_un) {
                    ...
                    if (lwork >= m*m + wrkbrd) {
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunglq(&m, &n, &m, VT, &ldvt, &work[itau], &work[iwork], &i__2, &ierr);
                        ie = 1;
                        itauq = itau;
                        itaup = itauq + m;
                        iwork = itaup + m;
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunmbr("P", "L", "C", &m, &n, &m, A, &lda, &work[itaup], VT, &ldvt, &work[iwork], &i__2, &ierr);
                        irwork = ie + m;
                    ...
                    if (lwork >= 2*m*m + wrkbrd) {
                        ...
                        i__2 = m - 1;
                        i__3 = m - 1;
                        lapackf77_claset("U", &i__2, &i__3, &c_zero, &c_zero, &work[iu + ldwrku], &ldwrku);
                        ...
                        i__2 = lwork - iwork + 1;
                        //printf( "path 5t-a\n" );
                        magma_cgebrd(m, m, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], i__2, &ierr);
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cungbr("P", &m, &m, &m, &work[iu], &ldwrku, &work[itaup], &work[iwork], &i__2, &ierr);
                        
                        // Generate left bidiagonalizing vectors in WORK(IR)
                        // (CWorkspace: need 2*M*M + 3*M, prefer 2*M*M + 2*M + M*NB)
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cungbr("Q", &m, &m, &m, &work[ir], &ldwrkr, &work[itauq], &work[iwork], &i__2, &ierr);
                        irwork = ie + m;
                    ...
                    if (lwork >= m*m + wrkbrd) {
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunmbr("P", "L", "C", &m, &n, &m, U, &ldu, &work[itaup], VT, &ldvt, &work[iwork], &i__2, &ierr);
                ...
                if (want_un) {
                    ...
                    if (lwork >= m*m + max(n + m, wrkbrd)) {
                        ...
                        // (RWorkspace: 0)
                        i__2 = lwork - iwork + 1;
                        lapackf77_cunglq(&n, &n, &m, VT, &ldvt, &work[itau], &work[iwork], &i__2, &ierr);
                        ie = 1;
                        itauq = itau;
                        itaup = itauq + m;
                        iwork = itaup + m;
            ...
            if (want_uas) {
                ...
                lapackf77_clacpy("L", &m, &m, A, &lda, U, &ldu);
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("Q", &m, &m, &n, U, &ldu, &work[itauq], &work[iwork], &i__2, &ierr);
            }
            if (want_vas) {
                // If right singular vectors desired in VT, copy result to
                // VT and generate right bidiagonalizing vectors in VT
                ...
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("P", &nrvt, &n, &m, VT, &ldvt, &work[itaup], &work[iwork], &i__2, &ierr);
            }
            if (want_uo) {
                // If left singular vectors desired in A, generate left
                // bidiagonalizing vectors in A
                ...
                // (RWorkspace: 0)
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("Q", &m, &m, &n, A, &lda, &work[itauq], &work[iwork], &i__2, &ierr);
            }
            if (want_vo) {
                // If right singular vectors desired in A, generate right
                // bidiagonalizing vectors in A
                ...
                // (RWorkspace: 0)
                i__2 = lwork - iwork + 1;
                lapackf77_cungbr("P", &m, &n, &m, A, &lda, &work[itaup], &work[iwork], &i__2, &ierr);
            }
            irwork = ie + m;
            if (want_uas || want_uo) {
                nru = m;
    ...
    if (iscl == 1) {
        ...
        if (*info != 0 && anrm > bignum) {
            i__2 = minmn - 1;
            lapackf77_slascl("G", &izero, &izero, &bignum, &anrm, &i__2, &ione, &rwork[ie], &minmn, &ierr);
        }
        if (anrm < smlnum) {
        ...
        if (*info != 0 && anrm < smlnum) {
            i__2 = minmn - 1;
            lapackf77_slascl("G", &izero, &izero, &smlnum, &anrm, &i__2, &ione, &rwork[ie], &minmn, &ierr);
        }
    }
