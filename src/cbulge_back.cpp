/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from src/zbulge_back.cpp normal z -> c, Fri Jan 22 21:41:46 2016
...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    if (n_gpu < ne) {
        ...
        magma_csetmatrix( n, ne-n_gpu, Z + n_gpu*ldz, ldz, dZ + n_gpu*ldz, lddz, queues[0] );

        /*============================
         *  use only GPU
         *==========================*/
    } else {
        magma_csetmatrix( n, ne, Z, ldz, dZ, lddz, queues[0] );
...
static void *magma_capplyQ_parallel_section(void *arg)
{
    ...
    if (my_core_id == 0) {
        ...
        magma_csetmatrix( n, n_gpu, E, lde, dE, ldde, queues[0] );
