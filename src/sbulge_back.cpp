/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from zbulge_back.cpp normal z -> s, Tue Sep  2 12:38:23 2014
...
void magma_sapplyQ_data_init(magma_sapplyQ_data *zapplyQ_data, magma_int_t threads_num, magma_int_t n, magma_int_t ne, magma_int_t n_gpu,
        magma_int_t nb, magma_int_t Vblksiz, float *E, magma_int_t lde,
        float *V, magma_int_t ldv, float *TAU,
        float *T, magma_int_t ldt, float *dE, magma_int_t ldde)
{
...
void magma_sapplyQ_data_destroy(magma_sapplyQ_data *zapplyQ_data)
{
...
void magma_sapplyQ_id_data_init(magma_sapplyQ_id_data *zapplyQ_id_data,
