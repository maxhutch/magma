...
class magma_sapplyQ_data {

public:

    magma_sapplyQ_data(magma_int_t threads_num_, magma_int_t n_, magma_int_t ne_, magma_int_t n_gpu_,
                       magma_int_t nb_, magma_int_t Vblksiz_, float *E_, magma_int_t lde_,
                       float *V_, magma_int_t ldv_, float *TAU_,
                       float *T_, magma_int_t ldt_, float *dE_, magma_int_t ldde_)
    :
...
private:
    ...
    magma_sapplyQ_data(magma_sapplyQ_data& data); // disable copy

};

class magma_sapplyQ_id_data {
...
public:
    ...
    magma_sapplyQ_id_data(magma_int_t id_, magma_sapplyQ_data* data_)
    : id(id_), data(data_)
    {}
...
magma_sbulge_back(magma_int_t threads, char uplo, 
