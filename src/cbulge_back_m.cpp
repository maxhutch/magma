...
public:
    ...
    magma_capplyQ_m_data(magma_int_t nrgpu_, magma_int_t threads_num_, magma_int_t n_, magma_int_t ne_, magma_int_t n_gpu_,
...
magma_cbulge_back_m(magma_int_t nrgpu, magma_int_t threads, char uplo, 
...
//n_gpu = ne;
    if(n_gpu < ne)
    {
        ...
        magma_cbulge_applyQ_v2_m(nrgpu, 'L', ne, n, nb, Vblksiz, Z, ldz, V, ldv, T, ldt, info);
        magma_device_sync();
    }
...
static void *magma_capplyQ_m_parallel_section(void *arg)
{
    ...
    if(my_core_id==0)
    {
        ...
        magma_cbulge_applyQ_v2_m(nrgpu, 'L', n_gpu, n, nb, Vblksiz, E, lde, V, ldv, T, ldt, &info);
        magma_device_sync();
