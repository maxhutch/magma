/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zbulge_back_m.cpp normal z -> c, Fri Apr 25 15:05:50 2014
...
static void *magma_capplyQ_m_parallel_section(void *arg)
{
    ...
    if (my_core_id == 0) {
        ...
        magma_cbulge_applyQ_v2_m(nrgpu, MagmaLeft, n_gpu, n, nb, Vblksiz, E, lde, V, ldv, T, ldt, &info);
        magma_device_sync();
