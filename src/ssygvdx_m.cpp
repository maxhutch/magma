/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Wed Aug 14 12:16:20 2013

*/
#include "common_magma.h"

extern "C" magma_int_t
magma_ssygvdx_m(magma_int_t nrgpu, magma_int_t itype, char jobz, char range, char uplo, magma_int_t n,
...
//
    ...
    if (wantz && *info == 0)
    {
        ...
        if (itype == 1 || itype == 2)
        {
            ...
            magma_strsm_m(nrgpu, MagmaLeft, uplo_[0], *trans, MagmaNonUnit,
