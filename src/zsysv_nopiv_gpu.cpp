...
magma_zsysv_nopiv_gpu(magma_uplo_t uplo,  magma_int_t n, magma_int_t nrhs, 
                 ...
                 magma_int_t *info)
{
    ...
    *info = 0;
    ...
    ret = magma_zsytrf_nopiv_gpu(uplo, n, dA, ldda, info);
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
        
    ret = magma_zsytrs_nopiv_gpu( uplo, n, nrhs, dA, ldda, dB, lddb, info );
    if ( (ret != MAGMA_SUCCESS) || (*info != 0) ) {
        return ret;
    }
