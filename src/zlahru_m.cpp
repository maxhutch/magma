    ...
    struct zgehrd_data *data )
{
    ...
    for( d = 0; d < ngpu; ++d ) {
        ...
        magma_zgemm( MagmaNoTrans, MagmaConjTrans, dkhi-dk, nb, nb,
                     c_one,  dVd(d, dk, 0), ldvd,
                             dTi(d),        nb,
                     c_zero, dW (d, dk, 0), ldda );
        
        // Am = Am - Ym Wd' = A(0:k-1, k:ihi-1) - Ym(0:k-1, 0:nb-1) * W(k:ihi-1, 0:nb-1)'
        magma_zgemm( MagmaNoTrans, MagmaConjTrans, k, dkhi-dk, nb,
        ...
        magma_zgemm( MagmaNoTrans, MagmaConjTrans, ihi-k, dkhi-dknb, nb,
        ...
        magma_zgemm( MagmaConjTrans, MagmaNoTrans, nb, dn-dknb, ihi-k,
                     c_one,  dV(d, k, 0),    ldv,
                             dA(d, k, dknb), ldda,
                     c_zero, dY(d, 0, 0),    nb );
        
        // Ag2 = Ag2 - W Z = A(k:ihi-1, k+nb:n-1) - W(k+nb:n-1, 0:nb-1) * Z(0:nb-1, k+nb:n-1)
        magma_zgemm( MagmaNoTrans, MagmaNoTrans, ihi-k, dn-dknb, nb,
