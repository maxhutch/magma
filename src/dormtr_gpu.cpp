/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from zunmtr_gpu.cpp normal z -> d, Fri May 30 10:41:03 2014
...
magma_dormtr_gpu(magma_side_t side, magma_uplo_t uplo, magma_trans_t trans,
                 ...
                 magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (upper) {
        magma_dormql2_gpu(side, trans, mi, ni, nq-1, &dA[ldda], ldda, tau,
        ...
        magma_dormqr2_gpu(side, trans, mi, ni, nq-1, &dA[1], ldda, tau,
