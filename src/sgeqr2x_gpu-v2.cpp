/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Tue Aug 13 16:44:19 2013

*/
#include "common_magma.h"
    
extern "C" magma_int_t
magma_sgeqr2x2_gpu(magma_int_t *m, magma_int_t *n, float *dA,
...
/*  -- MAGMA (version 1.4.0) --
    ...
    *info = 0;
    ...
    for (i = 0; i < k; ++i) {
        ...
        if (i>0) {
            magma_slarfbx_gpu(*m, i, da_ref(0, 0), *ldda,
                              dT, k, da_ref(0, i), work);
            magmablas_snrm2_adjust(i, dnorm+i, da_ref(0, i));
        }
        ...
        /*  Generate elementary reflector H(i) to annihilate A(i+1:m,i)
            ...
            3. update T                                                  */
        magma_slarfgtx_gpu(*m-i, da_ref(i, i), da_ref(min(i+1,*m), i), dtau+i,
                           dnorm+i, ddA + i + i*(*n), i,
