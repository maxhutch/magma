/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zhetrf_nopiv_gpu.cpp normal z -> s, Sat Nov 15 19:54:09 2014
...
magma_ssytrf_nopiv_gpu(magma_uplo_t uplo, magma_int_t n, 
    ...
    //} else 
    {
        ...
        if (upper) {
            ...
            for (j=0; j<n; j += nb) {
                ...
                magma_sgetmatrix_async(jb, jb, dA(j, j), ldda, A(j,j), nb, stream[0]);
                trace_gpu_end( 0, 0 );
