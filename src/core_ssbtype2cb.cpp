/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from src/core_zhbtype2cb.cpp, normal z -> s, Sun Nov 20 20:20:24 2016
 ...
 *
 *  magma_ssbtype2cb is a kernel that will operate on a region (triangle) of data
                ...
                float *work)
{
    ...
    if ( lem > 1 ) {
        ...
        *V(vpos)  = c_one;
         ...
         */
        len = len-1;
        ctmp = MAGMA_S_CONJ(*TAU(taupos));
        lapackf77_slarfx("L", &lem, &len, V(vpos),  &ctmp, A(J1, st+1), &ldx, work);
    }
}
