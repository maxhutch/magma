/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zhetrd_he2hb_mgpu_spec.cpp normal z -> d, Fri Apr 25 15:05:51 2014
...
magma_dsytrd_sy2sb_mgpu_spec( magma_uplo_t uplo, magma_int_t n, magma_int_t nb,
    ...
    if (upper) {
        ...
        for (i = 1; i <= n-nb; i += nb) {
            ...
            if (i > 1 ) {
                ...
                /*
                magma_device_sync();
                cudaMemcpy2DAsync(A(i,i), lda*sizeof(double),
                                 dA(idev,i,di+1), ldda*sizeof(double),
