 ...
 *
 *     @generated from zbulge_applyQ_v2.cpp normal z -> d, Fri Apr 25 15:05:49 2014
 *
 */
...
magma_dbulge_applyQ_v2(magma_side_t side,
                ...
                for (blki=mt; blki > 0; blki--) {
                    ...
                    if (ncpy == 0) {
                        ...
                        if (mysiz > 0) {
                            ...
                            magma_dsetmatrix_async(vld, Vblksiz, V(vpos), vld, dV1, vld, stream[1]);
                            magma_dsetmatrix_async(tld, Vblksiz, T(tpos), tld, dT1, tld, stream[1]);
                    ...
                    if (blkid == copyst) {
                        ...
                        if (mysiz > 0) {
                            ...
                            if (flip == 0) { // now I am working on dV0 so copy the next and put it on dV1
                                ...
                                magma_dsetmatrix_async(vld, Vblksiz, V(vpos), vld, dV0, vld, stream[0]);
                                magma_dsetmatrix_async(tld, Vblksiz, T(tpos), tld, dT0, tld, stream[0]);
                            }
                        }
                    }
