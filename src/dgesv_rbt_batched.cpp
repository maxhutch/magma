/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zgesv_rbt_batched.cpp normal z -> d, Sat Nov 15 19:54:09 2014
*/
                  ...
                  magma_int_t batchCount)
{
    ...
    info = magma_dgerbt_batched(MagmaTrue, n, nrhs, dA_array, n, dB_array, n, hu, hv, &info, batchCount);
    if (info != MAGMA_SUCCESS)  {
        return info;
    }


    info = magma_dgetrf_nopiv_batched( n, n, dA_array, ldda, info_array, batchCount);
    if ( (info != MAGMA_SUCCESS) ){
        return info;
    }
    ...
    info = magma_dgetrs_nopiv_batched( MagmaNoTrans, n, nrhs, dA_array, ldda, dB_array, lddb, info_array, batchCount );
    ...
    for(int i = 0; i < nrhs; i++)
        magmablas_dprbt_mv_batched(n, dv, dB_array+(i), batchCount);
