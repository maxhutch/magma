/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zgeqrs3_gpu.cpp normal z -> s, Fri Apr 25 15:05:39 2014
                  ...
                  magma_int_t *info)
{
    ...
    */
    magmablas_sswapdblk(k, nb, dA(0,0), ldda, 1, dT(0), nb, 0);
    if ( nrhs == 1 ) {
    ...
    magmablas_sswapdblk(k, nb, dT(0), nb, 0, dA(0,0), ldda, 1);
