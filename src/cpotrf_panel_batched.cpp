/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zpotrf_panel_batched.cpp normal z -> c, Sat Nov 15 19:54:10 2014
*/
    ...
    magma_int_t batchCount, cublasHandle_t myhandle)
{
    ...
    //===============================================
    if(n<nb){
        printf("magma_cpotrf_panel error n < nb %d < %d \n",(int) n, (int) nb);
        return -101;
    }
    ...
    magma_int_t batchCount, cublasHandle_t myhandle)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_cpotrf_panel_batched( uplo, m, panel_nb,
                           dA_displ, ldda,
                           dX_array, dX_length,
                           dinvA_array, dinvA_length,
        ...
        magma_cdisplace_pointers(dA_displ,  dA_array, ldda, p1+n1, p1, batchCount);        
        magma_cdisplace_pointers(dW0_displ, dA_array, ldda, p1+n1, p2, batchCount);        
        magmablas_cgemm_batched(MagmaNoTrans, MagmaConjTrans, m2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount);
    ...
    magma_int_t batchCount, cublasHandle_t myhandle)
{
    ...
    if(panel_nb <= min_recpnb){
        ...
        magma_cdisplace_pointers(dA_displ,  dA_array, ldda, p1, p1, batchCount);        
        magma_cdisplace_pointers(dW0_displ, dA_array, ldda, p2, p1, batchCount);
        magmablas_ctrsm_work_batched(MagmaRight, MagmaLower, MagmaConjTrans, MagmaNonUnit,
                              1, n2, n1, 
                              MAGMA_C_ONE,
                              dA_displ,    ldda, 
        ...
        magma_cdisplace_pointers(dA_displ,  dA_array, ldda, p2, p1, batchCount);        
        magma_cdisplace_pointers(dW0_displ, dA_array, ldda, p2, p2, batchCount);        
        magmablas_cgemm_batched(MagmaNoTrans, MagmaConjTrans, n2, n2, n1,
                              alpha, dA_displ, ldda, 
                              dA_displ, ldda, 
                              beta,  dW0_displ, ldda, 
                              batchCount);
    ...
    if(m>n){
        ...
        magma_cdisplace_pointers(dA_displ,  dA_array, ldda, 0, 0, batchCount);        
        magma_cdisplace_pointers(dW0_displ, dA_array, ldda, n, 0, batchCount);
        magmablas_ctrsm_work_batched(MagmaRight, MagmaLower, MagmaConjTrans, MagmaNonUnit,
                              1, m-n, n, 
                              MAGMA_C_ONE,
                              dA_displ,    ldda, 
