/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from src/zheevdx_2stage.cpp normal z -> d, Mon May  2 23:30:19 2016
...
*/
    ...
    if (! wantz) {
        ...
        timer_stop( time );
        timer_printf( "  N= %10d  nb= %5d time dstedx = %6.2f\n", (int)n, (int)nb, time );
        magma_free( dwedc );
        magma_dmove_eig(range, n, W, &il, &iu, vl, vu, m);
        ...
        timer_stop( time );
        timer_printf( "  N= %10d  nb= %5d time dbulge_back = %6.2f\n", (int)n, (int)nb, time );
