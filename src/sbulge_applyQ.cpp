 ...
 *     @author Stan Tomov
 *
 *     @generated from src/zbulge_applyQ.cpp normal z -> s, Fri Jan 22 21:41:45 2016
 *
 */
...
extern "C" void magma_sbulge_applyQ(
    magma_int_t WANTZ, magma_side_t SIDE, magma_int_t NE, magma_int_t N, magma_int_t NB,
    magma_int_t Vblksiz, float *E, magma_int_t LDE,
    float *V, float *TAU, float *T,
    magma_int_t *INFO, float *dV, float *dT,
    float *dE, magma_int_t copytype )
{
    //%===========================
    //%   local variables
    //%===========================
    ...
    *INFO=0;
    ...
    if (WANTZ == 1) {
        ...
        magmablas_slaset( MagmaFull, N, N, c_zero, c_one, dE, N );
    }
