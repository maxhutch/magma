/*
    -- MAGMA (version 1.7.0) --
       ...
       @author Stan Tomov
       @generated from zgeqrf2_gpu.cpp normal z -> d, Fri Sep 11 18:29:27 2015
    ...
    *info = 0;
    ...
    if (nb >= nbmin && nb < k && nx < k) {
        ...
        for (i = 0; i < k-nx; i += nb) {
            ...
            magma_dpanel_to_q( MagmaUpper, ib, work_ref(i), ldwork, hwork+ib*ib );
            ...
            if (i + ib < n) {
                if (i+nb < k-nx) {
                    ...
                    magma_dq_to_panel( MagmaUpper, ib, work_ref(i), ldwork, hwork+ib*ib );
                }
                else {
                    magma_dlarfb_gpu( MagmaLeft, MagmaConjTrans, MagmaForward, MagmaColumnwise,
                                      rows, n-i-ib, ib,
