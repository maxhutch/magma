/*
    -- MAGMA (version 2.0.2) --
       ...
       @author Mark Gates
       @generated from interface_cuda/blas_z_v2.cpp normal z -> d, Mon May  2 23:29:59 2016
*/
    ...
    magma_queue_t queue )
{
    ...
    cublasIdamax( queue->cublas_handle(), n, dx, incx, &result );
    return result;
}
...
{
    int result; /* not magma_int_t */
    cublasIdamin( queue->cublas_handle(), n, dx, incx, &result );
    return result;
}
...
{
    double result;
    cublasDasum( queue->cublas_handle(), n, dx, incx, &result );
    return result;
}
...
magma_daxpy_q(
    ...
    magma_queue_t queue )
{
    cublasDaxpy( queue->cublas_handle(), n, &alpha, dx, incx, dy, incy );
}
...
magma_dcopy_q(
    ...
    magma_queue_t queue )
{
    cublasDcopy( queue->cublas_handle(), n, dx, incx, dy, incy );
}
...
{
    double result;
    cublasDdot( queue->cublas_handle(), n, dx, incx, dy, incy, &result );
    return result;
}
...
{
    double result;
    cublasDnrm2( queue->cublas_handle(), n, dx, incx, &result );
    return result;
}
...
magma_drot_q(
    ...
    magma_queue_t queue )
{
    cublasDrot( queue->cublas_handle(), n, dx, incx, dy, incy, &c, &s );
}
...
magma_drotm_q(
    ...
    magma_queue_t queue )
{
    cublasDrotm( queue->cublas_handle(), n, dx, incx, dy, incy, param );
}
...
magma_dscal_q(
    ...
    magma_queue_t queue )
{
    cublasDscal( queue->cublas_handle(), n, &alpha, dx, incx );
}
...
magma_dswap_q(
    ...
    magma_queue_t queue )
{
    cublasDswap( queue->cublas_handle(), n, dx, incx, dy, incy );
}
