/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from ztranspose-v2.cu normal z -> d, Fri Apr 25 15:05:22 2014
...
__global__ void dtranspose3_32( double       *B, int ldb, 
                                const double *A, int lda,
                                int m, int m32, int n, int n32)
{
    __shared__ double sA[32][DSIZE_1SHARED+1];
...
__global__ void dtranspose2_32( double       *B, int ldb, 
                                const double *A, int lda, 
                                int m, int m32, int n, int n32)
{        
    __shared__ double sA[32][DSIZE_1SHARED+1];
...
//
extern "C" void 
magmablas_dtranspose2(double       *odata, magma_int_t ldo, 
                      ...
                      magma_int_t m, magma_int_t n )
{
    ...
    dtranspose3_32<<< grid, threads, 0, magma_stream >>>(
                       ...
                       magma_int_t m, magma_int_t n, magma_queue_t stream )
{
    ...
    dim3 threads( DSIZE_1SHARED, 8, 1 );
    dim3 grid( (m+31)/32, (n+31)/32, 1 );
    dtranspose3_32<<< grid, threads, 0, stream >>>(
        odata, ldo, idata, ldi, m, (32-m%32)%32, n, (32-n%32)%32 );
}
