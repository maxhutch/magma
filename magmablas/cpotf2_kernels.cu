/*
   ...
   @generated from magmablas/zpotf2_kernels.cu, normal z -> c, Sun Nov 20 20:20:31 2016
 */
        ...
        int localstep, int gbstep, magma_int_t *info_array, const int batchCount)
{
    ...
    cpotf2_smlpout_fixwidth_device(m, dA_array[batchid]+localstep, dA_array[batchid]+localstep+localstep*lda, lda, localstep, gbstep, &(info_array[batchid]));
}
