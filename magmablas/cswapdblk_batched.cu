/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zswapdblk_batched.cu normal z -> c, Fri Sep 11 18:29:22 2015
    ...
    magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if ( nblocks > 0 ) {
        cswapdblk_batched_kernel<<< dimGrid, dimBlock, 0, queue >>>
...
{
    magmablas_cswapdblk_batched_q( n, nb, dA_array, ldda, inca, dB_array, lddb, incb, batchCount, magma_stream );
}
