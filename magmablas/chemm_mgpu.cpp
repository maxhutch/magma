/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from magmablas/zhemm_mgpu.cpp normal z -> c, Wed Jan  6 17:59:40 2016
       @author Mark Gates
       @author Azzam Haidar
*/
...
void magmablas_chemm_mgpu_com(
    ...
    magmaFloatComplex *work[],     magma_int_t worksiz,  // TODO unused
    ...
    for( dev = 0; dev < ngpu; ++dev ) {
        ...
        if (remm%nb > 0) {
            ...
            if (devperm == mydevlstblk)
                magmablas_csymmetrize(  MagmaLower,  remm % nb,  dA(dev, newoffset+mynbblk*nb, myblkoffst*nb+ myblk*nb),  ldda );  // last partial tile
        }
    }
