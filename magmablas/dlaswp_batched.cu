/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from magmablas/zlaswp_batched.cu normal z -> d, Mon May  2 23:30:41 2016
    ...
    magma_queue_t queue)
{
    ...
    {
        fprintf( stderr, "%s: height=%d > %d, magma_dlaswp_rowparallel_q not supported\n", __func__, int(n), int(MAX_NTHREADS) );
    }
