/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zgemm_fermi_batched_k32.cu normal z -> s, Sat Nov 15 19:53:59 2014
    ...
    float **dC_array, magma_int_t lddc, magma_int_t batchCount )
{
    ...
    if      ( transB == MagmaTrans )
        ...
        magma_getvector( min(2,batchCount), sizeof(float*), dA_array, 1, cpuAarray, 1);
        magma_getvector( min(2,batchCount), sizeof(float*), dB_array, 1, cpuBarray, 1);
