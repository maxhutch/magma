/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zlacpy_cnjg.cu normal z -> c, Fri Sep 11 18:29:20 2015
...
magmablas_clacpy_cnjg_q(
    magma_int_t n,
    magmaFloatComplex *dA1, magma_int_t lda1, 
    magmaFloatComplex *dA2, magma_int_t lda2,
    magma_queue_t queue )
{
    int blocksize = 64;
    dim3 blocks( magma_ceildiv( n, blocksize ) );
    magmagpu_clacpy_cnjg_params_t params = { dA1, dA2, int(n), int(lda1), int(lda2) };
