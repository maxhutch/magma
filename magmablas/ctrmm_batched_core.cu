/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from magmablas/ztrmm_batched_core.cu, normal z -> c, Sun Nov 20 20:20:32 2016
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if(nrowA <= CTRMM_BATCHED_NB){
        magmablas_ctrmm_small_batched( side, uplo, transA, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, roffA, coffA, roffB, coffB, batchCount, queue );
        return;
    }
