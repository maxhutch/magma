...
__global__ void ztranspose_conj_inplace_odd( int n, magmaDoubleComplex *matrix, int lda )
{
...
__global__ void ztranspose_conj_inplace_even( int n, magmaDoubleComplex *matrix, int lda )
{
    __shared__ magmaDoubleComplex sA[ NB ][ NB+1 ];
    __shared__ magmaDoubleComplex sB[ NB ][ NB+1 ];
