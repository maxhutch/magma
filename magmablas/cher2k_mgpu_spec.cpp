/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from zher2k_mgpu_spec.cpp normal z -> c, Fri Jul 18 17:34:13 2014
       @author Mark Gates
       @author Azzam Haidar 
*/
...
/**
    ...
    trans    magma_trans_t.
             ...
             follows:
      -     = MagmaNoTrans:     C := alpha*A*B**H + conjf( alpha )*B*A**H + beta*C.
      -     = MagmaConjTrans:   C := alpha*A**H*B + conjf( alpha )*B**H*A + beta*C.
    ...
    magma_int_t ngpu, magma_int_t nb, magma_queue_t streams[][20], magma_int_t nstream )
{
    ...
    for( magma_int_t i = 0; i < n; i += ib ) {
        ...
        magma_cgemm( MagmaNoTrans, MagmaConjTrans, n, ib, k,
