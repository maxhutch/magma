/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from ztrsm_work.cu normal z -> s, Fri May 30 10:40:43 2014
...
__global__ void
strsm_work_copy_kernel (int m, int n, float *b, int ldb, float *d_x, int ldx)
{
    int by = blockIdx.y;
...
#define strsm_work_copy() \
    do { \
        ...
        strsm_work_copy_kernel<<< dimGrid, dimBlock, 0, magma_stream >>>(m, n, b, ldb, d_x, m); \
        magma_device_sync(); \
    } while(0)
