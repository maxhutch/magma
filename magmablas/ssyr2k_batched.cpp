    ...
    float **dC_array, magma_int_t lddc, magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if( trans == MagmaNoTrans){
        magmablas_ssyrk_internal_batched(uplo, MagmaNoTrans, n, k, alpha, dA_array, ldda, dB_array, lddb, cbeta, dC_array, lddc, batchCount, queue );
        magmablas_ssyrk_internal_batched(uplo, MagmaNoTrans, n, k, MAGMA_S_CONJ(alpha), dB_array, lddb, dA_array, ldda, c_one, dC_array, lddc, batchCount, queue );    
    }else{
        magmablas_ssyrk_internal_batched(uplo, MagmaTrans, n, k, alpha, dA_array, ldda, dB_array, lddb, cbeta, dC_array, lddc, batchCount, queue );
        magmablas_ssyrk_internal_batched(uplo, MagmaTrans, n, k, MAGMA_S_CONJ(alpha), dB_array, lddb, dA_array, ldda, c_one, dC_array, lddc, batchCount, queue );
    }
}
