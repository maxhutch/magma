/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zhemm_mgpu_spec.cpp normal z -> d, Sat Nov 15 19:53:59 2014
       @author Azzam Haidar
*/
    ...
    magma_int_t gnode[MagmaMaxGPUs][MagmaMaxGPUs+2], magma_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_dgemm( MagmaConjTrans, MagmaNoTrans, m, n, m,
    ...
    for( magma_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_dgemm( MagmaConjTrans, MagmaNoTrans, mycolsize, n, m,
