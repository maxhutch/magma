/*
    -- MAGMA (version 1.5.0-beta1) --
       ...
       @generated from zhemm_mgpu_spec.cpp normal z -> d, Fri Apr 25 15:05:24 2014
       @author Azzam Haidar
*/
    ...
    magma_int_t gnode[MagmaMaxGPUs][MagmaMaxGPUs+2], magma_int_t nbcmplx )
{
    ...
    if(ngpu ==1){
        ...
        magma_dgemm( MagmaTrans, MagmaNoTrans, m, n, m,
    ...
    for( magma_int_t cmplxid = 0; cmplxid < nbcmplx; ++cmplxid ) {
        ...
        for( magma_int_t idev = 0; idev < myngpu; ++idev ) {
            ...
            if(mycolsize>0){
                ...
                magma_dgemm( MagmaTrans, MagmaNoTrans, mycolsize, n, m,
            ...
            if(mycolsize>0){
                ...
                for( magma_int_t k = 0; k < nbcmplx; ++k ) {
                    if(k!=cmplxid){
                        ...
                        if(gmaster!=-1){ //real is active
                            ...
                            cudaMemcpy2DAsync(&dwork[gmaster][maxgsize*dev], mycolsize*sizeof(double),
                                         &dwork[dev][maxgsize*dev], mycolsize*sizeof(double),
                                         mycolsize*sizeof(double), n,
                ...
                for( magma_int_t l = 0; l < myngpu; ++l ) {
                    ...
                    if((lcdev!=dev)&&(lccolsize>0)){
                        ...
                        cudaMemcpy2DAsync(&dwork[lcdev][maxgsize*dev], mycolsize*sizeof(double),
                                         &dwork[dev][maxgsize*dev], mycolsize*sizeof(double),
                                         mycolsize*sizeof(double), n,
                        ...
                        if(gcolsize>0){
                           ...
                           for( magma_int_t l = 0; l < myngpu; ++l ) {
                                ...
                                if((lcdev!=masterdev)&&(lccolsize>0)){
                                    ...
                                    cudaMemcpy2DAsync(&dwork[lcdev][maxgsize*gdev], gcolsize*sizeof(double),
                                                    &dwork[masterdev][maxgsize*gdev], gcolsize*sizeof(double),
                                                    gcolsize*sizeof(double), n,
            ...
            if(mycolsize>0){ // I am an active GPU
                ...
                if(gcolsize>0){
                    ...
                    for( magma_int_t blki = 0; blki < gblk; ++blki){
                        ...
                        magmablas_dlacpy( MagmaFull, ib, n, &dwork[dev][maxgsize*gdev+lcblki], gcolsize, &dC[dev][gbblki], lddc);
                    }// end blki
                }
