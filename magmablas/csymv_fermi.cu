/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Tue Aug 13 16:45:18 2013
...
#define magmablas_csymv_200 magmablas_csymv
#define magmablas_csymv2_200 magmablas_csymv2
...
extern "C"
void magmablas_csymv_200_L(magma_int_t m, magmaFloatComplex alpha,
                           ...
                           magmaFloatComplex *dC_work)
{
     ...
     */
    if(m % csymv_bs == 0 ) {
        magmablas_csymv_200_L_special <<< grid, threads, 0, magma_stream >>>(
            m, alpha, A, lda, X, incx, beta, Y, incy, dC_work);
    }
    else{
        magma_int_t m_mod_thread_x = m%csymv_bs - 1;
        magmablas_csymv_200_L_generic <<< grid, threads, 0, magma_stream >>> (
            m, alpha, A, lda, X, incx ,beta, Y, incy, dC_work, m_mod_thread_x);
    }

    magmablas_csymv_200_L_update<<< grid, threads_u, 0, magma_stream >>>(
        m, alpha, A, lda, X, incx, beta, Y, incy, dC_work);
}
                     ...
                     magmaFloatComplex *Y, magma_int_t incy)
{
    ...
    else
    {
        ...
        magmablas_csymv_200_L(n, alpha, A, lda, X, incx, beta, Y, incy, dC_work);
