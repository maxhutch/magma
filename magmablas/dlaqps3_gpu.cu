/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zlaqps3_gpu.cu normal z -> d, Fri Sep 11 18:29:21 2015
...
__global__ void
magma_dswap_gemv_kernel(
    int m, int rk, int n, const double * __restrict__ V, int ldv,
...
__global__ void
magma_dgemv_kernel(
    int m, int n, const double * __restrict__ V, int ldv,
...
#define dF(i_, j_) (dF + (i_) + (j_)*(lddf))
    ...
    while( k < nb && lsticc == 0 ) {
        ...
        magma_dswap_gemv_kernel<<< magma_ceildiv( m, BLOCK_SIZE1 ), BLOCK_SIZE1, 0, magma_stream >>> 
        ...
        if (k > 0) {
            ...
            magma_dgemv_kernel<<< magma_ceildiv( n-k-1, BLOCK_SIZE1 ), BLOCK_SIZE1, 0, magma_stream >>>
        ...
        if (k < n-1) {
            ...
            magma_dgemv_kernel_adjust<<< magma_ceildiv( n-k-1, BLOCK_SIZE2 ), BLOCK_SIZE2, 0, magma_stream >>>
