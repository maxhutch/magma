/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from magmablas/zgetmatrix_transpose.cpp, normal z -> s, Tue Aug 30 09:38:28 2016
...
#define dwork(i_, j_) (dwork + (i_) + (j_)*lddw)
    ...
    for (i=0; i < n; i += nb) {
        ...
        magmablas_stranspose_q( ib, m, dAT(i,0), ldda, dwork(0,(j%2)*nb), lddw, queues[j%2] );
