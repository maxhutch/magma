/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from magmablas/zswapdblk_batched.cu normal z -> d, Mon May  2 23:30:42 2016
...
__global__ void 
dswapdblk_batched_kernel( int nb, int n_mod_nb,
                  double **dA_array, int ldda, int inca,
                  double **dB_array, int lddb, int incb )
{
