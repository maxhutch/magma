/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from ztranspose.cu normal z -> d, Fri Jul 18 17:34:12 2014
...
/**
    Purpose
    -------
    dtranspose_stream copies and transposes a matrix dA to matrix dAT.
    
    Same as dtranspose, but adds stream argument.
    ...
    ********************************************************************/
extern "C" void
magmablas_dtranspose_stream(
    magma_int_t m, magma_int_t n,
    const double *dA,  magma_int_t ldda,
    double       *dAT, magma_int_t lddat, magma_queue_t stream )
{
    magma_int_t info = 0;
    if ( m < 0 )
        info = -1;
    ...
    dtranspose_kernel<<< grid, threads, 0, stream >>>
        ( m, n, dA, ldda, dAT, lddat );
}


/**
    @see magmablas_dtranspose_stream
    @ingroup magma_daux2
    ********************************************************************/
extern "C" void
...
{
    magmablas_dtranspose_stream( m, n, dA, ldda, dAT, lddat, magma_stream );
}
