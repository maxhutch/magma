...
fermiSgemm_v2_kernel_NN_64(float *C, const float *A, const float *B,  
...
extern "C" __global__ void 
fermiSgemm_v2_kernel_TN_64(float *C, const float *A, const float *B,  
...
extern "C" __global__ void 
fermiSgemm_v2_kernel_TT_64(float *C, const float *A, const float *B, 
                           int m, int n,  int k,  int lda,  int ldb, 
                           int ldc, float alpha, float beta,
                           int offsetA, int offsetB) 
{
...
extern "C" __global__ void 
fermiSgemm_v2_kernel_NT_64(float *C, const float *A, const float *B,  
                           int m, int n,  int k,  int lda,  int ldb,  
                           int ldc, float alpha, float beta,
                           int offsetA, int offsetB) 
{
...
extern "C" void
magmablas_sgemm_fermi64(char TRANSA, char TRANSB, magma_int_t m , magma_int_t n , magma_int_t k , 
...
/*  -- MAGMA (version 1.4.0) --
   ...
   =====================================================================    */
        ...
        if ( TransB ) 
           if( !TransA ) 
                fermiSgemm_v2_kernel_NT_64<<< grid, threads, 0, magma_stream >>>(C, A, B, m, n, k, lda, ldb, 
                                                              ldc, alpha, beta,
                                                              (int)offsetA, (int)offsetB);
           else
                fermiSgemm_v2_kernel_TT_64<<< grid, threads, 0, magma_stream >>>(C, A, B, m, n, k, lda, ldb, 
                                                               ldc, alpha, beta,
                                                               (int)offsetA, (int)offsetB);
        else
           if( !TransA ) 
                fermiSgemm_v2_kernel_NN_64<<< grid, threads, 0, magma_stream >>>(C, A, B, m, n, k, lda, ldb, 
                                                            ldc, alpha, beta,
                                                            (int)offsetA, (int)offsetB);
           else
                fermiSgemm_v2_kernel_TN_64<<< grid, threads, 0, magma_stream >>>(C, A, B, m, n, k, lda, ldb, 
                                                              ldc, alpha, beta,
                                                              (int)offsetA, (int)offsetB);
