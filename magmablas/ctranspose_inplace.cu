/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from ztranspose_inplace.cu normal z -> c, Fri May 30 10:40:42 2014
...
////////////////////////////////////////////////////////////////////////////////
extern "C" void
magmablas_ctranspose_inplace( magma_int_t n, magmaFloatComplex *A, magma_int_t lda )
{
    dim3 threads( NB, NB );
    ...
    if( nblock % 2 == 1 ) {
        ...
        ctranspose_inplace_odd<<< grid, threads, 0, magma_stream >>>( n, A, lda );
    }
    else {
        dim3 grid( nblock+1, nblock/2 );
        ctranspose_inplace_even<<< grid, threads, 0, magma_stream >>>( n, A, lda );
    }
}
