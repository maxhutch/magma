/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zgerbt_func_batched.cu normal z -> d, Sat Nov 15 19:53:59 2014
...
{
    magmablas_dprbt_mtv_batched_q(n, du, db_array, magma_stream, batchCount);
}
...
{
    magmablas_dprbt_mv_batched_q(n, dv, db_array, magma_stream, batchCount);
}
...
{
    magmablas_dprbt_batched_q(n, dA_array, ldda, du, dv, magma_stream, batchCount);
}
