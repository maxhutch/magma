/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from zlaset.cu normal z -> d, Sat Nov 15 19:53:59 2014
...
extern "C"
void magmablas_dlaset_batched_q(
    magma_uplo_t uplo, magma_int_t m, magma_int_t n,
    double offdiag, double diag,
...
/**
    @see magmablas_dlaset_batched_q
    @ingroup magma_daux2
    ********************************************************************/
extern "C"
...
{
    magmablas_dlaset_batched_q( uplo, m, n, offdiag, diag, dAarray, ldda, batchCount, magma_stream );
}
////////////////////////////////////////////////////////////////////////////////////////////////////
