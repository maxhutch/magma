/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from magmablas/ztrmm_batched_core.cu, normal z -> d, Sun Nov 20 20:20:32 2016
        ...
        magma_int_t batchCount, magma_queue_t queue )
{
    ...
    if(nrowA <= DTRMM_BATCHED_NB){
        magmablas_dtrmm_small_batched( side, uplo, transA, diag, m, n, alpha, dA_array, ldda, dB_array, lddb, roffA, coffA, roffB, coffB, batchCount, queue );
        return;
    }
