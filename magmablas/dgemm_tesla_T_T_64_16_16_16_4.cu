...
__global__ void  
dgemm_kernel_T_T_64_16_16_16_4(double *C, const double *A, const double *B,
                               int m, int n, int k, 
...
extern "C" void
magmablas_dgemm_kernel_T_T_64_16_16_16_4(double *C,
                                         const double *A, 
                                         const double *B,
                                         ...
                                         double alpha, double beta)
{
        ...
        dgemm_kernel_T_T_64_16_16_16_4<<< grid, threads, 0, magma_stream >>>(C, A, B,
                                                            m, n, k, 
                                                            lda, ldb, ldc, 
                                                            alpha, beta);
}
