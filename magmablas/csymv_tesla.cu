...
__global__ void
magmablas_csymv_130_L_special( int n, magmaFloatComplex alpha,
                               ...
                               magmaFloatComplex *WC)
{
    ...
    __shared__ magmaFloatComplex la   [quarter_thread_x][thread_x+1]; /* Why +3? */ 
 ...
 */
__global__ void
magmablas_csymv_130_L_generic(int n, magmaFloatComplex alpha,
                              const magmaFloatComplex *A, int lda,
                              const magmaFloatComplex *x, int incx,
                              magmaFloatComplex beta,
                              magmaFloatComplex *y, int incy,
...
__global__ void
magmablas_csymv_130_L_update(int n, magmaFloatComplex alpha,
                         const magmaFloatComplex* A, int lda,
                         const magmaFloatComplex *x, int incx,
                         magmaFloatComplex beta,
                         magmaFloatComplex *y, int incy,
...
extern "C"
void magmablas_csymv_130_L(magma_int_t m, magmaFloatComplex alpha,
                           ...
                           magmaFloatComplex *dC_work)
{
     ...
     */
    if(m % csymv_bs == 0 ) {
        magmablas_csymv_130_L_special <<< grid, threads, 0, magma_stream >>>(
            m, alpha, A, lda, X, incx, beta, Y, incy, dC_work);
    }
    else{
        magma_int_t m_mod_thread_x = m%csymv_bs - 1;
        magmablas_csymv_130_L_generic <<< grid, threads, 0, magma_stream >>> (
            m, alpha, A, lda, X, incx ,beta, Y, incy, dC_work, m_mod_thread_x);
    }

    magmablas_csymv_130_L_update<<< grid, threads_u, 0, magma_stream >>>(
        m, alpha, A, lda, X, incx, beta, Y, incy, dC_work);
}
...
/*************************************************************************
    ...
    magmablas_csymv2  performs the matrix-vector operation on fermi:
    ...
    the interface of magmablas_csymv2 is different from magmablas_csymv in
    ...
    If users need to call csymv frequently, we suggest to use magmablas_csymv2 instead of magmablas_csymv.
                     ...
                     magmaFloatComplex *Y, magma_int_t incy)
{
    ...
    else
    {
        ...
        magmablas_csymv2_130( uplo, n, alpha, 
                              A, lda, X, incx,
