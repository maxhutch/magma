/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from ztranspose_inplace.cu normal z -> s, Fri Jul 18 17:34:12 2014
...
/**
    ...
    ********************************************************************/
extern "C" void
magmablas_stranspose_inplace_stream(
    magma_int_t n, float *dA, magma_int_t ldda,
    magma_queue_t stream )
{
    ...
    if( nblock % 2 == 1 ) {
        ...
        stranspose_inplace_odd<<< grid, threads, 0, stream >>>( n, dA, ldda );
    }
    else {
        dim3 grid( nblock+1, nblock/2 );
        stranspose_inplace_even<<< grid, threads, 0, stream >>>( n, dA, ldda );
    }
}


/**
    @see magmablas_stranspose_inplace_stream
    @ingroup magma_saux2
    ********************************************************************/
extern "C" void
magmablas_stranspose_inplace( magma_int_t n, float *dA, magma_int_t ldda )
{
    magmablas_stranspose_inplace_stream( n, dA, ldda, magma_stream );
}
