/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from zlaswp_sym.cu normal z -> s, Fri Sep 11 18:29:21 2015
...
extern "C" void slaswp_sym( slaswp_sym_params_t &params, magma_queue_t queue )
{
    ...
    slaswp_sym_kernel<<< blocks, NTHREADS, 0, queue >>>( params );
}
...
magmablas_slaswp_sym( magma_int_t n, float *dA, magma_int_t lda,
                      ...
                      const magma_int_t *ipiv, magma_int_t inci )
{
    return magmablas_slaswp_sym_q( n, dA, lda, k1, k2, ipiv, inci, magma_stream );
}
