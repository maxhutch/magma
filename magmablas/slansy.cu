/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @author Mark Gates
       @generated from zlanhe.cu normal z -> s, Fri Jul 18 17:34:12 2014
    ...
    magma_uplo_t uplo, int n, const float *A, int lda, float *dwork )
{
    ...
    if ( uplo == MagmaLower ) {
        slansy_max_kernel_lower<<< grid, threads, 0, magma_stream >>>
            ( n, A, lda, dwork );
    }
    else {
        slansy_max_kernel_upper<<< grid, threads, 0, magma_stream >>>
            ( n, A, lda, dwork );
    }
}
