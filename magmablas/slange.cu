/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Tue Aug 13 16:45:12 2013
                            ...
                            int M, int N, int lda,int tree_depth)
{
        ...
        if( M %64 == 0  && N %64 == 0 ){ 
                magma_slange_special<<< grid, threads, 0, magma_stream >>> ( A, C , M , N , lda);
        }
        else{
                int N_mod_4 = N % 4 ;
                N = N - N_mod_4 ;  
                magma_slange_generic<<< grid, threads, 0, magma_stream >>> ( A, C , M , N , lda , N_mod_4);
        }
}
