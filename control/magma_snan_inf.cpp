/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @author Mark Gates
       @generated from magma_znan_inf.cpp normal z -> s, Fri Jul 18 17:34:20 2014
...
const float MAGMA_S_NAN = MAGMA_S_MAKE( 0./0., 0./0. );
const float MAGMA_S_INF = MAGMA_S_MAKE( 1./0., 1./0. );
