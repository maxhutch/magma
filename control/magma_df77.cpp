...
void magmaf_dtrsm_m(
    magma_int_t *nrgpu, magma_side_t *side, magma_uplo_t *uplo, magma_trans_t *transa, magma_diag_t *diag, magma_int_t *m, magma_int_t *n, double *alpha,
    double *a, magma_int_t *lda,
    double *b, magma_int_t *ldb )
{
    magma_dtrsm_m(
