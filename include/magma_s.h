...
magma_int_t magma_ssyevdx(char jobz, char range, char uplo, magma_int_t n,
                          float *a, magma_int_t lda,
                          float vl, float vu, magma_int_t il, magma_int_t iu,
                          magma_int_t *m, float *w, float *work,
                          magma_int_t lwork, float *rwork, magma_int_t lrwork,
                          magma_int_t *iwork, magma_int_t liwork, magma_int_t *info);
magma_int_t magma_ssyevdx_2stage(char jobz, char range, char uplo,
                          magma_int_t n,
                          float *a, magma_int_t lda,
                          float vl, float vu, magma_int_t il, magma_int_t iu,
...
magma_int_t magma_ssygvdx(magma_int_t itype, char jobz, char range, char uplo,
                          ...
                          magma_int_t liwork, magma_int_t *info);
magma_int_t magma_ssygvdx_2stage(magma_int_t itype, char jobz, char range, char uplo, magma_int_t n,
                          float *a, magma_int_t lda, 
                          float *b, magma_int_t ldb,
                          float vl, float vu, magma_int_t il, magma_int_t iu,
                          magma_int_t *m, float *w, 
...
magma_int_t magma_strsm_m ( magma_int_t nrgpu,
                            ...
                            float *a, magma_int_t lda, 
                            float *b, magma_int_t ldb);
magma_int_t magma_sormqr_m( magma_int_t nrgpu, char side, char trans,
                            magma_int_t m, magma_int_t n, magma_int_t k,
                            float *a,    magma_int_t lda,
                            float *tau,
                            float *c,    magma_int_t ldc,
...
magma_int_t magma_ssygvdx_2stage_m( magma_int_t nrgpu, 
                                    ...
                                    magma_int_t *info);
#else /* not (defined(PRECISION_z) || defined(PRECISION_c)) */
magma_int_t magma_ssyevd_m( magma_int_t nrgpu, char jobz, char uplo,
                            magma_int_t n,
                            float *a, magma_int_t lda,
                            float *w,
                            float *work, magma_int_t lwork,   
...
magma_int_t magma_slarfb2_gpu(magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              float *dC,          magma_int_t ldc,
                              float *dwork,       magma_int_t ldwork );
magma_int_t magma_slarfb_gpu_gemm( char side, char trans, char direct, char storev,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              const float *dv, magma_int_t ldv,
                              const float *dt, magma_int_t ldt,
                              float *dc,       magma_int_t ldc,
...
magma_int_t magma_spotrf_mgpu(magma_int_t ngpu, char uplo, magma_int_t n,
...
magma_int_t magma_ssytrd_mgpu(magma_int_t num_gpus, magma_int_t k, char uplo, magma_int_t n,
                              float *a, magma_int_t lda,
                              float *d, float *e, float *tau,
                              float *work, magma_int_t lwork,
                              magma_int_t *info);
magma_int_t magma_ssytrd_sb2st(magma_int_t threads, char uplo, 
                              ...
                              float *T, magma_int_t ldt);
magma_int_t magma_ssytrd_sy2sb(char uplo, magma_int_t n, magma_int_t NB,
                              float *a, magma_int_t lda,
                              float *tau, float *work, magma_int_t lwork,
                              float *dT, magma_int_t threads,
                              magma_int_t *info);
magma_int_t magma_ssytrd_sy2sb_mgpu( char uplo, magma_int_t n, magma_int_t nb,
                              float *a, magma_int_t lda,
                              float *tau,
                              float *work, magma_int_t lwork,
...
magma_int_t magma_ssytrd_sy2sb_mgpu_spec( char uplo, magma_int_t n, magma_int_t nb,
                              float *a, magma_int_t lda,
                              float *tau,
                              float *work, magma_int_t lwork,
                              float *dAmgpu[], magma_int_t ldda,
...
magma_int_t magma_sorgqr_gpu( magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              magma_int_t nb, magma_int_t *info );
magma_int_t magma_sormql2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              float *da, magma_int_t ldda,
                              float *tau,
...
magma_int_t magma_sormqr2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              float *da,   magma_int_t ldda,
                              float *tau,
                              float *dc,    magma_int_t lddc,
