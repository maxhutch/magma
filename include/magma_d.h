...
magma_int_t magma_dormql( char side, char trans,
...
magma_int_t magma_dsyevdx(char jobz, char range, char uplo, magma_int_t n,
                          double *a, magma_int_t lda,
                          double vl, double vu, magma_int_t il, magma_int_t iu,
                          magma_int_t *m, double *w, double *work,
                          magma_int_t lwork, double *rwork, magma_int_t lrwork,
                          magma_int_t *iwork, magma_int_t liwork, magma_int_t *info);
magma_int_t magma_dsyevdx_2stage(char jobz, char range, char uplo,
                          magma_int_t n,
                          double *a, magma_int_t lda,
                          double vl, double vu, magma_int_t il, magma_int_t iu,
...
magma_int_t magma_dsygvdx(magma_int_t itype, char jobz, char range, char uplo,
                          ...
                          magma_int_t liwork, magma_int_t *info);
magma_int_t magma_dsygvdx_2stage(magma_int_t itype, char jobz, char range, char uplo, magma_int_t n,
                          double *a, magma_int_t lda, 
                          double *b, magma_int_t ldb,
                          double vl, double vu, magma_int_t il, magma_int_t iu,
                          magma_int_t *m, double *w, 
...
magma_int_t magma_dtrsm_m ( magma_int_t nrgpu,
                            ...
                            double *a, magma_int_t lda, 
                            double *b, magma_int_t ldb);
magma_int_t magma_dormqr_m( magma_int_t nrgpu, char side, char trans,
                            magma_int_t m, magma_int_t n, magma_int_t k,
                            double *a,    magma_int_t lda,
                            double *tau,
                            double *c,    magma_int_t ldc,
...
magma_int_t magma_dsygvdx_2stage_m( magma_int_t nrgpu, 
                                    ...
                                    magma_int_t *info);
#else /* not (defined(PRECISION_z) || defined(PRECISION_c)) */
magma_int_t magma_dsyevd_m( magma_int_t nrgpu, char jobz, char uplo,
                            magma_int_t n,
                            double *a, magma_int_t lda,
                            double *w,
                            double *work, magma_int_t lwork,   
...
magma_int_t magma_dlarfb2_gpu(magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              double *dC,          magma_int_t ldc,
                              double *dwork,       magma_int_t ldwork );
magma_int_t magma_dlarfb_gpu_gemm( char side, char trans, char direct, char storev,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              const double *dv, magma_int_t ldv,
                              const double *dt, magma_int_t ldt,
                              double *dc,       magma_int_t ldc,
...
magma_int_t magma_dpotrf_mgpu(magma_int_t ngpu, char uplo, magma_int_t n,
                              double **d_lA, magma_int_t ldda, magma_int_t *info);
magma_int_t magma_dpotrf3_mgpu(magma_int_t num_gpus, char uplo, magma_int_t m, magma_int_t n,
...
magma_int_t magma_dsytrd_mgpu(magma_int_t num_gpus, magma_int_t k, char uplo, magma_int_t n,
                              double *a, magma_int_t lda,
                              double *d, double *e, double *tau,
                              double *work, magma_int_t lwork,
                              magma_int_t *info);
magma_int_t magma_dsytrd_sb2st(magma_int_t threads, char uplo, 
                              ...
                              double *T, magma_int_t ldt);
magma_int_t magma_dsytrd_sy2sb(char uplo, magma_int_t n, magma_int_t NB,
                              double *a, magma_int_t lda,
                              double *tau, double *work, magma_int_t lwork,
                              double *dT, magma_int_t threads,
                              magma_int_t *info);
magma_int_t magma_dsytrd_sy2sb_mgpu( char uplo, magma_int_t n, magma_int_t nb,
                              double *a, magma_int_t lda,
                              double *tau,
                              double *work, magma_int_t lwork,
...
magma_int_t magma_dsytrd_sy2sb_mgpu_spec( char uplo, magma_int_t n, magma_int_t nb,
                              double *a, magma_int_t lda,
                              double *tau,
                              double *work, magma_int_t lwork,
                              double *dAmgpu[], magma_int_t ldda,
...
magma_int_t magma_dorgqr_gpu( magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              magma_int_t nb, magma_int_t *info );
magma_int_t magma_dormql2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              double *da, magma_int_t ldda,
                              double *tau,
...
magma_int_t magma_dormqr2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              double *da,   magma_int_t ldda,
                              double *tau,
                              double *dc,    magma_int_t lddc,
