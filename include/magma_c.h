...
magma_int_t magma_clatrd( char uplo, magma_int_t n, magma_int_t nb, magmaFloatComplex *a,
...
magma_int_t magma_cposv ( char uplo, magma_int_t n, magma_int_t nrhs,
                          magmaFloatComplex *A, magma_int_t lda,
                          magmaFloatComplex *B, magma_int_t ldb, magma_int_t *info);
magma_int_t magma_cpotrf( char uplo, magma_int_t n, magmaFloatComplex *A,
                          magma_int_t lda, magma_int_t *info);
magma_int_t magma_cpotri( char uplo, magma_int_t n, magmaFloatComplex *A,
                          magma_int_t lda, magma_int_t *info);
magma_int_t magma_clauum( char uplo, magma_int_t n, magmaFloatComplex *A,
                          magma_int_t lda, magma_int_t *info);
magma_int_t magma_ctrtri( char uplo, char diag, magma_int_t n, magmaFloatComplex *A,
                          magma_int_t lda, magma_int_t *info);
magma_int_t magma_chetrd( char uplo, magma_int_t n, magmaFloatComplex *A,
                          magma_int_t lda, float *d, float *e,
...
magma_int_t magma_cheevdx(char jobz, char range, char uplo, magma_int_t n,
                          magmaFloatComplex *a, magma_int_t lda,
                          float vl, float vu, magma_int_t il, magma_int_t iu,
                          magma_int_t *m, float *w, magmaFloatComplex *work,
                          magma_int_t lwork, float *rwork, magma_int_t lrwork,
                          magma_int_t *iwork, magma_int_t liwork, magma_int_t *info);
magma_int_t magma_cheevdx_2stage(char jobz, char range, char uplo,
                          magma_int_t n,
                          magmaFloatComplex *a, magma_int_t lda,
                          float vl, float vu, magma_int_t il, magma_int_t iu,
...
magma_int_t magma_ctrsm_m ( magma_int_t nrgpu,
                            ...
                            magmaFloatComplex *a, magma_int_t lda, 
                            magmaFloatComplex *b, magma_int_t ldb);
magma_int_t magma_cunmqr_m( magma_int_t nrgpu, char side, char trans,
                            magma_int_t m, magma_int_t n, magma_int_t k,
                            magmaFloatComplex *a,    magma_int_t lda,
                            magmaFloatComplex *tau,
                            magmaFloatComplex *c,    magma_int_t ldc,
...
magma_int_t magma_chegvd_m( magma_int_t nrgpu,
                            magma_int_t itype, char jobz, char uplo,
                            magma_int_t n,
                            magmaFloatComplex *a, magma_int_t lda,
                            magmaFloatComplex *b, magma_int_t ldb,
                            float *w,
...
magma_int_t magma_chegvdx_2stage_m( magma_int_t nrgpu, 
                                    ...
                                    magma_int_t *info);
#else /* not (defined(PRECISION_z) || defined(PRECISION_c)) */
magma_int_t magma_cheevd_m( magma_int_t nrgpu, char jobz, char uplo,
                            magma_int_t n,
                            magmaFloatComplex *a, magma_int_t lda,
                            float *w,
                            magmaFloatComplex *work, magma_int_t lwork,   
...
magma_int_t magma_clarfb2_gpu(magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              magmaFloatComplex *dC,          magma_int_t ldc,
                              magmaFloatComplex *dwork,       magma_int_t ldwork );
magma_int_t magma_clarfb_gpu_gemm( char side, char trans, char direct, char storev,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              const magmaFloatComplex *dv, magma_int_t ldv,
                              const magmaFloatComplex *dt, magma_int_t ldt,
                              magmaFloatComplex *dc,       magma_int_t ldc,
...
magma_int_t magma_cpotrf_mgpu(magma_int_t ngpu, char uplo, magma_int_t n,
...
float magma_clatrd_mgpu(
    magma_int_t num_gpus, char uplo,
...
magma_int_t magma_chetrd_mgpu(magma_int_t num_gpus, magma_int_t k, char uplo, magma_int_t n,
                              magmaFloatComplex *a, magma_int_t lda,
                              float *d, float *e, magmaFloatComplex *tau,
                              magmaFloatComplex *work, magma_int_t lwork,
                              magma_int_t *info);
magma_int_t magma_chetrd_hb2st(magma_int_t threads, char uplo, 
                              ...
                              magmaFloatComplex *T, magma_int_t ldt);
magma_int_t magma_chetrd_he2hb(char uplo, magma_int_t n, magma_int_t NB,
                              magmaFloatComplex *a, magma_int_t lda,
                              magmaFloatComplex *tau, magmaFloatComplex *work, magma_int_t lwork,
                              magmaFloatComplex *dT, magma_int_t threads,
                              magma_int_t *info);
magma_int_t magma_chetrd_he2hb_mgpu( char uplo, magma_int_t n, magma_int_t nb,
                              magmaFloatComplex *a, magma_int_t lda,
                              magmaFloatComplex *tau,
                              magmaFloatComplex *work, magma_int_t lwork,
...
magma_int_t magma_chetrd_he2hb_mgpu_spec( char uplo, magma_int_t n, magma_int_t nb,
                              magmaFloatComplex *a, magma_int_t lda,
                              magmaFloatComplex *tau,
                              magmaFloatComplex *work, magma_int_t lwork,
                              magmaFloatComplex *dAmgpu[], magma_int_t ldda,
...
magma_int_t magma_cungqr_gpu( magma_int_t m, magma_int_t n, magma_int_t k,
                              ...
                              magma_int_t nb, magma_int_t *info );
magma_int_t magma_cunmql2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              magmaFloatComplex *da, magma_int_t ldda,
                              magmaFloatComplex *tau,
...
magma_int_t magma_cunmqr2_gpu(char side, char trans,
                              magma_int_t m, magma_int_t n, magma_int_t k,
                              magmaFloatComplex *da,   magma_int_t ldda,
                              magmaFloatComplex *tau,
                              magmaFloatComplex *dc,    magma_int_t lddc,
