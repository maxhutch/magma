/*
    -- MAGMA (version 1.5.0) --
       ...
       @generated from magmablas_z_q.h normal z -> d, Tue Sep  2 12:38:14 2014
*/
...
extern "C" {
   ...
   * Transpose functions
   */
void magmablas_dtranspose_inplace_q(
    magma_int_t n,
    magmaDouble_ptr dA, magma_int_t ldda,
    magma_queue_t queue );

void magmablas_dtranspose_q(
    magma_int_t m, magma_int_t n,
    magmaDouble_const_ptr dA,  magma_int_t ldda,
    magmaDouble_ptr       dAT, magma_int_t lddat,
    magma_queue_t queue );

void magmablas_dgetmatrix_transpose_q(
    magma_int_t m, magma_int_t n,
...
void magmablas_dsetmatrix_transpose_q(
    magma_int_t m, magma_int_t n,
...
void magmablas_dgeadd_batched_q(
    magma_int_t m, magma_int_t n,
    double alpha,
...
void magmablas_dlacpy_batched_q(
...
void magmablas_dsymmetrize_q(
    magma_uplo_t uplo, magma_int_t m,
    magmaDouble_ptr dA, magma_int_t ldda,
    magma_queue_t queue );

void magmablas_dsymmetrize_tiles_q(
    magma_uplo_t uplo, magma_int_t m,
    magmaDouble_ptr dA, magma_int_t ldda,
    magma_int_t ntile, magma_int_t mstride, magma_int_t nstride,
    magma_queue_t queue );

void magmablas_dtrtri_diag_q(
   ...
   * Level 1 BLAS
   */
void magmablas_dswap_q(
    magma_int_t n,
    magmaDouble_ptr dA, magma_int_t ldda,
    magmaDouble_ptr dB, magma_int_t lddb,
    magma_queue_t queue );

void magmablas_dswapblk_q(
    magma_order_t order,
    magma_int_t n,
    magmaDouble_ptr dA, magma_int_t ldda,
    magmaDouble_ptr dB, magma_int_t lddb,
