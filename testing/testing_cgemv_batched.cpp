/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from testing_zgemv_batched.cpp normal z -> c, Fri Sep 11 18:29:39 2015
       @author Mark Gates
       @author Azzam Haidar
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cset_pointer(A_array, d_A, ldda, 0, 0, ldda*N, batchCount, opts.queue);
            cset_pointer(X_array, d_X, 1, 0, 0, incx*Xm, batchCount, opts.queue);
            cset_pointer(Y_array, d_Y, 1, 0, 0, incy*Ym, batchCount, opts.queue);
