/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zheevd.cpp normal z -> d, Fri Jan 22 21:42:46 2016
...
int main( int argc, char** argv)
{
    ...
    double *h_A, *h_R, *h_Z, *h_work, aux_work[1];
    #ifdef COMPLEX
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 1) {
                if (opts.ngpu == 1) {
                    ...
                    //printf( "magma_dsyevd_m, ngpu %d (%d)\n", opts.ngpu, abs_ngpu );
                ...
                if (opts.ngpu == 1) {
                    ...
                    //printf( "magma_dsyevdx_m, ngpu %d (%d)\n", opts.ngpu, abs_ngpu );
