/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Tue Aug 13 16:45:54 2013
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            // output is N x M
            TESTING_MALLOC(   h_B, magmaFloatComplex, ldb*M  );
            TESTING_MALLOC(   h_R, magmaFloatComplex, ldb*M  );
            TESTING_DEVALLOC( d_B, magmaFloatComplex, lddb*M );
            ...
            //magmablas_ctranspose2( d_B+1+lddb, lddb, d_A+1+ldda, ldda, M-2, N-2 );  // inset by 1 row & col
            magmablas_ctranspose2( d_B, lddb, d_A, ldda, M, N );
