/*
   ...
   @generated from testing_zposv_batched.cpp normal z -> s, Sat Nov 15 19:54:18 2014
 */
// includes, system
#include <stdio.h>
#include <stdlib.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            info = magma_sposv_batched(opts.uplo, N, nrhs, dA_array, ldda, dB_array, lddb, dinfo_array, batchCount); 
