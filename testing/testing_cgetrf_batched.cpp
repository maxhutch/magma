/*
   ...
   @generated from testing_zgetrf_batched.cpp normal z -> c, Sat Nov 15 19:54:18 2014
 */
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv)
{
    ...
    magmaFloatComplex *dA_magma, *dA_cublas;
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
      ...
      for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV(  dA_cublas,  magmaFloatComplex, ldda*N * batchCount);
            ...
            lapackf77_clacpy( MagmaUpperLowerStr, &M, &columns, h_A, &lda, h_R, &lda );
            ...
            cset_pointer(dA_array, dA_magma, ldda, 0, 0, ldda*N, batchCount);
            set_ipointer(dipiv_array, dipiv_magma, 1, 0, 0, min_mn, batchCount);
            magma_time = magma_sync_wtime(0);
            info = magma_cgetrf_batched( M, N, dA_array, ldda, dipiv_array,  dinfo_magma, batchCount);
            ...
            magma_csetmatrix( M, columns, h_R, lda, dA_cublas,  ldda );
            cset_pointer(dA_array, dA_cublas, ldda, 0, 0, ldda * N, batchCount);
