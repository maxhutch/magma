/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from testing_zhemv_mgpu.cpp normal z -> d, Sat Nov 15 19:54:18 2014
*/
...
int main(int argc, char **argv)
{
    ...
    magmaDouble_ptr dA, dX[MagmaMaxGPUs], dY[MagmaMaxGPUs], d_lA[MagmaMaxGPUs], dYcublas;

    //magma_queue_t stream[MagmaMaxGPUs][10];
    double *C_work;
    magmaDouble_ptr dC_work[MagmaMaxGPUs];
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            cublasDsymv( opts.handle, cublas_uplo_const(opts.uplo), N-opts.offset,
...
*/
             ...
             */
            blasf77_dcopy( &N, Y, &incx, Ycublas, &incx );
