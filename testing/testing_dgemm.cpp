/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zgemm.cpp normal z -> d, Fri Jan 22 21:42:32 2016
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dsetmatrix( Am, An, h_A, lda, d_A, ldda, opts.queue );
            magma_dsetmatrix( Bm, Bn, h_B, ldb, d_B, lddb, opts.queue );
            
            /* =====================================================================
               Performs operation using MAGMABLAS (currently only with CUDA)
               =================================================================== */
            #ifdef HAVE_CUBLAS
                magma_dsetmatrix( M, N, h_C, ldc, d_C, lddc, opts.queue );
                ...
                magma_dgetmatrix( M, N, d_C, lddc, h_Cmagma, ldc, opts.queue );
            #endif
            ...
            magma_dgetmatrix( M, N, d_C, lddc, h_Cdev, ldc, opts.queue );
