/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zhemm_mgpu.cpp normal z -> c, Wed Jan  6 17:59:47 2016
...
int main( int argc, char** argv)
{
    ...
    magmaFloatComplex_ptr dA[MagmaMaxGPUs], dX[MagmaMaxGPUs], dB[MagmaMaxGPUs], dwork[MagmaMaxGPUs], hwork[MagmaMaxGPUs+1];
      ...
      for( int offset = 0; offset < N; offset += min(N,nb) ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            for( int d = 0; d < opts.ngpu; ++d ) {
                ...
                TESTING_MALLOC_PIN( hwork[d], magmaFloatComplex, hworksiz    );
            }
            TESTING_MALLOC_PIN( hwork[opts.ngpu], magmaFloatComplex, lda*N );
