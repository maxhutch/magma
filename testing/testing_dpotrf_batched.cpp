/*
   ...
   @generated from testing_zpotrf_batched.cpp normal z -> d, Sat Nov 15 19:54:18 2014
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lapackf77_dlacpy( MagmaUpperLowerStr, &N, &(columns), h_A, &lda, h_R, &lda );
            ...
            /* ====================================================================
               ...
               =================================================================== */
            dset_pointer(d_A_array, d_A, ldda, 0, 0, ldda * N, batchCount);
            gpu_time = magma_sync_wtime(NULL);
            info = magma_dpotrf_batched( opts.uplo, N, d_A_array, ldda, dinfo_magma, batchCount);
            ...
            {
                if(cpu_info[i] != 0 ){
                    printf("magma_dpotrf_batched matrix %d returned internal error %d\n",i, (int)cpu_info[i] );
                }
            }
            if (info != 0)
