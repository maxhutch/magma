/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_ztrtri_diag.cpp normal z -> c, Fri Jan 22 21:42:37 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV( d_dinvA, magmaFloatComplex, size_inv );
            TESTING_MALLOC_CPU( h_dinvA, magmaFloatComplex, size_inv );
            ...
            magmablas_ctrtri_diag( opts.uplo, opts.diag, N, d_A, ldda, d_dinvA );
            magma_time = magma_sync_wtime( opts.queue ) - magma_time;
            magma_perf = gflops / magma_time;
            
            magma_cgetvector( size_inv, d_dinvA, 1, h_dinvA, 1 );
