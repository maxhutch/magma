/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @author Mark Gates
       @generated from testing/testing_zunmqr.cpp normal z -> s, Fri Jan 22 21:42:45 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.ngpu == 1 ) {
                ...
                if ( side[iside] == MagmaLeft ) {
                    ...
                    printf( "%5d %5d %5d   %4c   %5c   skipping because magma_sormqr_m doesn't support MagmaRight\n",
                            (int) m, (int) n, (int) k,
                            lapacke_side_const( side[iside] ),
                            lapacke_trans_const( trans[itran] ) );
                    goto cleanup;
