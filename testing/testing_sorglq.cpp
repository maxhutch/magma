/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zunglq.cpp normal z -> s, Fri Jan 22 21:42:45 2016
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (info != 0) {
                printf("magma_sorglq returned error %d: %s.\n",
                       (int) info, magma_strerror( info ));
            }
            ...
            if ( opts.lapack ) {
                ...
                if (info != 0) {
                    printf("lapackf77_sorglq returned error %d: %s.\n",
                           (int) info, magma_strerror( info ));
                }
