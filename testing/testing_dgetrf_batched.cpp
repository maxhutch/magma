/*
   ...
   @generated from testing_zgetrf_batched.cpp normal z -> d, Fri Sep 11 18:29:39 2015
 */
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            magma_dsetmatrix( M, columns, h_R, lda, dA, ldda );
            dset_pointer(dA_array, dA, ldda, 0, 0, ldda*N, batchCount, opts.queue);
            ...
            magma_dgetmatrix( M, N*batchCount, dA, ldda, h_Amagma, lda );
