/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zhemv_mgpu.cpp normal z -> s, Fri Jan 22 21:42:34 2016
      ...
      for( int ioffset=0; ioffset < noffsets; ioffset += 1 ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            Ynorm = lapackf77_slange( "F", &Noffset, &ione, Ycublas, &Noffset, work );
            blasf77_saxpy( &Noffset, &c_neg_one, Ymagma, &incx, Ycublas, &incx );
            error = lapackf77_slange( "F", &Noffset, &ione, Ycublas, &Noffset, work ) / Ynorm;
