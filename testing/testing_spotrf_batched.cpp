/*
   ...
   @generated from testing/testing_zpotrf_batched.cpp normal z -> s, Tue Feb  9 16:06:17 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                for (int i=0; i < batchCount; i++)
                {
                    ...
                    Anorm = lapackf77_slansy("f", uplo, &N, h_A + i * lda*N, &lda, work);
                    err   = lapackf77_slansy("f", uplo, &N, h_R + i * lda*N, &lda, work)
                          / Anorm;
