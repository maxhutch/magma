/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from testing_zgeev_m.cpp normal z -> c, Fri Sep 11 18:29:39 2015
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (info != 0)
                printf("magma_cgeev_m returned error %d: %s.\n",
            ...
            if ( opts.check == 2 ) {
                ...
                // this is really slow because it calls magma_cgeev_m multiple times
                ...
                magma_cgeev_m( MagmaVec, MagmaVec,
                               ...
                               h_work, lwork, rwork, &info );
                if (info != 0)
                    printf("magma_cgeev_m (case V, V) returned error %d: %s.\n",
                           (int) info, magma_strerror( info ));
                ...
                //                h_work, lwork, rwork, &info );
                // if (info != 0)
                //     printf("magma_cgeev_m (case N, N) returned error %d: %s.\n",
                //            (int) info, magma_strerror( info ));
                //
                ...
                magma_cgeev_m( MagmaNoVec, MagmaVec,
                               ...
                               h_work, lwork, rwork, &info );
                if (info != 0)
                    printf("magma_cgeev_m (case N, V) returned error %d: %s.\n",
                           (int) info, magma_strerror( info ));
                ...
                magma_cgeev_m( MagmaVec, MagmaNoVec,
                               ...
                               h_work, lwork, rwork, &info );
                if (info != 0)
                    printf("magma_cgeev_m (case V, N) returned error %d: %s.\n",
                           (int) info, magma_strerror( info ));
