/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zhegvdx.cpp normal z -> s, Wed Jan  6 17:59:50 2016
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 1) {
                if (opts.ngpu == 1) {
                    ...
                    magma_ssygvdx_m( abs_ngpu, opts.itype, opts.jobz, MagmaRangeI, opts.uplo,
                                     N, h_R, lda, h_S, lda, vl, vu, il, iu, &m1, w1,
                                     h_work, lwork,
                                     #ifdef COMPLEX
                                     rwork, lrwork,
                ...
                #ifdef COMPLEX
                magma_ssygvr( opts.itype, opts.jobz, MagmaRangeI, opts.uplo,
                ...
                #ifdef COMPLEX
                magma_ssygvx( opts.itype, opts.jobz, MagmaRangeI, opts.uplo,
                              N, h_R, lda, h_S, lda, vl, vu, il, iu, abstol, &m1, w1,
                              h_Z, lda,
                              h_work, lwork,
                              #ifdef COMPLEX
