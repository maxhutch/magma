/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zlanhe.cpp normal z -> d, Fri Jan 22 21:42:35 2016
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    if ( arch < 200 ) {
        ...
        for( int iuplo = 0; iuplo < 2; ++iuplo ) {
            ...
            norm_magma = magmablas_dlansy( norm[inorm], uplo[iuplo], 1, NULL, 1, NULL, 1 );
            if ( norm_magma != -1 ) {
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int iuplo = 0; iuplo < 2; ++iuplo ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            norm_magma = magmablas_dlansy( norm[inorm], uplo[iuplo], N, d_A, ldda, d_work, N );
