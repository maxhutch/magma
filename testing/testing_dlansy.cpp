/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from testing_zlanhe.cpp normal z -> d, Fri Sep 11 18:29:37 2015
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    if ( mkl_warning ) {
        printf("* MKL (e.g., 11.1.0) has a bug in dlansy with multiple threads; corrected in 11.2.x.\n"
