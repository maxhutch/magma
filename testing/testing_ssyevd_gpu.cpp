/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zheevd_gpu.cpp normal z -> s, Fri Jan 22 21:42:45 2016
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (opts.version == 3) {
                TESTING_MALLOC_DEV( d_Z,    float, N*ldda     );
            ...
            if ( opts.version == 1 ) {
                ...
                magma_ssyevr_gpu( opts.jobz, range, opts.uplo,
                                  ...
                                  iwork, liwork,
                                  &info );
                magmablas_slacpy( MagmaFull, N, N, d_Z, ldda, d_R, ldda );
                #endif
            }
