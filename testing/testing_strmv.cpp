/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from testing/testing_ztrmv.cpp, normal z -> s, Sun Nov 20 20:20:33 2016
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                Cnorm = lapackf77_slange( "M", &N, &ione, hx, &N, work );
                
                blasf77_saxpy( &N, &c_neg_one, hx, &ione, hxdev, &ione );
                dev_error = lapackf77_slange( "M", &N, &ione, hxdev, &N, work ) / Cnorm;
