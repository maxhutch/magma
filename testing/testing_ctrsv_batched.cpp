/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_ztrsv_batched.cpp normal z -> c, Fri Jan 22 21:42:49 2016
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV( d_b,       magmaFloatComplex, N*batchCount  );
            ...
            magma_cgetmatrix( N, batchCount, dwork, N, h_bmagma, N );
            ...
            magma_cgetmatrix( N, batchCount, d_b, N, h_bcublas, N );
