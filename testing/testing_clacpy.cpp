/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zlacpy.cpp normal z -> c, Fri Jan 22 21:42:35 2016
       @author Mark Gates
*/
    ...
    for( int iuplo = 0; iuplo < 3; ++iuplo ) {
      for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            //magmablas_clacpy( uplo[iuplo], M-2, N-2, d_A+1+ldda, ldda, d_B+1+lddb, lddb );  // inset by 1 row & col
            magmablas_clacpy( uplo[iuplo], M, N, d_A, ldda, d_B, lddb );
            ...
            if ( opts.verbose ) {
                ...
                printf( "dB=" );  magma_cprint_gpu( M, N, d_B, lddb );
            }
            
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_cgetmatrix( M, N, d_B, lddb, h_R, lda );
