/*
    -- clMAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_zgetrf_mgpu.cpp normal z -> d, Mon May  2 23:31:13 2016
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* ====================================================================
               ...
               =================================================================== */
            init_matrix( M, N, h_A, lda );
            magma_dsetmatrix_1D_col_bcyclic( M, N, h_A, lda, d_lA, ldda, ngpu, nb, queues );
            ...
            magma_dgetmatrix_1D_col_bcyclic( M, N, d_lA, ldda, h_A, lda, ngpu, nb, queues );
