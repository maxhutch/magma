/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from testing/testing_zherk_batched.cpp, normal z -> c, Tue Aug 30 09:39:16 2016
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                for (i=0; i < batchCount; i++)
                {
                    ...
                    Cnorm      = safe_lapackf77_clanhe( "fro", lapack_uplo_const(opts.uplo), &N, h_C     +i*ldc*N, &ldc, work );
                    float err = safe_lapackf77_clanhe( "fro", lapack_uplo_const(opts.uplo), &N, h_Cmagma+i*ldc*N, &ldc, work )
                               / Cnorm;
