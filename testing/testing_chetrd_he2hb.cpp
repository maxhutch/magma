/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Tue Aug 13 16:46:11 2013
...
int main( int argc, char** argv)
{
    ...
    TESTING_HOSTALLOC( h_work, magmaFloatComplex, lwork0 );
    TESTING_MALLOC(    tau,    magmaFloatComplex, N-1   );
    TESTING_HOSTALLOC( D,    float, N );
    TESTING_HOSTALLOC( E,    float, N );
    //TESTING_DEVALLOC( dT1,  magmaFloatComplex, (2*min(N,N)+(N+31)/32*32)*NB );
    TESTING_DEVALLOC( dT1,  magmaFloatComplex, (N*NB) );
...
*/
        ...
        TESTING_HOSTALLOC(hh_work, magmaFloatComplex,  lwork);
