/*
    -- MAGMA (version 1.5.0-beta2) --
       ...
       @generated from testing_zher2k_mgpu.cpp normal z -> s, Fri May 30 10:41:21 2014
...
int main( int argc, char** argv)
{
    ...
    float *dV[MagmaMaxGPUs], *dW[MagmaMaxGPUs], *dA[MagmaMaxGPUs];
        ...
        for( int offset = 0; offset < n; offset += min(k,nb) ) {
            for( int iter = 0; iter < opts.niter; ++iter ) {
                ...
                /* ====================================================================
                   ...
                   =================================================================== */
                magma_ssetmatrix_1D_col_bcyclic( n, n, hA, lda, dA, ldda, ngpu, nb );
                for( int d = 0; d < ngpu; ++d ) {
                    magma_setdevice( d );
                    dW[d] = dV[d] + ldda*k;
                    magma_ssetmatrix( n, k, hV, lda, dV[d], ldda );
                ...
                magma_sgetmatrix_1D_col_bcyclic( n, n, dA, ldda, hR, lda, ngpu, nb );
