/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_ztrmm.cpp normal z -> c, Mon May  2 23:31:05 2016
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            #ifdef HAVE_CUBLAS
                magma_cgetmatrix( M, N, d_C,    lddc, h_Bcublas, ldb, opts.queue );
            #else
                magma_cgetmatrix( M, N, d_B, 0, lddb, h_Bcublas, ldb, opts.queue, opts.queue );
            #endif
