/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from testing/testing_zgemm_vbatched.cpp, normal z -> d, Tue Aug 30 09:39:18 2016
       @author Mark Gates
       @author Azzam Haidar
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                for (int s=0; s < batchCount; s++)
                {
                    ...
                    Cnorm = lapackf77_dlange( "M", &h_M[s], &h_N[s], h_C_tmp, &h_ldc[s], work );

                    blasf77_daxpy( &C_batchSize, &c_neg_one, h_C_tmp, &ione, h_Cmagma_tmp, &ione );
                    magma_err = lapackf77_dlange( "M", &h_M[s], &h_N[s], h_Cmagma_tmp, &h_ldc[s], work ) / Cnorm;
