/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated d Tue Aug 13 16:45:50 2013
...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC( h_b,  double, N );
            TESTING_MALLOC( h_x,  double, N );
            TESTING_MALLOC( h_xcublas, double, N  );
            
            TESTING_DEVALLOC( d_A, double, ldda*N );
            TESTING_DEVALLOC( d_x, double, N  );
