/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zgesvd.cpp normal z -> c, Fri Jan 22 21:42:48 2016
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    printf("%% jobu jobv   M     N  CPU time (sec)  GPU time (sec)   |S1-S2|   |A-USV^H|   |I-UU^H|/M   |I-VV^H|/N   S sorted\n");
    printf("%%===============================================================================================================\n");
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_CPU( VT,    magmaFloatComplex, ldv*N );   // N x N (jobvt=A) or min(M,N) x N
            TESTING_MALLOC_CPU( U,     magmaFloatComplex, ldu*N_U ); // M x M (jobu=A)  or M x min(M,N)
