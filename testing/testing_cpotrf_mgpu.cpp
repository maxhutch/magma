/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_zpotrf_mgpu.cpp normal z -> c, Mon May  2 23:31:11 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.uplo == MagmaUpper ) {
                ...
                magma_csetmatrix_1D_col_bcyclic( N, N, h_R, lda, d_lA, ldda, ngpu, nb, queues );
            }
            else {
                ldda = (1+N/(nb*ngpu))*nb;
                magma_csetmatrix_1D_row_bcyclic( N, N, h_R, lda, d_lA, ldda, ngpu, nb, queues );
            }
            ...
            if ( opts.uplo == MagmaUpper ) {
                magma_cgetmatrix_1D_col_bcyclic( N, N, d_lA, ldda, h_R, lda, ngpu, nb, queues );
            }
            else {
                magma_cgetmatrix_1D_row_bcyclic( N, N, d_lA, ldda, h_R, lda, ngpu, nb, queues );
            }
