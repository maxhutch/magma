/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated s Wed Aug 14 12:18:00 2013
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC(   hAarray, float*, ntile );
            TESTING_MALLOC(   hBarray, float*, ntile );
            TESTING_DEVALLOC( dAarray, float*, ntile );
            TESTING_DEVALLOC( dBarray, float*, ntile );
