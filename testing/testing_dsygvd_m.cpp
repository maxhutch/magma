/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from testing_zhegvd_m.cpp normal z -> d, Fri Sep 11 18:29:39 2015
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.warmup || opts.check ) {
                ...
                lapackf77_dlacpy( MagmaFullStr, &N, &N, h_A, &N, h_Ainit, &N );
                lapackf77_dlacpy( MagmaFullStr, &N, &N, h_B, &N, h_Binit, &N );
            }
            ...
            if (opts.warmup) {
                ...
                magma_dsygvd_m( opts.ngpu, opts.itype, opts.jobz, opts.uplo,
                                ...
                                iwork, liwork,
                                &info);
                lapackf77_dlacpy( MagmaFullStr, &N, &N, h_Ainit, &N, h_A, &N );
                lapackf77_dlacpy( MagmaFullStr, &N, &N, h_Binit, &N, h_B, &N );
            }
