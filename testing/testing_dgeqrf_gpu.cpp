/*
    -- MAGMA (version 2.0.0) --
       ...
       @generated from testing/testing_zgeqrf_gpu.cpp normal z -> d, Tue Feb  9 16:06:10 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.version == 1 || opts.version == 3 ) {
                ...
                magmablas_dlaset( MagmaFull, size, 1, c_zero, c_zero, dT, size );
            }
            ...
            if ( opts.check == 1 && (opts.version == 2 || opts.version == 3) ) {
                if ( opts.version == 3 ) {
                    ...
                    for( int i=0; i < min_mn-nb; i += nb ) {
                        ...
                        magmablas_dlacpy( MagmaUpper, ib, ib, &dT[min_mn*nb + i*nb], nb, &d_A[ i + i*ldda ], ldda );
                    }
                }
