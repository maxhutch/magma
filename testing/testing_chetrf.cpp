/*
    -- MAGMA (version 1.7.0) --
       ...
       @generated from testing_zhetrf.cpp normal z -> c, Fri Sep 11 18:29:38 2015
    ...
    magma_int_t *ipiv )
{
    ...
    int nb = magma_get_chetrf_aasen_nb(n);
    // extract T
    for (int i=0; i<n; i++)
    {
    ...
    // compute r = Ax - b, saved in b
    blasf77_cgemv( "Notrans", &n, &n, &c_one, A, &lda, x, &ione, &c_mone, b, &ione );
