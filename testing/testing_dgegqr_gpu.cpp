/*
    -- MAGMA (version 1.5.0-beta3) --
       ...
       @generated from testing_zgegqr_gpu.cpp normal z -> d, Fri Jul 18 17:34:25 2014
       @author Stan Tomov
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                /* =====================================================================
                   ...
                   =================================================================== */
                blasf77_dgemm("t", "n", &N, &N, &M, &c_one, h_R, &M, h_R, &M, &c_zero, h_work, &N);
                ...
                blasf77_dgemm("t", "n", &N, &N, &M, &c_one, h_A, &M, h_A, &M, &c_zero, h_work, &N);
                for(int ii = 0; ii < N*N; ii += N+1 ) {
                    h_work[ii] = MAGMA_D_SUB(h_work[ii], c_one);
                }
