/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zhegvdx_2stage.cpp normal z -> s, Wed Jan  6 17:59:50 2016
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.check && opts.jobz != MagmaNoVec ) {
                ...
                result[0] = 1.;
                result[0] /= safe_lapackf77_slansy("1", lapack_uplo_const(opts.uplo), &N, h_A, &N, rwork);
