/*
    -- MAGMA (version 1.6.0) --
       ...
       @generated from testing_zherk_batched.cpp normal z -> d, Sat Nov 15 19:54:18 2014
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            dset_pointer(A_array, d_A, lda, 0, 0, ldda*Ak, batchCount);
            dset_pointer(C_array, d_C, ldc, 0, 0, lddc*N,  batchCount);
