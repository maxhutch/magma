/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zgeqrf_batched.cpp normal z -> s, Fri Jan 22 21:42:50 2016
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            TESTING_MALLOC_DEV( dtau_array, float*, batchCount );
            ...
            if ( opts.check ) {
                ...
                for (magma_int_t s=0; s < batchCount; s++)
                {
                    ...
                    if (locinfo != 0) {
                        printf("lapackf77_sgeqrf matrix %d returned error %d: %s.\n",
