/*
    -- MAGMA (version 1.6.1) --
       ...
       @generated from testing_ztrsm_batched.cpp normal z -> d, Fri Jan 30 19:00:26 2015
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            dset_pointer(dwork_array, dwork, lddb, 0, 0, dwork_batchSize, batchCount, queue);
            dset_pointer(dinvA_array, dinvA, ((Ak+TRI_NB-1)/TRI_NB)*TRI_NB, 0, 0, dinvA_batchSize, batchCount, queue);
            ...
            dset_pointer(d_A_array, d_A, ldda, 0, 0, ldda*Ak, batchCount, queue);
            dset_pointer(d_B_array, d_B, lddb, 0, 0, lddb*N, batchCount, queue);
            dset_pointer(dwork_array, dwork, lddb, 0, 0, lddb*N, batchCount, queue);
