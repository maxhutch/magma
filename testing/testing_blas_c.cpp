/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_blas_z.cpp normal z -> c, Mon May  2 23:31:07 2016
       @author Mark Gates
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        TESTING_MALLOC_PIN( A,   magmaFloatComplex, size );
        TESTING_MALLOC_PIN( B,   magmaFloatComplex, size );
        TESTING_MALLOC_PIN( C,   magmaFloatComplex, size );
        TESTING_MALLOC_PIN( C2,  magmaFloatComplex, size );
        TESTING_MALLOC_PIN( LU,  magmaFloatComplex, size );
        
        TESTING_MALLOC_DEV( dA,  magmaFloatComplex, size );
        TESTING_MALLOC_DEV( dB,  magmaFloatComplex, size );
        TESTING_MALLOC_DEV( dC1, magmaFloatComplex, size );
        TESTING_MALLOC_DEV( dC2, magmaFloatComplex, size );
