/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @author Mark Gates
       @generated from testing/testing_zunmlq.cpp normal z -> s, Fri Jan 22 21:42:45 2016
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int itran = 0; itran < 2; ++itran ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sgelqf( k, mm, A, lda, tau, W, lwork_max, &info );
            if (info != 0) {
            ...
            if (info != 0) {
                printf("magma_sormlq (lwork query) returned error %d: %s.\n",
                       (int) info, magma_strerror( info ));
            }
            ...
            if (info != 0) {
                printf("magma_sormlq returned error %d: %s.\n",
                       (int) info, magma_strerror( info ));
            }
