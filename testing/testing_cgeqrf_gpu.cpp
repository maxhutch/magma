/*
    -- MAGMA (version 1.4.0) --
       ...
       @generated c Tue Aug 13 16:46:02 2013
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
                ...
                if ( opts.version == 2 ) {
                    ...
                    if ( opts.version == 1 ) {
                        ...
                        magma_cgeqrs_gpu( M, N, 1,
                                          ...
                                          d_B, M, tmp, -1, &info );
                        lwork = (magma_int_t)MAGMA_C_REAL( tmp[0] );
                        TESTING_MALLOC( hwork, magmaFloatComplex, lwork );
