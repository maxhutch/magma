/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zlacpy_batched.cpp normal z -> c, Wed Jan  6 17:59:50 2016
       @author Mark Gates
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_clacpy_batched( MagmaUpperLower, mb, nb, dAarray, ldda, dBarray, ldda, ntile, opts.queue );
