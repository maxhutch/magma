/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_zhemv_mgpu.cpp normal z -> c, Mon May  2 23:31:06 2016
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int ioffset=0; ioffset < noffsets; ioffset += 1 ) {
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_cgetvector( Noffset, dY, incx, Ycublas, incx, opts.queue );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_csetmatrix_1D_col_bcyclic( Noffset, Noffset, A, lda, d_lA, ldda, opts.ngpu, nb, queues );
