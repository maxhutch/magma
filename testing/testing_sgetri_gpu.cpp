/*
    -- MAGMA (version 2.0.0-beta3) --
       ...
       @generated from testing/testing_zgetri_gpu.cpp normal z -> s, Fri Jan 22 21:42:41 2016
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sgetmatrix( N, N, d_A, ldda, h_Ainv, lda );
            if (info != 0) {
            ...
            //magma_ssetmatrix( N, N, h_Ainv, lda, d_A, ldda );
