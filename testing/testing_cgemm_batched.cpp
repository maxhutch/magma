/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from testing/testing_zgemm_batched.cpp, normal z -> c, Tue Aug 30 09:39:16 2016
       @author Mark Gates
       @author Azzam Haidar
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_cset_pointer( A_array, d_A, ldda, 0, 0, ldda*An, batchCount, opts.queue );
            magma_cset_pointer( B_array, d_B, lddb, 0, 0, lddb*Bn, batchCount, opts.queue );
            ...
            cublasCgemmBatched(opts.handle, cublas_trans_const(opts.transA), cublas_trans_const(opts.transB),
                               int(M), int(N), int(K),
                               &alpha, (const magmaFloatComplex**) A_array, int(ldda),
                                       (const magmaFloatComplex**) B_array, int(lddb),
