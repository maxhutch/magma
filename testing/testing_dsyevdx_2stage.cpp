...
static magma_int_t check_orthogonality(magma_int_t, magma_int_t, double*, magma_int_t, double);
static magma_int_t check_reduction(magma_int_t, magma_int_t, magma_int_t, double*, double*, magma_int_t, double*, double);
        ...
        for( magma_int_t iter = 0; iter < opts.niter; ++iter ) {
            ...
            if(opts.warmup){
                ...
                if(ngpu==1){
                    ...
                    magma_dsyevdx_2stage(jobz, range, uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
                    ...
                    magma_dsyevdx_2stage_m(ngpu, jobz, range, uplo, N, 
                                    h_R, N, 
                                    vl, vu, il, iu, 
                                    &m1, w1, 
                                    h_work, lwork, 
 ...
 *  Check the reduction 
 */
static magma_int_t check_reduction(magma_int_t uplo, magma_int_t N, magma_int_t bw, double *A, double *D, magma_int_t LDA, double *Q, double eps )
{
    double c_one     = MAGMA_D_ONE;
    ...
    Rnorm = lapackf77_dlansy("1", &luplo, &N, Residual, &N, work);
    Anorm = lapackf77_dlansy("1", &luplo, &N, A,        &LDA, work);
