/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zherk.cpp normal z -> s, Wed Jan  6 17:59:47 2016
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                Cnorm        = safe_lapackf77_slansy( "fro", lapack_uplo_const(opts.uplo), &N, h_C,       &ldc, work );
                cublas_error = safe_lapackf77_slansy( "fro", lapack_uplo_const(opts.uplo), &N, h_Ccublas, &ldc, work )
                             / Cnorm;
