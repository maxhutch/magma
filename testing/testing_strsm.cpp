/*
    -- MAGMA (version 2.1.0) --
       ...
       @generated from testing/testing_ztrsm.cpp, normal z -> s, Tue Aug 30 09:39:02 2016
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            lapackf77_sgetrf( &Ak, &Ak, hA, &lda, ipiv, &info );
            for( int j = 0; j < Ak; ++j ) {
                for( int i = 0; i < j; ++i ) {
                    *hA(i,j) = *hA(j,i);
                }
            ...
            memcpy( hBlapack, hB, sizeB*sizeof(float) );
            ...
            normA = lapackf77_slange( "M", &Ak, &Ak, hA, &lda, work );
