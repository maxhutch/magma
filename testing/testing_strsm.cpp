/*
    -- MAGMA (version 2.0.2) --
       ...
       @generated from testing/testing_ztrsm.cpp normal z -> s, Mon May  2 23:31:06 2016
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
                ...
                magma_sgetmatrix( M, N, d_B, lddb, h_Bmagma, ldb, opts.queue );
            #endif
            ...
            magma_sgetmatrix( M, N, d_B, lddb, h_Bcublas, ldb, opts.queue );
