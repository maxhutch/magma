/*
    -- MAGMA (version 2.0.0-beta2) --
       ...
       @generated from testing/testing_zhemm_mgpu.cpp normal z -> s, Wed Jan  6 17:59:47 2016
...
{
    fprintf( stderr, "Note: tester for ssymm_mgpu needs to be updated; exiting.\n" );
    return 1;
    ...
    float *hA, *hX, *hB, *hR;
    magmaFloat_ptr dA[MagmaMaxGPUs], dX[MagmaMaxGPUs], dB[MagmaMaxGPUs], dwork[MagmaMaxGPUs], hwork[MagmaMaxGPUs+1];
    magmaFloat_ptr dA2;
