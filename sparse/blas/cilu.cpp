/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from sparse/blas/zilu.cpp, normal z -> c, Sun Nov 20 20:20:42 2016
*/
    ...
    magma_queue_t queue )
{
    ...
    if( precond->trisolver == Magma_CUSOLVE || precond->trisolver == 0 ){
        ...
        CHECK_CUSPARSE( cusparseCcsrsm_analysis( cusparseHandle,
            ...
            cusparseCcsr2csc(cusparseHandle, hL.num_cols, hL.num_rows, hL.nnz,
            ...
            // conversion using CUSPARSE
            cusparseCcsr2csc(cusparseHandle, hU.num_cols, hU.num_rows, hU.nnz,
