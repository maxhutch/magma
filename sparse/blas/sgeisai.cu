/*
    -- MAGMA (version 2.2.0) --
       ...
       @generated from sparse/blas/zgeisai.cu, normal z -> s, Sun Nov 20 20:20:42 2016
...
__global__ void
magma_slocations_trunc_lower_kernel(
    magma_int_t n,
    magma_index_t *row,
    magma_index_t *col,
    float *val,
...
__global__ void
magma_slocations_trunc_upper_kernel(
    magma_int_t n,
    magma_index_t *row,
    magma_index_t *col,
    float *val,
    ...
    magma_queue_t queue )
{
    ...
    magma_sgpumemzero_z<<< grid, block, 0, queue->cuda_stream() >>>(
   ...
   // magma_sprint_gpu( 32, 32, L.dval, 32, queue );
    ...
    if( uplotype == MagmaLower ){
        magma_slocations_lower_kernel<<< grid, block, 0, queue->cuda_stream() >>>(
                        LC.num_rows,
                        LC.drow,
                        LC.dcol,
                        LC.dval,
        ...
        magma_slocations_upper_kernel<<< grid, block, 0, queue->cuda_stream() >>>(
                        LC.num_rows,
                        LC.drow,
                        LC.dcol,
                        LC.dval,
    ...
    magma_sfilltrisystems_kernel<<< grid2, block2, 0, queue->cuda_stream() >>>(
                        L.num_rows,
                        L.drow,
                        L.dcol,
                        L.dval,
    ...
    magma_queue_t queue )
{
    ...
    magma_sbackinsert_kernel<<< grid, block, 0, queue->cuda_stream() >>>(
            M->num_rows,
            M->drow,
            M->dcol,
            M->dval,
